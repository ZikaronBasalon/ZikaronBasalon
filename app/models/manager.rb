class Manager < ActiveRecord::Base
  ...
  def get_hosts(page, filter, query, sort, has_manager, has_survivor, is_org, language, in_future, reverse_ordering, has_survivor_set)
   ...
   hosts = hosts.where("survivor_needed IS NOT NULL") unless has_survivor_set == "false"
