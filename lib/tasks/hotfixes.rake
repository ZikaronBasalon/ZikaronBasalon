...
namespace :hotfixes do
  ...
  task :temp_runs => :environment do
    Witness.find(2285).comments.create!(user_id: 415, content: "בשנה שעברה, 'ארנה בינדלגלס' (2285) היה/הייתה מצוות/ת למארח/ת אורית לסר (6791). בצד של המארחים הוא/היא 12997.")
    w = Witness.find(2285)
    w.active_last_year = true
    w.save
    ...
    h.save
    Witness.find(1297).comments.create!(user_id: 415, content: "בשנה שעברה, 'אוריה מבורך' (1297) היה/הייתה מצוות/ת למארח/ת אריק (2495). בצד של המארחים הוא/היא 5260.")
    w = Witness.find(1297)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1802).comments.create!(user_id: 415, content: "בשנה שעברה, 'טובה שי' (1802) היה/הייתה מצוות/ת למארח/ת מירב גרטי (7181). בצד של המארחים הוא/היא 17771.")
    w = Witness.find(1802)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1971).comments.create!(user_id: 415, content: "בשנה שעברה, 'אניטה פיינרו' (1971) היה/הייתה מצוות/ת למארח/ת חנה מורג (1303). בצד של המארחים הוא/היא 1741.")
    w = Witness.find(1971)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3096).comments.create!(user_id: 415, content: "בשנה שעברה, 'שארל אריה ארון' (3096) היה/הייתה מצוות/ת למארח/ת אלה ספטל (8465). בצד של המארחים הוא/היא 19389.")
    w = Witness.find(3096)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1803).comments.create!(user_id: 415, content: "בשנה שעברה, 'יעל מיליגר' (1803) היה/הייתה מצוות/ת למארח/ת רויטל זקן (8957). בצד של המארחים הוא/היא 20328.")
    w = Witness.find(1803)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(851).comments.create!(user_id: 415, content: "בשנה שעברה, 'זהבה ומרדכי רון' (851) היה/הייתה מצוות/ת למארח/ת עדן פרום (7408). בצד של המארחים הוא/היא 18044.")
    w = Witness.find(851)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2298).comments.create!(user_id: 415, content: "בשנה שעברה, 'ענת מילר' (2298) היה/הייתה מצוות/ת למארח/ת רזיה יפה (6872). בצד של המארחים הוא/היא 17428.")
    w = Witness.find(2298)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(970).comments.create!(user_id: 415, content: "בשנה שעברה, 'יונייב מוטקה וטובה' (970) היה/הייתה מצוות/ת למארח/ת הדס ברזילי (8062). בצד של המארחים הוא/היא 18799.")
    w = Witness.find(970)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1549).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברקוביץ יהודה' (1549) היה/הייתה מצוות/ת למארח/ת מתן צדוק (873). בצד של המארחים הוא/היא 930.")
    w = Witness.find(1549)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(485).comments.create!(user_id: 415, content: "בשנה שעברה, 'צבי רוט' (485) היה/הייתה מצוות/ת למארח/ת מאיה אורה (7420). בצד של המארחים הוא/היא 18058.")
    w = Witness.find(485)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1435).comments.create!(user_id: 415, content: "בשנה שעברה, 'סול חדד' (1435) היה/הייתה מצוות/ת למארח/ת נועם יאדגר (6722). בצד של המארחים הוא/היא 17265.")
    w = Witness.find(1435)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2005).comments.create!(user_id: 415, content: "בשנה שעברה, 'נועה רוזן' (2005) היה/הייתה מצוות/ת למארח/ת מסורי ליאת (7154). בצד של המארחים הוא/היא 17742.")
    w = Witness.find(2005)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2125).comments.create!(user_id: 415, content: "בשנה שעברה, 'אריה שפירא' (2125) היה/הייתה מצוות/ת למארח/ת ג'ני גובר (6542). בצד של המארחים הוא/היא 17091.")
    w = Witness.find(2125)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1935).comments.create!(user_id: 415, content: "בשנה שעברה, 'לנה ניקולאיו' (1935) היה/הייתה מצוות/ת למארח/ת יערית חיון (8129). בצד של המארחים הוא/היא 18875.")
    w = Witness.find(1935)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2291).comments.create!(user_id: 415, content: "בשנה שעברה, 'יענקלה פטרושקה' (2291) היה/הייתה מצוות/ת למארח/ת אופיר רמז (7973). בצד של המארחים הוא/היא 18704.")
    w = Witness.find(2291)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1520).comments.create!(user_id: 415, content: "בשנה שעברה, 'ציפורה פלודה' (1520) היה/הייתה מצוות/ת למארח/ת רוני טבין (7727). בצד של המארחים הוא/היא 18418.")
    w = Witness.find(1520)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1638).comments.create!(user_id: 415, content: "בשנה שעברה, 'טובה נייברג' (1638) היה/הייתה מצוות/ת למארח/ת נעמה רחל גורדון (7460). בצד של המארחים הוא/היא 18101.")
    w = Witness.find(1638)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1362).comments.create!(user_id: 415, content: "בשנה שעברה, 'בת שבע ומלך ווסרמן' (1362) היה/הייתה מצוות/ת למארח/ת אסנת כהן (8788). בצד של המארחים הוא/היא 19931.")
    w = Witness.find(1362)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1795).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה ליפר' (1795) היה/הייתה מצוות/ת למארח/ת יהונתן םרידמן (8730). בצד של המארחים הוא/היא 19825.")
    w = Witness.find(1795)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2287).comments.create!(user_id: 415, content: "בשנה שעברה, 'אורנה\tפייקין' (2287) היה/הייתה מצוות/ת למארח/ת שירלי דגוני (6808). בצד של המארחים הוא/היא 17358.")
    w = Witness.find(2287)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2288).comments.create!(user_id: 415, content: "בשנה שעברה, 'דב \tליפשיץ' (2288) היה/הייתה מצוות/ת למארח/ת אנה לי ברנשטיין (8005). בצד של המארחים הוא/היא 18739.")
    w = Witness.find(2288)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1798).comments.create!(user_id: 415, content: "בשנה שעברה, 'יפה אלוני' (1798) היה/הייתה מצוות/ת למארח/ת רותם גלאם (8513). בצד של המארחים הוא/היא 19461.")
    w = Witness.find(1798)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(799).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיים קגן' (799) היה/הייתה מצוות/ת למארח/ת נעמה מתנס חצור הגלילית (3970). בצד של המארחים הוא/היא 10103.")
    w = Witness.find(799)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1799).comments.create!(user_id: 415, content: "בשנה שעברה, 'תקוה פרידהבר' (1799) היה/הייתה מצוות/ת למארח/ת איילה כהן (5801). בצד של המארחים הוא/היא 13304.")
    w = Witness.find(1799)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(490).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרדכי רונזברג' (490) היה/הייתה מצוות/ת למארח/ת קרין מזגאוקר (9334). בצד של המארחים הוא/היא 21580.")
    w = Witness.find(490)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1728).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרדכי קרויטורו' (1728) היה/הייתה מצוות/ת למארח/ת מתן גולדברגר (6009). בצד של המארחים הוא/היא 13945.")
    w = Witness.find(1728)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1310).comments.create!(user_id: 415, content: "בשנה שעברה, 'גולדה גורונקין' (1310) היה/הייתה מצוות/ת למארח/ת ירדן (9578). בצד של המארחים הוא/היא 22747.")
    w = Witness.find(1310)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(923).comments.create!(user_id: 415, content: "בשנה שעברה, 'אפרים לפיד' (923) היה/הייתה מצוות/ת למארח/ת סיגל עזתי (236). בצד של המארחים הוא/היא 247.")
    w = Witness.find(923)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1996).comments.create!(user_id: 415, content: "בשנה שעברה, 'שאול אורן' (1996) היה/הייתה מצוות/ת למארח/ת איתן בוכוול ואמילי שופן (4753). בצד של המארחים הוא/היא 11116.")
    w = Witness.find(1996)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2281).comments.create!(user_id: 415, content: "בשנה שעברה, 'שלמה פרל' (2281) היה/הייתה מצוות/ת למארח/ת מורן שירי (8251). בצד של המארחים הוא/היא 19036.")
    w = Witness.find(2281)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(603).comments.create!(user_id: 415, content: "בשנה שעברה, 'אליהו אוזן' (603) היה/הייתה מצוות/ת למארח/ת פרויקט שאג\"י (5347). בצד של המארחים הוא/היא 12242.")
    w = Witness.find(603)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(805).comments.create!(user_id: 415, content: "בשנה שעברה, 'ישראל ויזל' (805) היה/הייתה מצוות/ת למארח/ת איתי דונר (7409). בצד של המארחים הוא/היא 18047.")
    w = Witness.find(805)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(746).comments.create!(user_id: 415, content: "בשנה שעברה, 'דנה שומכר' (746) היה/הייתה מצוות/ת למארח/ת אנה שוורץ (9521). בצד של המארחים הוא/היא 22486.")
    w = Witness.find(746)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3098).comments.create!(user_id: 415, content: "בשנה שעברה, 'זהבה היטנר' (3098) היה/הייתה מצוות/ת למארח/ת מיכל ואילן אופנהיימר (8735). בצד של המארחים הוא/היא 19835.")
    w = Witness.find(3098)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(699).comments.create!(user_id: 415, content: "בשנה שעברה, 'איילת רייך' (699) היה/הייתה מצוות/ת למארח/ת הודיה רייף (7787). בצד של המארחים הוא/היא 18484.")
    w = Witness.find(699)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1320).comments.create!(user_id: 415, content: "בשנה שעברה, 'אריאלה בכר' (1320) היה/הייתה מצוות/ת למארח/ת מיה הוד רן (3227). בצד של המארחים הוא/היא 6718.")
    w = Witness.find(1320)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(775).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנוך לרר' (775) היה/הייתה מצוות/ת למארח/ת נטע תמיר (7950). בצד של המארחים הוא/היא 10908.")
    w = Witness.find(775)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2121).comments.create!(user_id: 415, content: "בשנה שעברה, 'יגאל רץ' (2121) היה/הייתה מצוות/ת למארח/ת הדס הנדלר (4556). בצד של המארחים הוא/היא 10856.")
    w = Witness.find(2121)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(557).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה קליין' (557) היה/הייתה מצוות/ת למארח/ת הדס וול (8986). בצד של המארחים הוא/היא 20398.")
    w = Witness.find(557)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1071).comments.create!(user_id: 415, content: "בשנה שעברה, 'פרומה לאור' (1071) היה/הייתה מצוות/ת למארח/ת ליאור שרעבי (501). בצד של המארחים הוא/היא 549.")
    w = Witness.find(1071)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2245).comments.create!(user_id: 415, content: "בשנה שעברה, 'ציפורה פיק' (2245) היה/הייתה מצוות/ת למארח/ת נורית קנטרוביץ' (6654). בצד של המארחים הוא/היא 17199.")
    w = Witness.find(2245)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(985).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרגא שמר' (985) היה/הייתה מצוות/ת למארח/ת הפאב החברתי זה (8973). בצד של המארחים הוא/היא 20373.")
    w = Witness.find(985)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1587).comments.create!(user_id: 415, content: "בשנה שעברה, 'מוקה זילברמן' (1587) היה/הייתה מצוות/ת למארח/ת שרה אביחי (6957). בצד של המארחים הוא/היא 17523.")
    w = Witness.find(1587)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3106).comments.create!(user_id: 415, content: "בשנה שעברה, 'רבקה סופר' (3106) היה/הייתה מצוות/ת למארח/ת מרכז תקוותנו רחובות (7832). בצד של המארחים הוא/היא 18531.")
    w = Witness.find(3106)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1024).comments.create!(user_id: 415, content: "בשנה שעברה, 'צבי מריאנסקי' (1024) היה/הייתה מצוות/ת למארח/ת שחר סוחצקי (8828). בצד של המארחים הוא/היא 20027.")
    w = Witness.find(1024)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3081).comments.create!(user_id: 415, content: "בשנה שעברה, 'גיתית גליקמן' (3081) היה/הייתה מצוות/ת למארח/ת קרין (8825). בצד של המארחים הוא/היא 20023.")
    w = Witness.find(3081)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2243).comments.create!(user_id: 415, content: "בשנה שעברה, 'יחזקאל טלר' (2243) היה/הייתה מצוות/ת למארח/ת דיקלה קריספיל (8886). בצד של המארחים הוא/היא 20167.")
    w = Witness.find(2243)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2244).comments.create!(user_id: 415, content: "בשנה שעברה, 'נחמן אש' (2244) היה/הייתה מצוות/ת למארח/ת ליטל שרעבי (6531). בצד של המארחים הוא/היא 10717.")
    w = Witness.find(2244)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2290).comments.create!(user_id: 415, content: "בשנה שעברה, 'אילנה ולדמן' (2290) היה/הייתה מצוות/ת למארח/ת אווי הרשקו (8701). בצד של המארחים הוא/היא 19763.")
    w = Witness.find(2290)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1810).comments.create!(user_id: 415, content: "בשנה שעברה, 'בצלאל גרין' (1810) היה/הייתה מצוות/ת למארח/ת מעיין צדוק (4485). בצד של המארחים הוא/היא 10762.")
    w = Witness.find(1810)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(999).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודה אלכסנדר' (999) היה/הייתה מצוות/ת למארח/ת גפן מנור (7854). בצד של המארחים הוא/היא 18559.")
    w = Witness.find(999)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(996).comments.create!(user_id: 415, content: "בשנה שעברה, 'טובה לנדוי' (996) היה/הייתה מצוות/ת למארח/ת עדי אנגל (7160). בצד של המארחים הוא/היא 17750.")
    w = Witness.find(996)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1045).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרים גליקליך' (1045) היה/הייתה מצוות/ת למארח/ת ניצן אמדו (51). בצד של המארחים הוא/היא 54.")
    w = Witness.find(1045)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2294).comments.create!(user_id: 415, content: "בשנה שעברה, 'מגדה בר חי' (2294) היה/הייתה מצוות/ת למארח/ת מירב פילדס (8075). בצד של המארחים הוא/היא 18817.")
    w = Witness.find(2294)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(932).comments.create!(user_id: 415, content: "בשנה שעברה, 'אילן אבישר' (932) היה/הייתה מצוות/ת למארח/ת אייל גורן (1098). בצד של המארחים הוא/היא 1330.")
    w = Witness.find(932)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2412).comments.create!(user_id: 415, content: "בשנה שעברה, 'דלי לאור' (2412) היה/הייתה מצוות/ת למארח/ת סימונה (2312). בצד של המארחים הוא/היא 4421.")
    w = Witness.find(2412)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2130).comments.create!(user_id: 415, content: "בשנה שעברה, 'ראובן גלעד' (2130) היה/הייתה מצוות/ת למארח/ת דנה איצקוביץ (8549). בצד של המארחים הוא/היא 19512.")
    w = Witness.find(2130)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1046).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיה כספי' (1046) היה/הייתה מצוות/ת למארח/ת אמילי רוזמבלאום (7482). בצד של המארחים הוא/היא 18129.")
    w = Witness.find(1046)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1066).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה למפרט' (1066) היה/הייתה מצוות/ת למארח/ת לאה חיבה (8684). בצד של המארחים הוא/היא 13823.")
    w = Witness.find(1066)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3105).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה קוראל' (3105) היה/הייתה מצוות/ת למארח/ת לירון ויצמן (8267). בצד של המארחים הוא/היא 19058.")
    w = Witness.find(3105)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(398).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוסף ידייקיו' (398) היה/הייתה מצוות/ת למארח/ת אבי גבאי (8630). בצד של המארחים הוא/היא 19630.")
    w = Witness.find(398)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(545).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית רוזנצווייג' (545) היה/הייתה מצוות/ת למארח/ת הילה הובר (7211). בצד של המארחים הוא/היא 17808.")
    w = Witness.find(545)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3100).comments.create!(user_id: 415, content: "בשנה שעברה, 'יצחק שרייר' (3100) היה/הייתה מצוות/ת למארח/ת יאיר ונועה (6039). בצד של המארחים הוא/היא 14038.")
    w = Witness.find(3100)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1041).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרים ליניאל' (1041) היה/הייתה מצוות/ת למארח/ת נועה יחזקאל (7054). בצד של המארחים הוא/היא 17632.")
    w = Witness.find(1041)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1067).comments.create!(user_id: 415, content: "בשנה שעברה, 'שוש ציוני' (1067) היה/הייתה מצוות/ת למארח/ת אוסנת פידל (8090). בצד של המארחים הוא/היא 18834.")
    w = Witness.find(1067)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1061).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמעונה גודורוב' (1061) היה/הייתה מצוות/ת למארח/ת רימה פוגץ שנדלזון (614). בצד של המארחים הוא/היא 664.")
    w = Witness.find(1061)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2128).comments.create!(user_id: 415, content: "בשנה שעברה, 'שולמית לוין' (2128) היה/הייתה מצוות/ת למארח/ת שני מוצא (7318). בצד של המארחים הוא/היא 17932.")
    w = Witness.find(2128)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1050).comments.create!(user_id: 415, content: "בשנה שעברה, 'תמר סמט' (1050) היה/הייתה מצוות/ת למארח/ת מני חולי (6956). בצד של המארחים הוא/היא 17522.")
    w = Witness.find(1050)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2011).comments.create!(user_id: 415, content: "בשנה שעברה, 'טורי ברוכי' (2011) היה/הייתה מצוות/ת למארח/ת גלדיס גירש (2879). בצד של המארחים הוא/היא 8748.")
    w = Witness.find(2011)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1721).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיה זינו' (1721) היה/הייתה מצוות/ת למארח/ת ענבל ענבר (8512). בצד של המארחים הוא/היא 19458.")
    w = Witness.find(1721)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2311).comments.create!(user_id: 415, content: "בשנה שעברה, 'נילי גרוסמן' (2311) היה/הייתה מצוות/ת למארח/ת אסף שוורץ (401). בצד של המארחים הוא/היא 435.")
    w = Witness.find(2311)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3114).comments.create!(user_id: 415, content: "בשנה שעברה, 'אינס קדוש' (3114) היה/הייתה מצוות/ת למארח/ת מיכל לוי (8306). בצד של המארחים הוא/היא 19123.")
    w = Witness.find(3114)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1366).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלקה בירנשטיין' (1366) היה/הייתה מצוות/ת למארח/ת ליאן מסטבוים (9644). בצד של המארחים הוא/היא 23079.")
    w = Witness.find(1366)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1354).comments.create!(user_id: 415, content: "בשנה שעברה, 'אביחי צור' (1354) היה/הייתה מצוות/ת למארח/ת נויבואר מרגלית (7913). בצד של המארחים הוא/היא 18628.")
    w = Witness.find(1354)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3107).comments.create!(user_id: 415, content: "בשנה שעברה, 'אהרון דביר' (3107) היה/הייתה מצוות/ת למארח/ת פאב שדרות (8031). בצד של המארחים הוא/היא 18763.")
    w = Witness.find(3107)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3108).comments.create!(user_id: 415, content: "בשנה שעברה, 'מייקל בן יוסף' (3108) היה/הייתה מצוות/ת למארח/ת אנה לדביץ (1774). בצד של המארחים הוא/היא 2786.")
    w = Witness.find(3108)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1385).comments.create!(user_id: 415, content: "בשנה שעברה, 'יובל ירח' (1385) היה/הייתה מצוות/ת למארח/ת רועי אלבה (8715). בצד של המארחים הוא/היא 19800.")
    w = Witness.find(1385)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1104).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתר חכמון' (1104) היה/הייתה מצוות/ת למארח/ת נעמי שמרה (9627). בצד של המארחים הוא/היא 22980.")
    w = Witness.find(1104)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1086).comments.create!(user_id: 415, content: "בשנה שעברה, 'לביאה פישר' (1086) היה/הייתה מצוות/ת למארח/ת רותי חזן (7550). בצד של המארחים הוא/היא 18203.")
    w = Witness.find(1086)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(350).comments.create!(user_id: 415, content: "בשנה שעברה, 'פנינה קציר' (350) היה/הייתה מצוות/ת למארח/ת עמית פינסקר (6560). בצד של המארחים הוא/היא 17108.")
    w = Witness.find(350)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1084).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל סקלי' (1084) היה/הייתה מצוות/ת למארח/ת איריס אברהם (7397). בצד של המארחים הוא/היא 18030.")
    w = Witness.find(1084)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3113).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה קרייסברגר' (3113) היה/הייתה מצוות/ת למארח/ת אברהם ושמחה לוין (8054). בצד של המארחים הוא/היא 18788.")
    w = Witness.find(3113)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1382).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה פלד' (1382) היה/הייתה מצוות/ת למארח/ת רינה טויטו (6620). בצד של המארחים הוא/היא 17166.")
    w = Witness.find(1382)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1090).comments.create!(user_id: 415, content: "בשנה שעברה, 'ישראל אייזן' (1090) היה/הייתה מצוות/ת למארח/ת טליה כהן (7251). בצד של המארחים הוא/היא 17849.")
    w = Witness.find(1090)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1383).comments.create!(user_id: 415, content: "בשנה שעברה, 'יעקב גרוס' (1383) היה/הייתה מצוות/ת למארח/ת צליל גרוס (7908). בצד של המארחים הוא/היא 18622.")
    w = Witness.find(1383)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1379).comments.create!(user_id: 415, content: "בשנה שעברה, 'פניה גללר' (1379) היה/הייתה מצוות/ת למארח/ת אלונה בויארסקי (8923). בצד של המארחים הוא/היא 20237.")
    w = Witness.find(1379)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2131).comments.create!(user_id: 415, content: "בשנה שעברה, 'רותי אילת' (2131) היה/הייתה מצוות/ת למארח/ת רוצם גרוס (8665). בצד של המארחים הוא/היא 19704.")
    w = Witness.find(2131)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2308).comments.create!(user_id: 415, content: "בשנה שעברה, 'שלומית ישי' (2308) היה/הייתה מצוות/ת למארח/ת פידלר נועה (7986). בצד של המארחים הוא/היא 18718.")
    w = Witness.find(2308)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(483).comments.create!(user_id: 415, content: "בשנה שעברה, 'הרמן צבי' (483) היה/הייתה מצוות/ת למארח/ת דניאל תנהנגל (6995). בצד של המארחים הוא/היא 17564.")
    w = Witness.find(483)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3130).comments.create!(user_id: 415, content: "בשנה שעברה, 'דליה וינמן' (3130) היה/הייתה מצוות/ת למארח/ת נועה אלקיים (7552). בצד של המארחים הוא/היא 18205.")
    w = Witness.find(3130)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1177).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה חכמון' (1177) היה/הייתה מצוות/ת למארח/ת שחר לינצנברג (6677). בצד של המארחים הוא/היא 17221.")
    w = Witness.find(1177)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3125).comments.create!(user_id: 415, content: "בשנה שעברה, 'מאיה לינשיץ' (3125) היה/הייתה מצוות/ת למארח/ת שרה נחמיאס (8718). בצד של המארחים הוא/היא 19805.")
    w = Witness.find(3125)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1394).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתר יטבת' (1394) היה/הייתה מצוות/ת למארח/ת שני חממה - צוות תכנית אב לתחבורה (6498). בצד של המארחים הוא/היא 17048.")
    w = Witness.find(1394)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3118).comments.create!(user_id: 415, content: "בשנה שעברה, 'פוגל חיה' (3118) היה/הייתה מצוות/ת למארח/ת הילה קוטלר (9399). בצד של המארחים הוא/היא 21869.")
    w = Witness.find(3118)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1161).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלכס לימון' (1161) היה/הייתה מצוות/ת למארח/ת רחל (קוקה) כהן-רונן (7797). בצד של המארחים הוא/היא 18496.")
    w = Witness.find(1161)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1392).comments.create!(user_id: 415, content: "בשנה שעברה, 'הדסה פרומן' (1392) היה/הייתה מצוות/ת למארח/ת מעין נחום (7132). בצד של המארחים הוא/היא 3562.")
    w = Witness.find(1392)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(254).comments.create!(user_id: 415, content: "בשנה שעברה, 'גרין חיים' (254) היה/הייתה מצוות/ת למארח/ת בר שור (6667). בצד של המארחים הוא/היא 17211.")
    w = Witness.find(254)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(912).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרים אויפרט' (912) היה/הייתה מצוות/ת למארח/ת שי טאוב (6592). בצד של המארחים הוא/היא 17138.")
    w = Witness.find(912)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1815).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתר כרמי' (1815) היה/הייתה מצוות/ת למארח/ת יערה מור (6943). בצד של המארחים הוא/היא 17508.")
    w = Witness.find(1815)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2015).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה ברגמן' (2015) היה/הייתה מצוות/ת למארח/ת הילה אייכלר (7453). בצד של המארחים הוא/היא 18093.")
    w = Witness.find(2015)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1386).comments.create!(user_id: 415, content: "בשנה שעברה, 'ג'ודי גליקסון פסטרנק' (1386) היה/הייתה מצוות/ת למארח/ת ג'רי וינוקור ליבלין (7548). בצד של המארחים הוא/היא 18201.")
    w = Witness.find(1386)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3122).comments.create!(user_id: 415, content: "בשנה שעברה, 'צבי וינברג' (3122) היה/הייתה מצוות/ת למארח/ת גולייט גולדנברג אלבז (8907). בצד של המארחים הוא/היא 14558.")
    w = Witness.find(3122)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3126).comments.create!(user_id: 415, content: "בשנה שעברה, 'גיורא ירדני' (3126) היה/הייתה מצוות/ת למארח/ת שירן גומל (9554). בצד של המארחים הוא/היא 22620.")
    w = Witness.find(3126)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(551).comments.create!(user_id: 415, content: "בשנה שעברה, 'גדי פינאלי' (551) היה/הייתה מצוות/ת למארח/ת מיכל גיטלר (756). בצד של המארחים הוא/היא 809.")
    w = Witness.find(551)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3121).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית ואשר לקס' (3121) היה/הייתה מצוות/ת למארח/ת עמית פרץ (950). בצד של המארחים הוא/היא 1034.")
    w = Witness.find(3121)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1723).comments.create!(user_id: 415, content: "בשנה שעברה, 'דן ורדי' (1723) היה/הייתה מצוות/ת למארח/ת נעם שמש (7399). בצד של המארחים הוא/היא 18032.")
    w = Witness.find(1723)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1405).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלי אללי' (1405) היה/הייתה מצוות/ת למארח/ת אלין אהרון (7287). בצד של המארחים הוא/היא 17896.")
    w = Witness.find(1405)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1183).comments.create!(user_id: 415, content: "בשנה שעברה, 'אילונה קוזין' (1183) היה/הייתה מצוות/ת למארח/ת ענבר צוברי (6713). בצד של המארחים הוא/היא 17256.")
    w = Witness.find(1183)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2337).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוסי רון' (2337) היה/הייתה מצוות/ת למארח/ת עליזה רון (5456). בצד של המארחים הוא/היא 12422.")
    w = Witness.find(2337)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2333).comments.create!(user_id: 415, content: "בשנה שעברה, 'טל מסקוביץ'' (2333) היה/הייתה מצוות/ת למארח/ת מתנ\"ס שיכוני-המזרח ראשל\"צ (2223). בצד של המארחים הוא/היא 4165.")
    w = Witness.find(2333)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1155).comments.create!(user_id: 415, content: "בשנה שעברה, 'הרמן יעקובסון' (1155) היה/הייתה מצוות/ת למארח/ת גלית דלויה (6780). בצד של המארחים הוא/היא 17329.")
    w = Witness.find(1155)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1262).comments.create!(user_id: 415, content: "בשנה שעברה, 'דוד רץ' (1262) היה/הייתה מצוות/ת למארח/ת ירדן לוגסי (7168). בצד של המארחים הוא/היא 17758.")
    w = Witness.find(1262)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1172).comments.create!(user_id: 415, content: "בשנה שעברה, 'זאב מושקוביץ' (1172) היה/הייתה מצוות/ת למארח/ת רום שיבי (941). בצד של המארחים הוא/היא 1022.")
    w = Witness.find(1172)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2013).comments.create!(user_id: 415, content: "בשנה שעברה, 'לאון קופלמן' (2013) היה/הייתה מצוות/ת למארח/ת ירדן הניק (8587). בצד של המארחים הוא/היא 19566.")
    w = Witness.find(2013)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2050).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמעון טל' (2050) היה/הייתה מצוות/ת למארח/ת תם אור שחר (8359). בצד של המארחים הוא/היא 19187.")
    w = Witness.find(2050)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2675).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה יעקב' (2675) היה/הייתה מצוות/ת למארח/ת מכינה קדם צבאית  ידידיה - חוות משואות יצחק הישנה (7729). בצד של המארחים הוא/היא 18420.")
    w = Witness.find(2675)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1211).comments.create!(user_id: 415, content: "בשנה שעברה, 'זאב ארנון' (1211) היה/הייתה מצוות/ת למארח/ת הודיה אוגלי (7470). בצד של המארחים הוא/היא 18112.")
    w = Witness.find(1211)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2023).comments.create!(user_id: 415, content: "בשנה שעברה, 'מלכה ברש' (2023) היה/הייתה מצוות/ת למארח/ת סיוון רט (4035). בצד של המארחים הוא/היא 10185.")
    w = Witness.find(2023)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1832).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלעד רוטנברג' (1832) היה/הייתה מצוות/ת למארח/ת ליהי עינב (1876). בצד של המארחים הוא/היא 3073.")
    w = Witness.find(1832)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1224).comments.create!(user_id: 415, content: "בשנה שעברה, 'נורית יוסף' (1224) היה/הייתה מצוות/ת למארח/ת אפרת פנחס (7116). בצד של המארחים הוא/היא 17699.")
    w = Witness.find(1224)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(325).comments.create!(user_id: 415, content: "בשנה שעברה, 'שושנה לביא' (325) היה/הייתה מצוות/ת למארח/ת ניסיםמויוספה בן כהן (6113). בצד של המארחים הוא/היא 14421.")
    w = Witness.find(325)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2257).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברוך  נתן' (2257) היה/הייתה מצוות/ת למארח/ת אסתר רז (6748). בצד של המארחים הוא/היא 17292.")
    w = Witness.find(2257)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2053).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוכבד ראט' (2053) היה/הייתה מצוות/ת למארח/ת ליטל ניסני (6535). בצד של המארחים הוא/היא 17080.")
    w = Witness.find(2053)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1841).comments.create!(user_id: 415, content: "בשנה שעברה, 'יצחק רוטשטיין' (1841) היה/הייתה מצוות/ת למארח/ת אודליה פריד (6614). בצד של המארחים הוא/היא 17160.")
    w = Witness.find(1841)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3128).comments.create!(user_id: 415, content: "בשנה שעברה, 'בוריס יאמפולסקי' (3128) היה/הייתה מצוות/ת למארח/ת קורל הורן (8493). בצד של המארחים הוא/היא 19422.")
    w = Witness.find(3128)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2255).comments.create!(user_id: 415, content: "בשנה שעברה, 'סוניה פלדמן' (2255) היה/הייתה מצוות/ת למארח/ת יעלה קלמי (6689). בצד של המארחים הוא/היא 17232.")
    w = Witness.find(2255)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2014).comments.create!(user_id: 415, content: "בשנה שעברה, 'אידה גרף' (2014) היה/הייתה מצוות/ת למארח/ת רונית עזיזה- אל על (8050). בצד של המארחים הוא/היא 18783.")
    w = Witness.find(2014)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1258).comments.create!(user_id: 415, content: "בשנה שעברה, 'שלמה איפנברג' (1258) היה/הייתה מצוות/ת למארח/ת דוד קייסר (8904). בצד של המארחים הוא/היא 20199.")
    w = Witness.find(1258)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2029).comments.create!(user_id: 415, content: "בשנה שעברה, 'צילה וסרמן' (2029) היה/הייתה מצוות/ת למארח/ת אבי נעים (8772). בצד של המארחים הוא/היא 19902.")
    w = Witness.find(2029)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1837).comments.create!(user_id: 415, content: "בשנה שעברה, 'רינה שחם' (1837) היה/הייתה מצוות/ת למארח/ת ברית שיימס (9393). בצד של המארחים הוא/היא 21843.")
    w = Witness.find(1837)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1724).comments.create!(user_id: 415, content: "בשנה שעברה, 'איציק אבל' (1724) היה/הייתה מצוות/ת למארח/ת חן אשד (7752). בצד של המארחים הוא/היא 18445.")
    w = Witness.find(1724)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3135).comments.create!(user_id: 415, content: "בשנה שעברה, 'זהבה הדר' (3135) היה/הייתה מצוות/ת למארח/ת ליאור דיהי (8490). בצד של המארחים הוא/היא 19419.")
    w = Witness.find(3135)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(33).comments.create!(user_id: 415, content: "בשנה שעברה, 'ראובן מוזר' (33) היה/הייתה מצוות/ת למארח/ת אלעד רומי (9737). בצד של המארחים הוא/היא 23724.")
    w = Witness.find(33)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2048).comments.create!(user_id: 415, content: "בשנה שעברה, 'רבקה טייר' (2048) היה/הייתה מצוות/ת למארח/ת חנה ישעיהו (6960). בצד של המארחים הוא/היא 17526.")
    w = Witness.find(2048)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(14).comments.create!(user_id: 415, content: "בשנה שעברה, 'צביקה אריאב' (14) היה/הייתה מצוות/ת למארח/ת שחף וילנסקי (6865). בצד של המארחים הוא/היא 17421.")
    w = Witness.find(14)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(624).comments.create!(user_id: 415, content: "בשנה שעברה, 'אברהם אוטינגר' (624) היה/הייתה מצוות/ת למארח/ת איריס שש- כוכבי  { בשם קיבוץ מצפה שלם } (7130). בצד של המארחים הוא/היא 17716.")
    w = Witness.find(624)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2027).comments.create!(user_id: 415, content: "בשנה שעברה, 'עמוס חן' (2027) היה/הייתה מצוות/ת למארח/ת חן חגואל (2811). בצד של המארחים הוא/היא 8354.")
    w = Witness.find(2027)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3134).comments.create!(user_id: 415, content: "בשנה שעברה, 'בלהה ומוטי' (3134) היה/הייתה מצוות/ת למארח/ת הילה טחן (5810). בצד של המארחים הוא/היא 13327.")
    w = Witness.find(3134)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1833).comments.create!(user_id: 415, content: "בשנה שעברה, 'ענת גרי לקריף' (1833) היה/הייתה מצוות/ת למארח/ת חיים אבקסיס (7608). בצד של המארחים הוא/היא 18278.")
    w = Witness.find(1833)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(312).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיה פלאט ארביב' (312) היה/הייתה מצוות/ת למארח/ת נוה פרג'ון (8596). בצד של המארחים הוא/היא 19576.")
    w = Witness.find(312)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1286).comments.create!(user_id: 415, content: "בשנה שעברה, 'דליה גביש' (1286) היה/הייתה מצוות/ת למארח/ת מעיין שוחט (8816). בצד של המארחים הוא/היא 19996.")
    w = Witness.find(1286)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3132).comments.create!(user_id: 415, content: "בשנה שעברה, 'דוד טייכהולץ' (3132) היה/הייתה מצוות/ת למארח/ת רוי בן דוד (8738). בצד של המארחים הוא/היא 19839.")
    w = Witness.find(3132)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1538).comments.create!(user_id: 415, content: "בשנה שעברה, 'רונן הרן' (1538) היה/הייתה מצוות/ת למארח/ת יעל אלון (9443). בצד של המארחים הוא/היא 22111.")
    w = Witness.find(1538)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1838).comments.create!(user_id: 415, content: "בשנה שעברה, 'רותי שטילמן' (1838) היה/הייתה מצוות/ת למארח/ת אלה וטורי (8409). בצד של המארחים הוא/היא 19288.")
    w = Witness.find(1838)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(35).comments.create!(user_id: 415, content: "בשנה שעברה, 'סילביה סילבס' (35) היה/הייתה מצוות/ת למארח/ת יפעת (9631). בצד של המארחים הוא/היא 22998.")
    w = Witness.find(35)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2057).comments.create!(user_id: 415, content: "בשנה שעברה, 'כרמלה ושלמה גולדנברג' (2057) היה/הייתה מצוות/ת למארח/ת תמר קדוש (6866). בצד של המארחים הוא/היא 17422.")
    w = Witness.find(2057)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(115).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה פרימרמן' (115) היה/הייתה מצוות/ת למארח/ת בן עזרא (7426). בצד של המארחים הוא/היא 18063.")
    w = Witness.find(115)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1251).comments.create!(user_id: 415, content: "בשנה שעברה, 'ורדה מידר' (1251) היה/הייתה מצוות/ת למארח/ת יעקב קורץ (5042). בצד של המארחים הוא/היא 11612.")
    w = Witness.find(1251)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2676).comments.create!(user_id: 415, content: "בשנה שעברה, 'דב פיירשטיין' (2676) היה/הייתה מצוות/ת למארח/ת ינון תורגמן (8093). בצד של המארחים הוא/היא 18837.")
    w = Witness.find(2676)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2025).comments.create!(user_id: 415, content: "בשנה שעברה, 'גילת שילה' (2025) היה/הייתה מצוות/ת למארח/ת פאב המפלצת אנחנו קופראטיב (6846). בצד של המארחים הוא/היא 17402.")
    w = Witness.find(2025)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1282).comments.create!(user_id: 415, content: "בשנה שעברה, 'שושנה גרוס' (1282) היה/הייתה מצוות/ת למארח/ת ירדן הברפלד (8565). בצד של המארחים הוא/היא 19537.")
    w = Witness.find(1282)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1289).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל אוזן' (1289) היה/הייתה מצוות/ת למארח/ת ורדיאל 17 - בית הצעירים של דרום העיר תל אביב (8248). בצד של המארחים הוא/היא 19033.")
    w = Witness.find(1289)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1583).comments.create!(user_id: 415, content: "בשנה שעברה, 'תמר מצ'אדו' (1583) היה/הייתה מצוות/ת למארח/ת חגית באלי (8637). בצד של המארחים הוא/היא 19642.")
    w = Witness.find(1583)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3141).comments.create!(user_id: 415, content: "בשנה שעברה, 'קופרי סבטלנה' (3141) היה/הייתה מצוות/ת למארח/ת שלומית פריבר (3189). בצד של המארחים הוא/היא 9074.")
    w = Witness.find(3141)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(76).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה בכור' (76) היה/הייתה מצוות/ת למארח/ת ארז ברק (9378). בצד של המארחים הוא/היא 21769.")
    w = Witness.find(76)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(657).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיים גולדשטיין' (657) היה/הייתה מצוות/ת למארח/ת דניאל דוידי (6793). בצד של המארחים הוא/היא 17341.")
    w = Witness.find(657)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(357).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה מילר' (357) היה/הייתה מצוות/ת למארח/ת אלון מור (6784). בצד של המארחים הוא/היא 4276.")
    w = Witness.find(357)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1334).comments.create!(user_id: 415, content: "בשנה שעברה, 'יפים סטולרוב' (1334) היה/הייתה מצוות/ת למארח/ת אפרת (1582). בצד של המארחים הוא/היא 2305.")
    w = Witness.find(1334)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(69).comments.create!(user_id: 415, content: "בשנה שעברה, 'ציפורה סנדרוביץ' (69) היה/הייתה מצוות/ת למארח/ת ענבר בן נון (8419). בצד של המארחים הוא/היא 19316.")
    w = Witness.find(69)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(89).comments.create!(user_id: 415, content: "בשנה שעברה, 'רבקה ליבוביץ' (89) היה/הייתה מצוות/ת למארח/ת הילה אביאל (8956). בצד של המארחים הוא/היא 20325.")
    w = Witness.find(89)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(23).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה הדר' (23) היה/הייתה מצוות/ת למארח/ת צביה הדל (9514). בצד של המארחים הוא/היא 22464.")
    w = Witness.find(23)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2278).comments.create!(user_id: 415, content: "בשנה שעברה, 'מוט פייר' (2278) היה/הייתה מצוות/ת למארח/ת מאור שטרן- מרכז קהילתי חוף חפר (7445). בצד של המארחים הוא/היא 18085.")
    w = Witness.find(2278)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2677).comments.create!(user_id: 415, content: "בשנה שעברה, 'גיל אהרוני' (2677) היה/הייתה מצוות/ת למארח/ת בתיה מאיר (6860). בצד של המארחים הוא/היא 17416.")
    w = Witness.find(2677)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1825).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה צביבך' (1825) היה/הייתה מצוות/ת למארח/ת סתיו בן שימול (7258). בצד של המארחים הוא/היא 17859.")
    w = Witness.find(1825)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(160).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית וינר' (160) היה/הייתה מצוות/ת למארח/ת שקד טייב (3339). בצד של המארחים הוא/היא 9220.")
    w = Witness.find(160)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2274).comments.create!(user_id: 415, content: "בשנה שעברה, 'קרולינה אייזן' (2274) היה/הייתה מצוות/ת למארח/ת דנה שואר (6996). בצד של המארחים הוא/היא 17565.")
    w = Witness.find(2274)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2046).comments.create!(user_id: 415, content: "בשנה שעברה, 'כלילה מרגלית' (2046) היה/הייתה מצוות/ת למארח/ת נאוה רוזנפלד (6568). בצד של המארחים הוא/היא 17115.")
    w = Witness.find(2046)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(422).comments.create!(user_id: 415, content: "בשנה שעברה, 'נעמי רגב' (422) היה/הייתה מצוות/ת למארח/ת איריס קפלן (6623). בצד של המארחים הוא/היא 17169.")
    w = Witness.find(422)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2042).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה קרצו' (2042) היה/הייתה מצוות/ת למארח/ת שחר ברקאי (7398). בצד של המארחים הוא/היא 18031.")
    w = Witness.find(2042)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3046).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסף בלאו' (3046) היה/הייתה מצוות/ת למארח/ת עמרי עידן קורן (1874). בצד של המארחים הוא/היא 3062.")
    w = Witness.find(3046)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(183).comments.create!(user_id: 415, content: "בשנה שעברה, 'מלכה ירון' (183) היה/הייתה מצוות/ת למארח/ת ליאת בכר אשכנזי (6550). בצד של המארחים הוא/היא 17099.")
    w = Witness.find(183)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(829).comments.create!(user_id: 415, content: "בשנה שעברה, 'רותי שריג' (829) היה/הייתה מצוות/ת למארח/ת Michal Ner-David (7272). בצד של המארחים הוא/היא 17876.")
    w = Witness.find(829)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(179).comments.create!(user_id: 415, content: "בשנה שעברה, 'ראובן (רוברט) פורר' (179) היה/הייתה מצוות/ת למארח/ת עיינה מירוצניק (7546). בצד של המארחים הוא/היא 18199.")
    w = Witness.find(179)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(134).comments.create!(user_id: 415, content: "בשנה שעברה, 'רלי שולקינד' (134) היה/הייתה מצוות/ת למארח/ת סיון רז (8038). בצד של המארחים הוא/היא 18770.")
    w = Witness.find(134)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2039).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלי ביר' (2039) היה/הייתה מצוות/ת למארח/ת אלה תאודור (7307). בצד של המארחים הוא/היא 17920.")
    w = Witness.find(2039)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3074).comments.create!(user_id: 415, content: "בשנה שעברה, 'נינה אביוב' (3074) היה/הייתה מצוות/ת למארח/ת לינוי אוליאל (6726). בצד של המארחים הוא/היא 17269.")
    w = Witness.find(3074)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(210).comments.create!(user_id: 415, content: "בשנה שעברה, 'טומי ברייער' (210) היה/הייתה מצוות/ת למארח/ת שני מסקין (9713). בצד של המארחים הוא/היא 23539.")
    w = Witness.find(210)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2035).comments.create!(user_id: 415, content: "בשנה שעברה, 'רפי אוסטרוף' (2035) היה/הייתה מצוות/ת למארח/ת רעות (7884). בצד של המארחים הוא/היא 18595.")
    w = Witness.find(2035)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(163).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוכי בשיסטה' (163) היה/הייתה מצוות/ת למארח/ת ירדן זאוי (9748). בצד של המארחים הוא/היא 23783.")
    w = Witness.find(163)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1849).comments.create!(user_id: 415, content: "בשנה שעברה, 'יפה אורבך' (1849) היה/הייתה מצוות/ת למארח/ת עמרם אהוד (4520). בצד של המארחים הוא/היא 10804.")
    w = Witness.find(1849)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(80).comments.create!(user_id: 415, content: "בשנה שעברה, 'איציק זינגר' (80) היה/הייתה מצוות/ת למארח/ת שקד המבר (2194). בצד של המארחים הוא/היא 4023.")
    w = Witness.find(80)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(200).comments.create!(user_id: 415, content: "בשנה שעברה, 'אליעזר ראוזנרמן' (200) היה/הייתה מצוות/ת למארח/ת שירה בן דהן (9058). בצד של המארחים הוא/היא 20647.")
    w = Witness.find(200)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(74).comments.create!(user_id: 415, content: "בשנה שעברה, 'צבי לביא' (74) היה/הייתה מצוות/ת למארח/ת אלה שאול (7648). בצד של המארחים הוא/היא 18326.")
    w = Witness.find(74)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1774).comments.create!(user_id: 415, content: "בשנה שעברה, 'רבקה רצ'בסקי' (1774) היה/הייתה מצוות/ת למארח/ת רחל הוד (2054). בצד של המארחים הוא/היא 3607.")
    w = Witness.find(1774)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(498).comments.create!(user_id: 415, content: "בשנה שעברה, 'עדנה בלילו' (498) היה/הייתה מצוות/ת למארח/ת יותם מויאל (4210). בצד של המארחים הוא/היא 10403.")
    w = Witness.find(498)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(754).comments.create!(user_id: 415, content: "בשנה שעברה, 'פועה לין' (754) היה/הייתה מצוות/ת למארח/ת דניאלה אבנרי (7568). בצד של המארחים הוא/היא 18225.")
    w = Witness.find(754)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1850).comments.create!(user_id: 415, content: "בשנה שעברה, 'בלה סולומון' (1850) היה/הייתה מצוות/ת למארח/ת נילי חומן (7138). בצד של המארחים הוא/היא 17723.")
    w = Witness.find(1850)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3144).comments.create!(user_id: 415, content: "בשנה שעברה, 'נרינסקי מיכאל' (3144) היה/הייתה מצוות/ת למארח/ת שמעון אטיאס (8048). בצד של המארחים הוא/היא 18781.")
    w = Witness.find(3144)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2256).comments.create!(user_id: 415, content: "בשנה שעברה, 'דינה בר-און' (2256) היה/הייתה מצוות/ת למארח/ת שבי פודגור (9427). בצד של המארחים הוא/היא 21990.")
    w = Witness.find(2256)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(230).comments.create!(user_id: 415, content: "בשנה שעברה, 'לאה טייכר' (230) היה/הייתה מצוות/ת למארח/ת תמי זוזל (8115). בצד של המארחים הוא/היא 18858.")
    w = Witness.find(230)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1252).comments.create!(user_id: 415, content: "בשנה שעברה, 'אביבה טל' (1252) היה/הייתה מצוות/ת למארח/ת בני אשכנזי (3380). בצד של המארחים הוא/היא 9267.")
    w = Witness.find(1252)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(207).comments.create!(user_id: 415, content: "בשנה שעברה, 'מצליח חכמון' (207) היה/הייתה מצוות/ת למארח/ת שמעון איפרגן (7226). בצד של המארחים הוא/היא 17823.")
    w = Witness.find(207)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(242).comments.create!(user_id: 415, content: "בשנה שעברה, 'רבקה וויס' (242) היה/הייתה מצוות/ת למארח/ת מירי סרברו- עמותת אנוש (8467). בצד של המארחים הוא/היא 19393.")
    w = Witness.find(242)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3140).comments.create!(user_id: 415, content: "בשנה שעברה, 'דוד הדר' (3140) היה/הייתה מצוות/ת למארח/ת סיגל בר (3828). בצד של המארחים הוא/היא 9906.")
    w = Witness.find(3140)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2254).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמואל וכטל' (2254) היה/הייתה מצוות/ת למארח/ת ענבר אסודי (6838). בצד של המארחים הוא/היא 17393.")
    w = Witness.find(2254)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(228).comments.create!(user_id: 415, content: "בשנה שעברה, 'ניבה ברדה' (228) היה/הייתה מצוות/ת למארח/ת שרי אלדר (7537). בצד של המארחים הוא/היא 18189.")
    w = Witness.find(228)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(251).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה רוזנבאום' (251) היה/הייתה מצוות/ת למארח/ת איריס אליה כהן (7099). בצד של המארחים הוא/היא 17684.")
    w = Witness.find(251)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1727).comments.create!(user_id: 415, content: "בשנה שעברה, 'סיגלית יפה' (1727) היה/הייתה מצוות/ת למארח/ת יפעת טהרני (7620). בצד של המארחים הוא/היא 18292.")
    w = Witness.find(1727)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1085).comments.create!(user_id: 415, content: "בשנה שעברה, 'בבי סלומון' (1085) היה/הייתה מצוות/ת למארח/ת מאיה לוי (8548). בצד של המארחים הוא/היא 19511.")
    w = Witness.find(1085)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(305).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלברט ודרורה כהן' (305) היה/הייתה מצוות/ת למארח/ת רומי קנאפו (8640). בצד של המארחים הוא/היא 19646.")
    w = Witness.find(305)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3139).comments.create!(user_id: 415, content: "בשנה שעברה, 'כוגן תמרה' (3139) היה/הייתה מצוות/ת למארח/ת יוסף ורעות ברדא (7847). בצד של המארחים הוא/היא 18549.")
    w = Witness.find(3139)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2065).comments.create!(user_id: 415, content: "בשנה שעברה, 'גרטה סלון' (2065) היה/הייתה מצוות/ת למארח/ת Muriel Davis (8610). בצד של המארחים הוא/היא 19601.")
    w = Witness.find(2065)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3155).comments.create!(user_id: 415, content: "בשנה שעברה, 'טרוסמן יעקב' (3155) היה/הייתה מצוות/ת למארח/ת אביב זמיר (757). בצד של המארחים הוא/היא 810.")
    w = Witness.find(3155)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3151).comments.create!(user_id: 415, content: "בשנה שעברה, 'גיטה גלר' (3151) היה/הייתה מצוות/ת למארח/ת נעה שופר (9590). בצד של המארחים הוא/היא 22801.")
    w = Witness.find(3151)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(278).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתר שיינברג' (278) היה/הייתה מצוות/ת למארח/ת עמיר דדון (8543). בצד של המארחים הוא/היא 19506.")
    w = Witness.find(278)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3145).comments.create!(user_id: 415, content: "בשנה שעברה, 'אולשנסקי לובה' (3145) היה/הייתה מצוות/ת למארח/ת ליאת ארליך (8924). בצד של המארחים הוא/היא 20238.")
    w = Witness.find(3145)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3150).comments.create!(user_id: 415, content: "בשנה שעברה, 'אבי נודלמן' (3150) היה/הייתה מצוות/ת למארח/ת מיטל פרג (5499). בצד של המארחים הוא/היא 12490.")
    w = Witness.find(3150)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2092).comments.create!(user_id: 415, content: "בשנה שעברה, 'בני צבר' (2092) היה/הייתה מצוות/ת למארח/ת דלית כהן (7461). בצד של המארחים הוא/היא 18102.")
    w = Witness.find(2092)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3143).comments.create!(user_id: 415, content: "בשנה שעברה, 'ביחוב אניה' (3143) היה/הייתה מצוות/ת למארח/ת אנה אור (8663). בצד של המארחים הוא/היא 19702.")
    w = Witness.find(3143)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3149).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוסי ולרשטיין' (3149) היה/הייתה מצוות/ת למארח/ת איתיאל שיינפלד (8570). בצד של המארחים הוא/היא 19543.")
    w = Witness.find(3149)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(289).comments.create!(user_id: 415, content: "בשנה שעברה, 'זהבה אמיץ' (289) היה/הייתה מצוות/ת למארח/ת ליבנת מזרחי (7865). בצד של המארחים הוא/היא 18571.")
    w = Witness.find(289)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(328).comments.create!(user_id: 415, content: "בשנה שעברה, 'רונית ברגמן' (328) היה/הייתה מצוות/ת למארח/ת רותם שרה בן יהושע (9000). בצד של המארחים הוא/היא 20455.")
    w = Witness.find(328)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3137).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהושע זונטג' (3137) היה/הייתה מצוות/ת למארח/ת גלעד בלום (8852). בצד של המארחים הוא/היא 20103.")
    w = Witness.find(3137)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(366).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה גודמן' (366) היה/הייתה מצוות/ת למארח/ת מור (1443). בצד של המארחים הוא/היא 1995.")
    w = Witness.find(366)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(331).comments.create!(user_id: 415, content: "בשנה שעברה, 'דינה חן' (331) היה/הייתה מצוות/ת למארח/ת מאיה דיסקין (מרכז וולטה לנוער) (459). בצד של המארחים הוא/היא 504.")
    w = Witness.find(331)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(337).comments.create!(user_id: 415, content: "בשנה שעברה, 'צבי בן פורת' (337) היה/הייתה מצוות/ת למארח/ת שני חממה (360). בצד של המארחים הוא/היא 392.")
    w = Witness.find(337)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(277).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלה ברקן' (277) היה/הייתה מצוות/ת למארח/ת יובל שרייבר (7923). בצד של המארחים הוא/היא 18639.")
    w = Witness.find(277)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3146).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלכס איווניר' (3146) היה/הייתה מצוות/ת למארח/ת נטלי ברוטמן (8453). בצד של המארחים הוא/היא 19373.")
    w = Witness.find(3146)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1854).comments.create!(user_id: 415, content: "בשנה שעברה, 'רינת גולן' (1854) היה/הייתה מצוות/ת למארח/ת שמעון ברק (4338). בצד של המארחים הוא/היא 10554.")
    w = Witness.find(1854)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3138).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה ברקון' (3138) היה/הייתה מצוות/ת למארח/ת ארז חמו (5464). בצד של המארחים הוא/היא 12432.")
    w = Witness.find(3138)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2356).comments.create!(user_id: 415, content: "בשנה שעברה, 'אידה מנס' (2356) היה/הייתה מצוות/ת למארח/ת דקלה תורתי (9206). בצד של המארחים הוא/היא 21150.")
    w = Witness.find(2356)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1664).comments.create!(user_id: 415, content: "בשנה שעברה, 'עזי ואן סטרטן' (1664) היה/הייתה מצוות/ת למארח/ת נועה קולב (7199). בצד של המארחים הוא/היא 17791.")
    w = Witness.find(1664)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(412).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרגא ברק' (412) היה/הייתה מצוות/ת למארח/ת נאור ויונטה (3538). בצד של המארחים הוא/היא 9515.")
    w = Witness.find(412)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(406).comments.create!(user_id: 415, content: "בשנה שעברה, 'בתיה כהנא' (406) היה/הייתה מצוות/ת למארח/ת עדי גינל (6839). בצד של המארחים הוא/היא 17394.")
    w = Witness.find(406)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(407).comments.create!(user_id: 415, content: "בשנה שעברה, 'לילי פרויד' (407) היה/הייתה מצוות/ת למארח/ת דנה ברששת (6645). בצד של המארחים הוא/היא 17190.")
    w = Witness.find(407)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1852).comments.create!(user_id: 415, content: "בשנה שעברה, 'מירי סיון' (1852) היה/הייתה מצוות/ת למארח/ת אוראל בלילטי (5346). בצד של המארחים הוא/היא 12239.")
    w = Witness.find(1852)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(386).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודה גולדשטיין' (386) היה/הייתה מצוות/ת למארח/ת דניאל אריאב (7223). בצד של המארחים הוא/היא 17820.")
    w = Witness.find(386)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2332).comments.create!(user_id: 415, content: "בשנה שעברה, 'רות מייסנר' (2332) היה/הייתה מצוות/ת למארח/ת עדי ונעם שכטר (8173). בצד של המארחים הוא/היא 18946.")
    w = Witness.find(2332)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3083).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוסף קלמנוביץ' (3083) היה/הייתה מצוות/ת למארח/ת ברק (6363). בצד של המארחים הוא/היא 16802.")
    w = Witness.find(3083)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(436).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה זילברמן' (436) היה/הייתה מצוות/ת למארח/ת שלי ואיתי וקסלר (3763). בצד של המארחים הוא/היא 9829.")
    w = Witness.find(436)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(273).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיליק בוגומולסקי' (273) היה/הייתה מצוות/ת למארח/ת גבריאל לזר (6762). בצד של המארחים הוא/היא 17306.")
    w = Witness.find(273)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3142).comments.create!(user_id: 415, content: "בשנה שעברה, 'נוביקוב לובה' (3142) היה/הייתה מצוות/ת למארח/ת דלינה רייטר (5259). בצד של המארחים הוא/היא 12066.")
    w = Witness.find(3142)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(424).comments.create!(user_id: 415, content: "בשנה שעברה, 'נאוה רודה' (424) היה/הייתה מצוות/ת למארח/ת אורלי הררי (8476). בצד של המארחים הוא/היא 19403.")
    w = Witness.find(424)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3156).comments.create!(user_id: 415, content: "בשנה שעברה, 'ליביה ביטון ג'קסון' (3156) היה/הייתה מצוות/ת למארח/ת חלי נעימי (8160). בצד של המארחים הוא/היא 18922.")
    w = Witness.find(3156)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3158).comments.create!(user_id: 415, content: "בשנה שעברה, 'ג'נין אוקנין' (3158) היה/הייתה מצוות/ת למארח/ת שמוליק דואק (6776). בצד של המארחים הוא/היא 17324.")
    w = Witness.find(3158)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2141).comments.create!(user_id: 415, content: "בשנה שעברה, 'אברהם תמר' (2141) היה/הייתה מצוות/ת למארח/ת פז שמש (7429). בצד של המארחים הוא/היא 18068.")
    w = Witness.find(2141)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(455).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה ליבמן' (455) היה/הייתה מצוות/ת למארח/ת רעות ליברמן (968). בצד של המארחים הוא/היא 1073.")
    w = Witness.find(455)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(460).comments.create!(user_id: 415, content: "בשנה שעברה, 'אבי לביא' (460) היה/הייתה מצוות/ת למארח/ת מור טביב (8906). בצד של המארחים הוא/היא 20206.")
    w = Witness.find(460)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(565).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל עזריה' (565) היה/הייתה מצוות/ת למארח/ת מיטל משה -מועדון כדורגל מכבי חיפה (8762). בצד של המארחים הוא/היא 19880.")
    w = Witness.find(565)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(457).comments.create!(user_id: 415, content: "בשנה שעברה, 'סימה גולצקי' (457) היה/הייתה מצוות/ת למארח/ת תפארת שטיימן (6664). בצד של המארחים הוא/היא 17208.")
    w = Witness.find(457)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(477).comments.create!(user_id: 415, content: "בשנה שעברה, 'ניצן אבקסיס' (477) היה/הייתה מצוות/ת למארח/ת שרון שוורץ (6786). בצד של המארחים הוא/היא 17334.")
    w = Witness.find(477)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(439).comments.create!(user_id: 415, content: "בשנה שעברה, 'ורד בן ארצי' (439) היה/הייתה מצוות/ת למארח/ת רוני לקר- עמותת אנוש גבעתיים (7203). בצד של המארחים הוא/היא 17795.")
    w = Witness.find(439)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1853).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה דקלו' (1853) היה/הייתה מצוות/ת למארח/ת עידן דטהר (5765). בצד של המארחים הוא/היא 13202.")
    w = Witness.find(1853)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(784).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוסף קנדל' (784) היה/הייתה מצוות/ת למארח/ת פריתס טל (8913). בצד של המארחים הוא/היא 20218.")
    w = Witness.find(784)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(644).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרסל מרקוביץ'' (644) היה/הייתה מצוות/ת למארח/ת לירון בייזר (7795). בצד של המארחים הוא/היא 18494.")
    w = Witness.find(644)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2680).comments.create!(user_id: 415, content: "בשנה שעברה, 'רבקה פנקס' (2680) היה/הייתה מצוות/ת למארח/ת אביב שיטרית (3235). בצד של המארחים הוא/היא 9119.")
    w = Witness.find(2680)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1879).comments.create!(user_id: 415, content: "בשנה שעברה, 'פאולינה שמיר' (1879) היה/הייתה מצוות/ת למארח/ת ארדיטי ציפי (7107). בצד של המארחים הוא/היא 17691.")
    w = Witness.find(1879)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2273).comments.create!(user_id: 415, content: "בשנה שעברה, 'שוש בן צבר' (2273) היה/הייתה מצוות/ת למארח/ת שובל כהן (8059). בצד של המארחים הוא/היא 18794.")
    w = Witness.find(2273)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(578).comments.create!(user_id: 415, content: "בשנה שעברה, 'פרלה פרלשטיין' (578) היה/הייתה מצוות/ת למארח/ת אלונה גזית (2157). בצד של המארחים הוא/היא 3869.")
    w = Witness.find(578)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1195).comments.create!(user_id: 415, content: "בשנה שעברה, 'נחום רוטנברג' (1195) היה/הייתה מצוות/ת למארח/ת אמירה פז (1943). בצד של המארחים הוא/היא 3306.")
    w = Witness.find(1195)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(647).comments.create!(user_id: 415, content: "בשנה שעברה, 'דב פלד' (647) היה/הייתה מצוות/ת למארח/ת בית ספר תורה ומדע (9411). בצד של המארחים הוא/היא 21924.")
    w = Witness.find(647)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(658).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל קיביץ' (658) היה/הייתה מצוות/ת למארח/ת רוני-לי וינוקור (8898). בצד של המארחים הוא/היא 20186.")
    w = Witness.find(658)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1865).comments.create!(user_id: 415, content: "בשנה שעברה, 'יפה שלזינגר' (1865) היה/הייתה מצוות/ת למארח/ת איריס ג'יבלי (4295). בצד של המארחים הוא/היא 10497.")
    w = Witness.find(1865)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(642).comments.create!(user_id: 415, content: "בשנה שעברה, 'שושנה רשף' (642) היה/הייתה מצוות/ת למארח/ת אלעזר יפה (5154). בצד של המארחים הוא/היא 11819.")
    w = Witness.find(642)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2090).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית בראל' (2090) היה/הייתה מצוות/ת למארח/ת בן ישראל שאול (8300). בצד של המארחים הוא/היא 19113.")
    w = Witness.find(2090)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1693).comments.create!(user_id: 415, content: "בשנה שעברה, 'אביטל פרלין' (1693) היה/הייתה מצוות/ת למארח/ת ענבר ורטהימר שינה (3933). בצד של המארחים הוא/היא 10038.")
    w = Witness.find(1693)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(655).comments.create!(user_id: 415, content: "בשנה שעברה, 'יפה קניג' (655) היה/הייתה מצוות/ת למארח/ת עדי כהן-סניף שיכון (8628). בצד של המארחים הוא/היא 19626.")
    w = Witness.find(655)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2074).comments.create!(user_id: 415, content: "בשנה שעברה, 'עליזה דרומי' (2074) היה/הייתה מצוות/ת למארח/ת עמיעד מערכות מים בע\"מ- שחף וילנסקי (2991). בצד של המארחים הוא/היא 8873.")
    w = Witness.find(2074)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(604).comments.create!(user_id: 415, content: "בשנה שעברה, 'פנינה קלטמן' (604) היה/הייתה מצוות/ת למארח/ת בקי יחזקאל (5235). בצד של המארחים הוא/היא 12015.")
    w = Witness.find(604)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(599).comments.create!(user_id: 415, content: "בשנה שעברה, 'בילי לניאדו' (599) היה/הייתה מצוות/ת למארח/ת חגית ברששת (8423). בצד של המארחים הוא/היא 15591.")
    w = Witness.find(599)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(610).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברטי קורן' (610) היה/הייתה מצוות/ת למארח/ת אורי פריתס (8915). בצד של המארחים הוא/היא 20219.")
    w = Witness.find(610)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(571).comments.create!(user_id: 415, content: "בשנה שעברה, 'עלית קראפ' (571) היה/הייתה מצוות/ת למארח/ת גלית כהן (6868). בצד של המארחים הוא/היא 17424.")
    w = Witness.find(571)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2295).comments.create!(user_id: 415, content: "בשנה שעברה, 'נורית בן מנחם' (2295) היה/הייתה מצוות/ת למארח/ת שהם חדאד (7564). בצד של המארחים הוא/היא 18221.")
    w = Witness.find(2295)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1855).comments.create!(user_id: 415, content: "בשנה שעברה, 'הניה שנון-קליין' (1855) היה/הייתה מצוות/ת למארח/ת דר׳ סוזי קגן (5666). בצד של המארחים הוא/היא 12899.")
    w = Witness.find(1855)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(722).comments.create!(user_id: 415, content: "בשנה שעברה, 'יולנדה גרוס' (722) היה/הייתה מצוות/ת למארח/ת טליה דאר (1696). בצד של המארחים הוא/היא 2591.")
    w = Witness.find(722)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3157).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיה וויינשטיין' (3157) היה/הייתה מצוות/ת למארח/ת מיכל הרשקוביץ (8604). בצד של המארחים הוא/היא 19594.")
    w = Witness.find(3157)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3161).comments.create!(user_id: 415, content: "בשנה שעברה, 'פרידה הירש' (3161) היה/הייתה מצוות/ת למארח/ת ויויאן רושנסקי (8999). בצד של המארחים הוא/היא 20454.")
    w = Witness.find(3161)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1866).comments.create!(user_id: 415, content: "בשנה שעברה, 'מלה מאיר' (1866) היה/הייתה מצוות/ת למארח/ת אילאיל שאול (7672). בצד של המארחים הוא/היא 18352.")
    w = Witness.find(1866)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(739).comments.create!(user_id: 415, content: "בשנה שעברה, 'אייזיק ארתור' (739) היה/הייתה מצוות/ת למארח/ת ליאור שרקר (7003). בצד של המארחים הוא/היא 17571.")
    w = Witness.find(739)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(738).comments.create!(user_id: 415, content: "בשנה שעברה, 'עליזה פלורנטל' (738) היה/הייתה מצוות/ת למארח/ת נטלי כהן (872). בצד של המארחים הוא/היא 927.")
    w = Witness.find(738)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2682).comments.create!(user_id: 415, content: "בשנה שעברה, 'אנה גרין' (2682) היה/הייתה מצוות/ת למארח/ת אסתר פרדה (7963). בצד של המארחים הוא/היא 18690.")
    w = Witness.find(2682)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(634).comments.create!(user_id: 415, content: "בשנה שעברה, 'זאב גלרנטר' (634) היה/הייתה מצוות/ת למארח/ת אילה (8137). בצד של המארחים הוא/היא 18885.")
    w = Witness.find(634)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1614).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית ודני רבל' (1614) היה/הייתה מצוות/ת למארח/ת יובל פילס (6607). בצד של המארחים הוא/היא 17153.")
    w = Witness.find(1614)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(729).comments.create!(user_id: 415, content: "בשנה שעברה, 'רונית ארנפרויד' (729) היה/הייתה מצוות/ת למארח/ת יסמין צוריאל (9350). בצד של המארחים הוא/היא 21624.")
    w = Witness.find(729)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3163).comments.create!(user_id: 415, content: "בשנה שעברה, 'לילה מאיה חפר' (3163) היה/הייתה מצוות/ת למארח/ת רחל מולא נצר (9130). בצד של המארחים הוא/היא 20824.")
    w = Witness.find(3163)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2529).comments.create!(user_id: 415, content: "בשנה שעברה, 'בלה פייט' (2529) היה/הייתה מצוות/ת למארח/ת הילה פייט פלדמן (8638). בצד של המארחים הוא/היא 19644.")
    w = Witness.find(2529)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1899).comments.create!(user_id: 415, content: "בשנה שעברה, 'שלמה גולן' (1899) היה/הייתה מצוות/ת למארח/ת יניב קדושים (3045). בצד של המארחים הוא/היא 8928.")
    w = Witness.find(1899)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(178).comments.create!(user_id: 415, content: "בשנה שעברה, 'אוהד איתם' (178) היה/הייתה מצוות/ת למארח/ת נועה כורם (5226). בצד של המארחים הוא/היא 6765.")
    w = Witness.find(178)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(766).comments.create!(user_id: 415, content: "בשנה שעברה, 'מסיה ביזוב' (766) היה/הייתה מצוות/ת למארח/ת יהודית ברנט (9184). בצד של המארחים הוא/היא 21092.")
    w = Witness.find(766)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(703).comments.create!(user_id: 415, content: "בשנה שעברה, 'יפה פינקלשטיין' (703) היה/הייתה מצוות/ת למארח/ת שרון אמור (7592). בצד של המארחים הוא/היא 18262.")
    w = Witness.find(703)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2104).comments.create!(user_id: 415, content: "בשנה שעברה, 'יעל אשכנזי' (2104) היה/הייתה מצוות/ת למארח/ת טל וינברג (8456). בצד של המארחים הוא/היא 19376.")
    w = Witness.find(2104)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(159).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל וידל' (159) היה/הייתה מצוות/ת למארח/ת חיים גבלייב (2615). בצד של המארחים הוא/היא 5996.")
    w = Witness.find(159)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(569).comments.create!(user_id: 415, content: "בשנה שעברה, 'ליליאן בר-נע' (569) היה/הייתה מצוות/ת למארח/ת עדי גורליק (6807). בצד של המארחים הוא/היא 17357.")
    w = Witness.find(569)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2098).comments.create!(user_id: 415, content: "בשנה שעברה, 'אילנה איתמרי' (2098) היה/הייתה מצוות/ת למארח/ת אבישג בצר (8358). בצד של המארחים הוא/היא 19186.")
    w = Witness.find(2098)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(572).comments.create!(user_id: 415, content: "בשנה שעברה, 'שלמה בובה' (572) היה/הייתה מצוות/ת למארח/ת מכבי צעיר חדרה (7418). בצד של המארחים הוא/היא 18055.")
    w = Witness.find(572)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1895).comments.create!(user_id: 415, content: "בשנה שעברה, 'שולמית וולקיטה' (1895) היה/הייתה מצוות/ת למארח/ת מירי לופוביץ' (7055). בצד של המארחים הוא/היא 17633.")
    w = Witness.find(1895)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(446).comments.create!(user_id: 415, content: "בשנה שעברה, 'מוטי קליין' (446) היה/הייתה מצוות/ת למארח/ת מוריה בוקרה (6979). בצד של המארחים הוא/היא 17546.")
    w = Witness.find(446)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1590).comments.create!(user_id: 415, content: "בשנה שעברה, 'לילי גומבוש' (1590) היה/הייתה מצוות/ת למארח/ת מעיין אהרון (8068). בצד של המארחים הוא/היא 18810.")
    w = Witness.find(1590)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3165).comments.create!(user_id: 415, content: "בשנה שעברה, 'רבקה טאוב' (3165) היה/הייתה מצוות/ת למארח/ת רונית רותם ירון (9721). בצד של המארחים הוא/היא 23630.")
    w = Witness.find(3165)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(708).comments.create!(user_id: 415, content: "בשנה שעברה, 'יצחק קואומו' (708) היה/הייתה מצוות/ת למארח/ת ענבר פינסקר (7726). בצד של המארחים הוא/היא 18417.")
    w = Witness.find(708)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3164).comments.create!(user_id: 415, content: "בשנה שעברה, 'אברהם חולי' (3164) היה/הייתה מצוות/ת למארח/ת סולימן אזולאי מימי (9040). בצד של המארחים הוא/היא 20583.")
    w = Witness.find(3164)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(369).comments.create!(user_id: 415, content: "בשנה שעברה, 'שביט בן ארי' (369) היה/הייתה מצוות/ת למארח/ת הדס חנה ארנברג (7326). בצד של המארחים הוא/היא 17945.")
    w = Witness.find(369)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1889).comments.create!(user_id: 415, content: "בשנה שעברה, 'ג'ק ברסלר' (1889) היה/הייתה מצוות/ת למארח/ת יובל אדלמן (8036). בצד של המארחים הוא/היא 18768.")
    w = Witness.find(1889)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(423).comments.create!(user_id: 415, content: "בשנה שעברה, 'תמרה לחמי' (423) היה/הייתה מצוות/ת למארח/ת עמותת שלומית ירושלים מאיה איתן (8559). בצד של המארחים הוא/היא 19528.")
    w = Witness.find(423)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1915).comments.create!(user_id: 415, content: "בשנה שעברה, 'נעמה שפי' (1915) היה/הייתה מצוות/ת למארח/ת אורטל וסטלר (8028). בצד של המארחים הוא/היא 11903.")
    w = Witness.find(1915)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(803).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלי קרטיס' (803) היה/הייתה מצוות/ת למארח/ת שחר כפיר (8008). בצד של המארחים הוא/היא 18742.")
    w = Witness.find(803)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1171).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנן זולדן' (1171) היה/הייתה מצוות/ת למארח/ת אודליה אחי דוד (7218). בצד של המארחים הוא/היא 17815.")
    w = Witness.find(1171)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(707).comments.create!(user_id: 415, content: "בשנה שעברה, 'יובל שטרסמן' (707) היה/הייתה מצוות/ת למארח/ת שמי רוזנפלד (6756). בצד של המארחים הוא/היא 17300.")
    w = Witness.find(707)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1886).comments.create!(user_id: 415, content: "בשנה שעברה, 'בינה הלפרין' (1886) היה/הייתה מצוות/ת למארח/ת טל בלוך (7821). בצד של המארחים הוא/היא 18519.")
    w = Witness.find(1886)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1409).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתר רוטר' (1409) היה/הייתה מצוות/ת למארח/ת לוסי כץ (8466). בצד של המארחים הוא/היא 19390.")
    w = Witness.find(1409)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1922).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרית זייברט' (1922) היה/הייתה מצוות/ת למארח/ת נעה כפרי (7330). בצד של המארחים הוא/היא 17949.")
    w = Witness.find(1922)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1223).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוסי וינר' (1223) היה/הייתה מצוות/ת למארח/ת הילה שניאור (8853). בצד של המארחים הוא/היא 20104.")
    w = Witness.find(1223)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(509).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרים דרוך' (509) היה/הייתה מצוות/ת למארח/ת גתית קסלר (8527). בצד של המארחים הוא/היא 14937.")
    w = Witness.find(509)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(454).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה שחורי' (454) היה/הייתה מצוות/ת למארח/ת אבי פן (7697). בצד של המארחים הוא/היא 18380.")
    w = Witness.find(454)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3173).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנן רושו' (3173) היה/הייתה מצוות/ת למארח/ת מוריה מסלטי (9214). בצד של המארחים הוא/היא 21174.")
    w = Witness.find(3173)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3175).comments.create!(user_id: 415, content: "בשנה שעברה, 'איטה גורפיין' (3175) היה/הייתה מצוות/ת למארח/ת רוני כץ (9047). בצד של המארחים הוא/היא 20609.")
    w = Witness.find(3175)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1834).comments.create!(user_id: 415, content: "בשנה שעברה, 'יקותיאל הירש' (1834) היה/הייתה מצוות/ת למארח/ת עידן אלעד (7640). בצד של המארחים הוא/היא 18318.")
    w = Witness.find(1834)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1897).comments.create!(user_id: 415, content: "בשנה שעברה, 'פנינה טננבאום' (1897) היה/הייתה מצוות/ת למארח/ת עדן חדשי (6316). בצד של המארחים הוא/היא 16512.")
    w = Witness.find(1897)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(97).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה רביב' (97) היה/הייתה מצוות/ת למארח/ת שרון דוד (6974). בצד של המארחים הוא/היא 17541.")
    w = Witness.find(97)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1410).comments.create!(user_id: 415, content: "בשנה שעברה, 'אידה הוברמן' (1410) היה/הייתה מצוות/ת למארח/ת הילה א.נחום (3367). בצד של המארחים הוא/היא 9251.")
    w = Witness.find(1410)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1235).comments.create!(user_id: 415, content: "בשנה שעברה, 'פרופסור שי בן אברהם' (1235) היה/הייתה מצוות/ת למארח/ת מרכז סטארטאפ באר שבע (8521). בצד של המארחים הוא/היא 19480.")
    w = Witness.find(1235)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1415).comments.create!(user_id: 415, content: "בשנה שעברה, 'אליאס פיסלבויים' (1415) היה/הייתה מצוות/ת למארח/ת נועה אלון (7700). בצד של המארחים הוא/היא 18384.")
    w = Witness.find(1415)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1533).comments.create!(user_id: 415, content: "בשנה שעברה, 'פרופ' אסתר הרצוג' (1533) היה/הייתה מצוות/ת למארח/ת נטע מלכי (7962). בצד של המארחים הוא/היא 18689.")
    w = Witness.find(1533)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1905).comments.create!(user_id: 415, content: "בשנה שעברה, 'ד\"ר דביר צור' (1905) היה/הייתה מצוות/ת למארח/ת גלי אופנבכר (9499). בצד של המארחים הוא/היא 22405.")
    w = Witness.find(1905)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2187).comments.create!(user_id: 415, content: "בשנה שעברה, 'לוי חנה' (2187) היה/הייתה מצוות/ת למארח/ת ליאור חקנזר (1083). בצד של המארחים הוא/היא 1298.")
    w = Witness.find(2187)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2).comments.create!(user_id: 415, content: "בשנה שעברה, 'בעז גבעון' (2) היה/הייתה מצוות/ת למארח/ת טל קניאס (7367). בצד של המארחים הוא/היא 17991.")
    w = Witness.find(2)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1907).comments.create!(user_id: 415, content: "בשנה שעברה, 'אמיליה שופמן' (1907) היה/הייתה מצוות/ת למארח/ת הדר חיימוביץ (7434). בצד של המארחים הוא/היא 18073.")
    w = Witness.find(1907)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1928).comments.create!(user_id: 415, content: "בשנה שעברה, 'שוש רותם' (1928) היה/הייתה מצוות/ת למארח/ת קרן דרור (6905). בצד של המארחים הוא/היא 5726.")
    w = Witness.find(1928)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2233).comments.create!(user_id: 415, content: "בשנה שעברה, 'אברהם צייגנבויים' (2233) היה/הייתה מצוות/ת למארח/ת מיכל צרפתי (9017). בצד של המארחים הוא/היא 20510.")
    w = Witness.find(2233)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1906).comments.create!(user_id: 415, content: "בשנה שעברה, 'דן שפירא' (1906) היה/הייתה מצוות/ת למארח/ת יעל ויואב קריב-טייטלבאום (3432). בצד של המארחים הוא/היא 9333.")
    w = Witness.find(1906)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1782).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמשון המר' (1782) היה/הייתה מצוות/ת למארח/ת רועי דרורי (7531). בצד של המארחים הוא/היא 18183.")
    w = Witness.find(1782)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2228).comments.create!(user_id: 415, content: "בשנה שעברה, 'קלדרון יצחק ושנפיק מלכה' (2228) היה/הייתה מצוות/ת למארח/ת גל שטיין (8602). בצד של המארחים הוא/היא 16412.")
    w = Witness.find(2228)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(692).comments.create!(user_id: 415, content: "בשנה שעברה, 'חווה ואלי  ליקוורניק' (692) היה/הייתה מצוות/ת למארח/ת אסתי פרץ קרויטורו (9018). בצד של המארחים הוא/היא 20512.")
    w = Witness.find(692)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2200).comments.create!(user_id: 415, content: "בשנה שעברה, 'מלצר מרדכי ועדה' (2200) היה/הייתה מצוות/ת למארח/ת ליביה רוטקובסקי (7616). בצד של המארחים הוא/היא 18287.")
    w = Witness.find(2200)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1527).comments.create!(user_id: 415, content: "בשנה שעברה, 'אריה נוסבכר' (1527) היה/הייתה מצוות/ת למארח/ת מור צור (14). בצד של המארחים הוא/היא 16.")
    w = Witness.find(1527)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2158).comments.create!(user_id: 415, content: "בשנה שעברה, 'גנית אפרת עו\"ד' (2158) היה/הייתה מצוות/ת למארח/ת אמפרסט מערכות (9545). בצד של המארחים הוא/היא 22564.")
    w = Witness.find(2158)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1908).comments.create!(user_id: 415, content: "בשנה שעברה, 'לי שיר' (1908) היה/הייתה מצוות/ת למארח/ת תומר צימרמן (8869). בצד של המארחים הוא/היא 1721.")
    w = Witness.find(1908)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1507).comments.create!(user_id: 415, content: "בשנה שעברה, 'דב ויינמן' (1507) היה/הייתה מצוות/ת למארח/ת בר אסלן (6552). בצד של המארחים הוא/היא 17101.")
    w = Witness.find(1507)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1552).comments.create!(user_id: 415, content: "בשנה שעברה, 'אריה בן דוד' (1552) היה/הייתה מצוות/ת למארח/ת הילה שלם (1128). בצד של המארחים הוא/היא 1380.")
    w = Witness.find(1552)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1540).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתר גוטמן' (1540) היה/הייתה מצוות/ת למארח/ת יניר אשכנזי (7903). בצד של המארחים הוא/היא 18617.")
    w = Witness.find(1540)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1509).comments.create!(user_id: 415, content: "בשנה שעברה, 'אורי הופרט' (1509) היה/הייתה מצוות/ת למארח/ת אור חוסקי (6678). בצד של המארחים הוא/היא 17222.")
    w = Witness.find(1509)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1904).comments.create!(user_id: 415, content: "בשנה שעברה, 'דוד בן שלום' (1904) היה/הייתה מצוות/ת למארח/ת זיכרון בסלון תל חי (8488). בצד של המארחים הוא/היא 19416.")
    w = Witness.find(1904)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2165).comments.create!(user_id: 415, content: "בשנה שעברה, 'יונה דולב' (2165) היה/הייתה מצוות/ת למארח/ת אגף משרד מרכז (7669). בצד של המארחים הוא/היא 18349.")
    w = Witness.find(2165)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1916).comments.create!(user_id: 415, content: "בשנה שעברה, 'עופר שיף' (1916) היה/הייתה מצוות/ת למארח/ת נווה שרת (7605). בצד של המארחים הוא/היא 18275.")
    w = Witness.find(1916)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1506).comments.create!(user_id: 415, content: "בשנה שעברה, 'ישראל גת' (1506) היה/הייתה מצוות/ת למארח/ת אלון מאור (9313). בצד של המארחים הוא/היא 21510.")
    w = Witness.find(1506)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1918).comments.create!(user_id: 415, content: "בשנה שעברה, 'ענת שמעוני' (1918) היה/הייתה מצוות/ת למארח/ת מעוז אביב (7607). בצד של המארחים הוא/היא 18277.")
    w = Witness.find(1918)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2103).comments.create!(user_id: 415, content: "בשנה שעברה, 'עדה אחימן' (2103) היה/הייתה מצוות/ת למארח/ת ענבר מלכא (7122). בצד של המארחים הוא/היא 17705.")
    w = Witness.find(2103)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1566).comments.create!(user_id: 415, content: "בשנה שעברה, 'ינינה גולדהר' (1566) היה/הייתה מצוות/ת למארח/ת ענת צבי (8680). בצד של המארחים הוא/היא 13079.")
    w = Witness.find(1566)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1500).comments.create!(user_id: 415, content: "בשנה שעברה, 'דוד שריד' (1500) היה/הייתה מצוות/ת למארח/ת נטע-לי דיויס (6625). בצד של המארחים הוא/היא 17170.")
    w = Witness.find(1500)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1586).comments.create!(user_id: 415, content: "בשנה שעברה, 'אפרים ויזל' (1586) היה/הייתה מצוות/ת למארח/ת אורי בוחניק (4191). בצד של המארחים הוא/היא 10383.")
    w = Witness.find(1586)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1526).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל הנדשר' (1526) היה/הייתה מצוות/ת למארח/ת דניאל חן (3601). בצד של המארחים הוא/היא 9612.")
    w = Witness.find(1526)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1598).comments.create!(user_id: 415, content: "בשנה שעברה, 'חוה זוהר' (1598) היה/הייתה מצוות/ת למארח/ת זיו ורהפטיג (8826). בצד של המארחים הוא/היא 20024.")
    w = Witness.find(1598)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3233).comments.create!(user_id: 415, content: "בשנה שעברה, 'דוניה רוזנבלט' (3233) היה/הייתה מצוות/ת למארח/ת שלי (8901). בצד של המארחים הוא/היא 20193.")
    w = Witness.find(3233)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3185).comments.create!(user_id: 415, content: "בשנה שעברה, 'פסיה בודנר' (3185) היה/הייתה מצוות/ת למארח/ת נועה חציר (8819). בצד של המארחים הוא/היא 20000.")
    w = Witness.find(3185)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3229).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיים כספי' (3229) היה/הייתה מצוות/ת למארח/ת סיון ווייס (9621). בצד של המארחים הוא/היא 22946.")
    w = Witness.find(3229)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1565).comments.create!(user_id: 415, content: "בשנה שעברה, 'ציפי קראוס' (1565) היה/הייתה מצוות/ת למארח/ת עידית ודרור אבני (3370). בצד של המארחים הוא/היא 9255.")
    w = Witness.find(1565)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3174).comments.create!(user_id: 415, content: "בשנה שעברה, 'יעל אתגר' (3174) היה/הייתה מצוות/ת למארח/ת עמוס אהרונסון (8511). בצד של המארחים הוא/היא 19455.")
    w = Witness.find(3174)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3242).comments.create!(user_id: 415, content: "בשנה שעברה, 'אליעזר גולדנטל' (3242) היה/הייתה מצוות/ת למארח/ת שבי גוברין (8584). בצד של המארחים הוא/היא 19562.")
    w = Witness.find(3242)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3192).comments.create!(user_id: 415, content: "בשנה שעברה, 'זהבה בדיחי-איכר' (3192) היה/הייתה מצוות/ת למארח/ת נועה ענבל (6818). בצד של המארחים הוא/היא 17372.")
    w = Witness.find(3192)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2184).comments.create!(user_id: 415, content: "בשנה שעברה, 'בורישקה יוריק' (2184) היה/הייתה מצוות/ת למארח/ת אלעד זגורי (6729). בצד של המארחים הוא/היא 17272.")
    w = Witness.find(2184)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1950).comments.create!(user_id: 415, content: "בשנה שעברה, 'רות אמיר (ד\"ר)' (1950) היה/הייתה מצוות/ת למארח/ת הילה הובר (7210). בצד של המארחים הוא/היא 17807.")
    w = Witness.find(1950)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(338).comments.create!(user_id: 415, content: "בשנה שעברה, 'חדווה רבר' (338) היה/הייתה מצוות/ת למארח/ת בר נסים (4982). בצד של המארחים הוא/היא 11491.")
    w = Witness.find(338)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2190).comments.create!(user_id: 415, content: "בשנה שעברה, 'מטילדה מאיר' (2190) היה/הייתה מצוות/ת למארח/ת ליטל שרון (495). בצד של המארחים הוא/היא 543.")
    w = Witness.find(2190)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1576).comments.create!(user_id: 415, content: "בשנה שעברה, 'סמדר אלעד' (1576) היה/הייתה מצוות/ת למארח/ת רות (7948). בצד של המארחים הוא/היא 18672.")
    w = Witness.find(1576)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3231).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברל שור' (3231) היה/הייתה מצוות/ת למארח/ת פיש יהודית (2864). בצד של המארחים הוא/היא 8723.")
    w = Witness.find(3231)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2183).comments.create!(user_id: 415, content: "בשנה שעברה, 'זלוף רחלי' (2183) היה/הייתה מצוות/ת למארח/ת אסיף (8092). בצד של המארחים הוא/היא 18836.")
    w = Witness.find(2183)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2323).comments.create!(user_id: 415, content: "בשנה שעברה, 'זהבה סבר' (2323) היה/הייתה מצוות/ת למארח/ת רננה מילר (7717). בצד של המארחים הוא/היא 18407.")
    w = Witness.find(2323)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3236).comments.create!(user_id: 415, content: "בשנה שעברה, 'נורית בירן' (3236) היה/הייתה מצוות/ת למארח/ת שקד הורוביץ (7053). בצד של המארחים הוא/היא 17631.")
    w = Witness.find(3236)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1595).comments.create!(user_id: 415, content: "בשנה שעברה, 'אווה צורף' (1595) היה/הייתה מצוות/ת למארח/ת טמיר שלמן (6901). בצד של המארחים הוא/היא 17457.")
    w = Witness.find(1595)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3234).comments.create!(user_id: 415, content: "בשנה שעברה, 'דוברוב לאוניד' (3234) היה/הייתה מצוות/ת למארח/ת ברוך מיכאלי (5301). בצד של המארחים הוא/היא 12155.")
    w = Witness.find(3234)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1932).comments.create!(user_id: 415, content: "בשנה שעברה, 'רון (רוני) כצנלסון' (1932) היה/הייתה מצוות/ת למארח/ת רוויה גרומבק (7754). בצד של המארחים הוא/היא 18448.")
    w = Witness.find(1932)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1492).comments.create!(user_id: 415, content: "בשנה שעברה, 'אוולין גודמן-טאו (פרופ')' (1492) היה/הייתה מצוות/ת למארח/ת אריאלה בנרמן (312). בצד של המארחים הוא/היא 341.")
    w = Witness.find(1492)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3230).comments.create!(user_id: 415, content: "בשנה שעברה, 'אנה זוהר' (3230) היה/הייתה מצוות/ת למארח/ת אביטל שחר (806). בצד של המארחים הוא/היא 861.")
    w = Witness.find(3230)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2172).comments.create!(user_id: 415, content: "בשנה שעברה, 'ארי לבנה' (2172) היה/הייתה מצוות/ת למארח/ת טל בוטל שפיס (1663). בצד של המארחים הוא/היא 2508.")
    w = Witness.find(2172)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1651).comments.create!(user_id: 415, content: "בשנה שעברה, 'ריטה ברקוביץ' (1651) היה/הייתה מצוות/ת למארח/ת דנה קדוש (6). בצד של המארחים הוא/היא 7.")
    w = Witness.find(1651)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1620).comments.create!(user_id: 415, content: "בשנה שעברה, 'עדנה ביבר' (1620) היה/הייתה מצוות/ת למארח/ת מאור צאייג (8644). בצד של המארחים הוא/היא 19654.")
    w = Witness.find(1620)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(793).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוסף אבס' (793) היה/הייתה מצוות/ת למארח/ת הגר פרדו (8555). בצד של המארחים הוא/היא 19525.")
    w = Witness.find(793)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1640).comments.create!(user_id: 415, content: "בשנה שעברה, 'אילנה הלר' (1640) היה/הייתה מצוות/ת למארח/ת עמותת אנוש (8350). בצד של המארחים הוא/היא 19172.")
    w = Witness.find(1640)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3187).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמשון שוורץ' (3187) היה/הייתה מצוות/ת למארח/ת מירי גלברט (3086). בצד של המארחים הוא/היא 6196.")
    w = Witness.find(3187)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3193).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיה נאמן' (3193) היה/הייתה מצוות/ת למארח/ת Nurit Torenheim (8387). בצד של המארחים הוא/היא 19229.")
    w = Witness.find(3193)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1945).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיים עזרן' (1945) היה/הייתה מצוות/ת למארח/ת הודיה הרוש (6806). בצד של המארחים הוא/היא 17356.")
    w = Witness.find(1945)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3235).comments.create!(user_id: 415, content: "בשנה שעברה, 'צופיה סיקסיק' (3235) היה/הייתה מצוות/ת למארח/ת קפה גותה (8250). בצד של המארחים הוא/היא 19035.")
    w = Witness.find(3235)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1617).comments.create!(user_id: 415, content: "בשנה שעברה, 'דניאל מאסטרו' (1617) היה/הייתה מצוות/ת למארח/ת מרכז קהילתי מגיד (3129). בצד של המארחים הוא/היא 9012.")
    w = Witness.find(1617)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3240).comments.create!(user_id: 415, content: "בשנה שעברה, 'לאוניד ברמוברג' (3240) היה/הייתה מצוות/ת למארח/ת שירי סטרוגנו (9054). בצד של המארחים הוא/היא 20629.")
    w = Witness.find(3240)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3191).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתר ערבה' (3191) היה/הייתה מצוות/ת למארח/ת מיה פלבסקי - מכינה קדם צבאית מיצר (9068). בצד של המארחים הוא/היא 20689.")
    w = Witness.find(3191)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3238).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית בר-כוכבא' (3238) היה/הייתה מצוות/ת למארח/ת יהודית בר-כוכבא (8321). בצד של המארחים הוא/היא 19144.")
    w = Witness.find(3238)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1659).comments.create!(user_id: 415, content: "בשנה שעברה, 'מינה בלומין' (1659) היה/הייתה מצוות/ת למארח/ת רעות אפל (918). בצד של המארחים הוא/היא 991.")
    w = Witness.find(1659)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1667).comments.create!(user_id: 415, content: "בשנה שעברה, 'יצחק הירש' (1667) היה/הייתה מצוות/ת למארח/ת Renee Shmuel (1314). בצד של המארחים הוא/היא 1760.")
    w = Witness.find(1667)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2218).comments.create!(user_id: 415, content: "בשנה שעברה, 'רייך דב וחיה' (2218) היה/הייתה מצוות/ת למארח/ת טל גבע (7131). בצד של המארחים הוא/היא 17717.")
    w = Witness.find(2218)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1610).comments.create!(user_id: 415, content: "בשנה שעברה, 'סמי בז'רנו' (1610) היה/הייתה מצוות/ת למארח/ת קרן גרשון (9775). בצד של המארחים הוא/היא 24116.")
    w = Witness.find(1610)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1677).comments.create!(user_id: 415, content: "בשנה שעברה, 'צבי לוין' (1677) היה/הייתה מצוות/ת למארח/ת אורטל עסיס (7876). בצד של המארחים הוא/היא 18583.")
    w = Witness.find(1677)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3097).comments.create!(user_id: 415, content: "בשנה שעברה, 'זהבה היטנר' (3097) היה/הייתה מצוות/ת למארח/ת יחידת הנוער נהריה (7423). בצד של המארחים הוא/היא 18060.")
    w = Witness.find(3097)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3245).comments.create!(user_id: 415, content: "בשנה שעברה, 'לינקה אנדה' (3245) היה/הייתה מצוות/ת למארח/ת לינקא אנדה (8322). בצד של המארחים הוא/היא 19145.")
    w = Witness.find(3245)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3194).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלידע ווטן' (3194) היה/הייתה מצוות/ת למארח/ת רביד שמואלביץ (4930). בצד של המארחים הוא/היא 11422.")
    w = Witness.find(3194)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3167).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה פוטשניק' (3167) היה/הייתה מצוות/ת למארח/ת מוריס צורף (9036). בצד של המארחים הוא/היא 13152.")
    w = Witness.find(3167)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2106).comments.create!(user_id: 415, content: "בשנה שעברה, 'יעקוב שפירא' (2106) היה/הייתה מצוות/ת למארח/ת דנה קציר (4391). בצד של המארחים הוא/היא 10627.")
    w = Witness.find(2106)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1668).comments.create!(user_id: 415, content: "בשנה שעברה, 'גרגורי וולושין' (1668) היה/הייתה מצוות/ת למארח/ת אליסה אוגורסקי (7831). בצד של המארחים הוא/היא 18530.")
    w = Witness.find(1668)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1661).comments.create!(user_id: 415, content: "בשנה שעברה, 'דיאנה לביא' (1661) היה/הייתה מצוות/ת למארח/ת יהודית חזקי (952). בצד של המארחים הוא/היא 1036.")
    w = Witness.find(1661)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3196).comments.create!(user_id: 415, content: "בשנה שעברה, 'אדמונד דיקמן' (3196) היה/הייתה מצוות/ת למארח/ת ירדן רבקה שדדי (8994). בצד של המארחים הוא/היא 20433.")
    w = Witness.find(3196)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3250).comments.create!(user_id: 415, content: "בשנה שעברה, 'גד פרטוק' (3250) היה/הייתה מצוות/ת למארח/ת ציפי מכלוף (7932). בצד של המארחים הוא/היא 18649.")
    w = Witness.find(3250)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2202).comments.create!(user_id: 415, content: "בשנה שעברה, 'נאמן אליהו ושולה' (2202) היה/הייתה מצוות/ת למארח/ת מרב מאסיל (9119). בצד של המארחים הוא/היא 20781.")
    w = Witness.find(2202)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1933).comments.create!(user_id: 415, content: "בשנה שעברה, 'ריקה ברקוביץ'' (1933) היה/הייתה מצוות/ת למארח/ת ליאורה ניאזוב (9266). בצד של המארחים הוא/היא 21345.")
    w = Witness.find(1933)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1736).comments.create!(user_id: 415, content: "בשנה שעברה, 'צבי ורחל שחר' (1736) היה/הייתה מצוות/ת למארח/ת נועה גבאי (7200). בצד של המארחים הוא/היא 17792.")
    w = Witness.find(1736)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3241).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברוריה בודק' (3241) היה/הייתה מצוות/ת למארח/ת Ulpan Bayit (7001). בצד של המארחים הוא/היא 17569.")
    w = Witness.find(3241)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1744).comments.create!(user_id: 415, content: "בשנה שעברה, 'אביבה ברוור' (1744) היה/הייתה מצוות/ת למארח/ת שירה סגל (8116). בצד של המארחים הוא/היא 18859.")
    w = Witness.find(1744)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2196).comments.create!(user_id: 415, content: "בשנה שעברה, 'מימון יוסף' (2196) היה/הייתה מצוות/ת למארח/ת מיכל רוטשילד (5275). בצד של המארחים הוא/היא 12105.")
    w = Witness.find(2196)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1773).comments.create!(user_id: 415, content: "בשנה שעברה, 'בינה קמילר' (1773) היה/הייתה מצוות/ת למארח/ת מילכה ברטיש (8171). בצד של המארחים הוא/היא 18944.")
    w = Witness.find(1773)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1739).comments.create!(user_id: 415, content: "בשנה שעברה, 'אירית האס' (1739) היה/הייתה מצוות/ת למארח/ת אסנת יצחק (7861). בצד של המארחים הוא/היא 4377.")
    w = Witness.find(1739)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1738).comments.create!(user_id: 415, content: "בשנה שעברה, 'לאה אייזנגר' (1738) היה/הייתה מצוות/ת למארח/ת לנה בנאל (6792). בצד של המארחים הוא/היא 17340.")
    w = Witness.find(1738)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1764).comments.create!(user_id: 415, content: "בשנה שעברה, 'אליהו פניירו' (1764) היה/הייתה מצוות/ת למארח/ת נאווה פיינהאוזן (8291). בצד של המארחים הוא/היא 19089.")
    w = Witness.find(1764)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1763).comments.create!(user_id: 415, content: "בשנה שעברה, 'מאשה' (1763) היה/הייתה מצוות/ת למארח/ת רלי אושר (7336). בצד של המארחים הוא/היא 17956.")
    w = Witness.find(1763)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2159).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה רביב' (2159) היה/הייתה מצוות/ת למארח/ת שני קריספין (9365). בצד של המארחים הוא/היא 16144.")
    w = Witness.find(2159)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1754).comments.create!(user_id: 415, content: "בשנה שעברה, 'אילנה קליין' (1754) היה/הייתה מצוות/ת למארח/ת מוריה ברוכין (7045). בצד של המארחים הוא/היא 17621.")
    w = Witness.find(1754)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1756).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוסף קורן' (1756) היה/הייתה מצוות/ת למארח/ת נוי שירן (7968). בצד של המארחים הוא/היא 18697.")
    w = Witness.find(1756)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1741).comments.create!(user_id: 415, content: "בשנה שעברה, 'לאה רוזנטול' (1741) היה/הייתה מצוות/ת למארח/ת ספיר יוסף (7544). בצד של המארחים הוא/היא 18197.")
    w = Witness.find(1741)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3243).comments.create!(user_id: 415, content: "בשנה שעברה, 'נתן וינברג' (3243) היה/הייתה מצוות/ת למארח/ת עמותת שק\"ל (3132). בצד של המארחים הוא/היא 9015.")
    w = Witness.find(3243)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1760).comments.create!(user_id: 415, content: "בשנה שעברה, 'עליזה רוטשילד' (1760) היה/הייתה מצוות/ת למארח/ת אורית קאופמן (8265). בצד של המארחים הוא/היא 19055.")
    w = Witness.find(1760)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1759).comments.create!(user_id: 415, content: "בשנה שעברה, 'רות ריינהורן' (1759) היה/הייתה מצוות/ת למארח/ת ציפי מרגלית (7858). בצד של המארחים הוא/היא 18564.")
    w = Witness.find(1759)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1766).comments.create!(user_id: 415, content: "בשנה שעברה, 'טאיב דולי' (1766) היה/הייתה מצוות/ת למארח/ת ציפי בש (7117). בצד של המארחים הוא/היא 17700.")
    w = Witness.find(1766)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1961).comments.create!(user_id: 415, content: "בשנה שעברה, 'ארווין כץ' (1961) היה/הייתה מצוות/ת למארח/ת רוני זק (4526). בצד של המארחים הוא/היא 10812.")
    w = Witness.find(1961)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2209).comments.create!(user_id: 415, content: "בשנה שעברה, 'ציאושו אסתר' (2209) היה/הייתה מצוות/ת למארח/ת ליהי מימון (7339). בצד של המארחים הוא/היא 17961.")
    w = Witness.find(2209)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1958).comments.create!(user_id: 415, content: "בשנה שעברה, 'ליאורה פוזננסקי' (1958) היה/הייתה מצוות/ת למארח/ת רינת צפניה (710). בצד של המארחים הוא/היא 763.")
    w = Witness.find(1958)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1967).comments.create!(user_id: 415, content: "בשנה שעברה, 'יעל קציר' (1967) היה/הייתה מצוות/ת למארח/ת ספריית בי\"ס צוקי אביב (7602). בצד של המארחים הוא/היא 18272.")
    w = Witness.find(1967)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1694).comments.create!(user_id: 415, content: "בשנה שעברה, 'יצחק וולסטר' (1694) היה/הייתה מצוות/ת למארח/ת עדי פרנקו (8348). בצד של המארחים הוא/היא 12759.")
    w = Witness.find(1694)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2207).comments.create!(user_id: 415, content: "בשנה שעברה, 'פרסי יעקב וחנה' (2207) היה/הייתה מצוות/ת למארח/ת אור זיידנרייס (8360). בצד של המארחים הוא/היא 19188.")
    w = Witness.find(2207)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(184).comments.create!(user_id: 415, content: "בשנה שעברה, 'לירי זו-הארי' (184) היה/הייתה מצוות/ת למארח/ת מרב ספיר (8756). בצד של המארחים הוא/היא 19867.")
    w = Witness.find(184)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1137).comments.create!(user_id: 415, content: "בשנה שעברה, 'ישראל קולקר' (1137) היה/הייתה מצוות/ת למארח/ת אופיר תדהר (8474). בצד של המארחים הוא/היא 19401.")
    w = Witness.find(1137)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(925).comments.create!(user_id: 415, content: "בשנה שעברה, 'אשר קרביץ' (925) היה/הייתה מצוות/ת למארח/ת אמילי שופן (4060). בצד של המארחים הוא/היא 10217.")
    w = Witness.find(925)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1012).comments.create!(user_id: 415, content: "בשנה שעברה, 'בני חן' (1012) היה/הייתה מצוות/ת למארח/ת אהרון אקילוב (6225). בצד של המארחים הוא/היא 15472.")
    w = Witness.find(1012)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1650).comments.create!(user_id: 415, content: "בשנה שעברה, 'יעקב ג'רבי' (1650) היה/הייתה מצוות/ת למארח/ת סיון הלימי (4451). בצד של המארחים הוא/היא 10721.")
    w = Witness.find(1650)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1073).comments.create!(user_id: 415, content: "בשנה שעברה, 'ורה טומניה' (1073) היה/הייתה מצוות/ת למארח/ת דיאנה רומנוביץ' (7049). בצד של המארחים הוא/היא 17627.")
    w = Witness.find(1073)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1213).comments.create!(user_id: 415, content: "בשנה שעברה, 'חוה שובל' (1213) היה/הייתה מצוות/ת למארח/ת דניאל רוזן (6749). בצד של המארחים הוא/היא 17293.")
    w = Witness.find(1213)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2112).comments.create!(user_id: 415, content: "בשנה שעברה, 'יניב אלמוג (פרופ')' (2112) היה/הייתה מצוות/ת למארח/ת אשר אלון (5408). בצד של המארחים הוא/היא 8179.")
    w = Witness.find(2112)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(533).comments.create!(user_id: 415, content: "בשנה שעברה, 'זאב הרץ' (533) היה/הייתה מצוות/ת למארח/ת Smadar Taff (6007). בצד של המארחים הוא/היא 13930.")
    w = Witness.find(533)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1166).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברכה לנדאו' (1166) היה/הייתה מצוות/ת למארח/ת נועה חיון (7614). בצד של המארחים הוא/היא 18284.")
    w = Witness.find(1166)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(528).comments.create!(user_id: 415, content: "בשנה שעברה, 'יצחק הרצוג' (528) היה/הייתה מצוות/ת למארח/ת סידני אבשלום (8599). בצד של המארחים הוא/היא 19589.")
    w = Witness.find(528)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3189).comments.create!(user_id: 415, content: "בשנה שעברה, 'נירה רוקח' (3189) היה/הייתה מצוות/ת למארח/ת יובל שליש (8893). בצד של המארחים הוא/היא 20178.")
    w = Witness.find(3189)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(940).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה רדו' (940) היה/הייתה מצוות/ת למארח/ת מודי נבון (8749). בצד של המארחים הוא/היא 19857.")
    w = Witness.find(940)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(543).comments.create!(user_id: 415, content: "בשנה שעברה, 'אליעזר שועלי' (543) היה/הייתה מצוות/ת למארח/ת רתם ורדי (7521). בצד של המארחים הוא/היא 18172.")
    w = Witness.find(543)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2241).comments.create!(user_id: 415, content: "בשנה שעברה, 'סוזי קורדוב' (2241) היה/הייתה מצוות/ת למארח/ת שירי צופי ים (9581). בצד של המארחים הוא/היא 22770.")
    w = Witness.find(2241)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2223).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמואלי רחל' (2223) היה/הייתה מצוות/ת למארח/ת מירב שמעון (4644). בצד של המארחים הוא/היא 10981.")
    w = Witness.find(2223)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1403).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלימלך יעקב' (1403) היה/הייתה מצוות/ת למארח/ת רונית דיסטלמן מוהבן (6923). בצד של המארחים הוא/היא 17479.")
    w = Witness.find(1403)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(736).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה ליפשיץ' (736) היה/הייתה מצוות/ת למארח/ת ענבר שטיינברג (4770). בצד של המארחים הוא/היא 11150.")
    w = Witness.find(736)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2109).comments.create!(user_id: 415, content: "בשנה שעברה, 'יצחק ליפשיץ (רב, ד\"ר)' (2109) היה/הייתה מצוות/ת למארח/ת קרן דואר (9283). בצד של המארחים הוא/היא 14746.")
    w = Witness.find(2109)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1517).comments.create!(user_id: 415, content: "בשנה שעברה, 'אפרים אייזנמן' (1517) היה/הייתה מצוות/ת למארח/ת דירת אימון (7014). בצד של המארחים הוא/היא 17583.")
    w = Witness.find(1517)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3232).comments.create!(user_id: 415, content: "בשנה שעברה, 'ג'יימס לובנשטיין' (3232) היה/הייתה מצוות/ת למארח/ת טל שרגאי (4399). בצד של המארחים הוא/היא 10638.")
    w = Witness.find(3232)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1510).comments.create!(user_id: 415, content: "בשנה שעברה, 'יונה אלטשולר' (1510) היה/הייתה מצוות/ת למארח/ת איציק גרינוולד מבטח (6491). בצד של המארחים הוא/היא 17042.")
    w = Witness.find(1510)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2269).comments.create!(user_id: 415, content: "בשנה שעברה, 'יחזקאל הרשטיק' (2269) היה/הייתה מצוות/ת למארח/ת אמילי שופן ומשה ניסים (7021). בצד של המארחים הוא/היא 17590.")
    w = Witness.find(2269)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2219).comments.create!(user_id: 415, content: "בשנה שעברה, 'שחורי יונה' (2219) היה/הייתה מצוות/ת למארח/ת אורית מאור (7350). בצד של המארחים הוא/היא 17972.")
    w = Witness.find(2219)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2325).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרים סיוון (ד\"ר)' (2325) היה/הייתה מצוות/ת למארח/ת עדן עיני (8795). בצד של המארחים הוא/היא 19946.")
    w = Witness.find(2325)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1580).comments.create!(user_id: 415, content: "בשנה שעברה, 'הרב יוסי פורמן' (1580) היה/הייתה מצוות/ת למארח/ת מיכל פרנקל (8087). בצד של המארחים הוא/היא 18831.")
    w = Witness.find(1580)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(19).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרית איתן' (19) היה/הייתה מצוות/ת למארח/ת סיון אמיתי בית חלומי אקים רעננה (8709). בצד של המארחים הוא/היא 19778.")
    w = Witness.find(19)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1474).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברנרס\tלידיה' (1474) היה/הייתה מצוות/ת למארח/ת נטלי קאופמן (8721). בצד של המארחים הוא/היא 19809.")
    w = Witness.find(1474)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2105).comments.create!(user_id: 415, content: "בשנה שעברה, 'מוריס רומני' (2105) היה/הייתה מצוות/ת למארח/ת יחידת השליחים - שרה אטיאס (3498). בצד של המארחים הוא/היא 9413.")
    w = Witness.find(2105)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3168).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמעון בויירסקי' (3168) היה/הייתה מצוות/ת למארח/ת מיכל דיסטניק (9223). בצד של המארחים הוא/היא 21202.")
    w = Witness.find(3168)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1253).comments.create!(user_id: 415, content: "בשנה שעברה, 'פנינה פריצקי' (1253) היה/הייתה מצוות/ת למארח/ת יואל עזריה (9533). בצד של המארחים הוא/היא 22532.")
    w = Witness.find(1253)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1983).comments.create!(user_id: 415, content: "בשנה שעברה, 'ציון כהן' (1983) היה/הייתה מצוות/ת למארח/ת דני אברהם (6755). בצד של המארחים הוא/היא 17299.")
    w = Witness.find(1983)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1757).comments.create!(user_id: 415, content: "בשנה שעברה, 'שי בקרמן' (1757) היה/הייתה מצוות/ת למארח/ת גדעון ריאטי (8014). בצד של המארחים הוא/היא 18748.")
    w = Witness.find(1757)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(892).comments.create!(user_id: 415, content: "בשנה שעברה, 'עליזה בר' (892) היה/הייתה מצוות/ת למארח/ת תומר דסה (7569). בצד של המארחים הוא/היא 18226.")
    w = Witness.find(892)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(453).comments.create!(user_id: 415, content: "בשנה שעברה, 'דינה שפטלביץ'' (453) היה/הייתה מצוות/ת למארח/ת אביטל זברגר (8258). בצד של המארחים הוא/היא 19046.")
    w = Witness.find(453)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1985).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה בן דוד' (1985) היה/הייתה מצוות/ת למארח/ת דר קלאוזנר (6787). בצד של המארחים הוא/היא 17335.")
    w = Witness.find(1985)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(91).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתר רוזנשטיין' (91) היה/הייתה מצוות/ת למארח/ת רוני הרטוך (6989). בצד של המארחים הוא/היא 17558.")
    w = Witness.find(91)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3255).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלכסנדר' (3255) היה/הייתה מצוות/ת למארח/ת יעקב פרויליך (9274). בצד של המארחים הוא/היא 21365.")
    w = Witness.find(3255)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3254).comments.create!(user_id: 415, content: "בשנה שעברה, 'מישל ורבר' (3254) היה/הייתה מצוות/ת למארח/ת ורד קונסטנטיני (9400). בצד של המארחים הוא/היא 21875.")
    w = Witness.find(3254)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3252).comments.create!(user_id: 415, content: "בשנה שעברה, 'רותי חלף' (3252) היה/הייתה מצוות/ת למארח/ת ורד קרונפלד (1241). בצד של המארחים הוא/היא 1593.")
    w = Witness.find(3252)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3099).comments.create!(user_id: 415, content: "בשנה שעברה, 'חביבה ארני' (3099) היה/הייתה מצוות/ת למארח/ת שרה רות יוסף (6708). בצד של המארחים הוא/היא 17251.")
    w = Witness.find(3099)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3258).comments.create!(user_id: 415, content: "בשנה שעברה, 'פולה מילס' (3258) היה/הייתה מצוות/ת למארח/ת אסף (9254). בצד של המארחים הוא/היא 21288.")
    w = Witness.find(3258)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(684).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמואל בניונסקי' (684) היה/הייתה מצוות/ת למארח/ת עינת דהרי (6565). בצד של המארחים הוא/היא 17112.")
    w = Witness.find(684)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2115).comments.create!(user_id: 415, content: "בשנה שעברה, 'אביגדור נוימן' (2115) היה/הייתה מצוות/ת למארח/ת אמיר אורנים (4134). בצד של המארחים הוא/היא 10305.")
    w = Witness.find(2115)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2235).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלכסנדר קרמר' (2235) היה/הייתה מצוות/ת למארח/ת שלי מרציאנו (3613). בצד של המארחים הוא/היא 9630.")
    w = Witness.find(2235)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3256).comments.create!(user_id: 415, content: "בשנה שעברה, 'מאירה פרתם' (3256) היה/הייתה מצוות/ת למארח/ת נופר שמש (7104). בצד של המארחים הוא/היא 17688.")
    w = Witness.find(3256)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3296).comments.create!(user_id: 415, content: "בשנה שעברה, 'יעקב רכטשפן' (3296) היה/הייתה מצוות/ת למארח/ת לילך פורת (8947). בצד של המארחים הוא/היא 20300.")
    w = Witness.find(3296)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3260).comments.create!(user_id: 415, content: "בשנה שעברה, 'ראיה גרובמן' (3260) היה/הייתה מצוות/ת למארח/ת ימין סהר (8430). בצד של המארחים הוא/היא 19336.")
    w = Witness.find(3260)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(710).comments.create!(user_id: 415, content: "בשנה שעברה, 'שוש רוזנפלד' (710) היה/הייתה מצוות/ת למארח/ת אלישבע היזמי (7978). בצד של המארחים הוא/היא 18709.")
    w = Witness.find(710)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(180).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמואל הראל' (180) היה/הייתה מצוות/ת למארח/ת חנה טולדנו (8518). בצד של המארחים הוא/היא 19471.")
    w = Witness.find(180)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1978).comments.create!(user_id: 415, content: "בשנה שעברה, 'בנימין לסלו ורצברגר' (1978) היה/הייתה מצוות/ת למארח/ת תומר דרור (6918). בצד של המארחים הוא/היא 17474.")
    w = Witness.find(1978)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2221).comments.create!(user_id: 415, content: "בשנה שעברה, 'שילר אריה' (2221) היה/הייתה מצוות/ת למארח/ת ירדן סלוני (5044). בצד של המארחים הוא/היא 11616.")
    w = Witness.find(2221)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1591).comments.create!(user_id: 415, content: "בשנה שעברה, 'מירה לאובר' (1591) היה/הייתה מצוות/ת למארח/ת אופיר בובה (6649). בצד של המארחים הוא/היא 17194.")
    w = Witness.find(1591)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1091).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודה קראוס' (1091) היה/הייתה מצוות/ת למארח/ת אורית (8149). בצד של המארחים הוא/היא 18904.")
    w = Witness.find(1091)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1323).comments.create!(user_id: 415, content: "בשנה שעברה, 'חוה לנג' (1323) היה/הייתה מצוות/ת למארח/ת חופית ג'אן (5642). בצד של המארחים הוא/היא 12846.")
    w = Witness.find(1323)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3261).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה כהן' (3261) היה/הייתה מצוות/ת למארח/ת דור לוי (9604). בצד של המארחים הוא/היא 22857.")
    w = Witness.find(3261)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(835).comments.create!(user_id: 415, content: "בשנה שעברה, 'בן ציון דרוטין' (835) היה/הייתה מצוות/ת למארח/ת יואל לקס (7887). בצד של המארחים הוא/היא 18598.")
    w = Witness.find(835)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(889).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה מליסדורף' (889) היה/הייתה מצוות/ת למארח/ת חן בר-און (7178). בצד של המארחים הוא/היא 17767.")
    w = Witness.find(889)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(17).comments.create!(user_id: 415, content: "בשנה שעברה, 'הרשקו אתי' (17) היה/הייתה מצוות/ת למארח/ת ניצן רז (8457). בצד של המארחים הוא/היא 19380.")
    w = Witness.find(17)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3265).comments.create!(user_id: 415, content: "בשנה שעברה, 'הרב זליקוביץ' (3265) היה/הייתה מצוות/ת למארח/ת מיכל פינגרהוט (4135). בצד של המארחים הוא/היא 10306.")
    w = Witness.find(3265)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3266).comments.create!(user_id: 415, content: "בשנה שעברה, 'אילונה שטרוסמן' (3266) היה/הייתה מצוות/ת למארח/ת שיראל לסרי (9586). בצד של המארחים הוא/היא 22789.")
    w = Witness.find(3266)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3270).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלקה כץ' (3270) היה/הייתה מצוות/ת למארח/ת יהודית חסקל חיים (3157). בצד של המארחים הוא/היא 9040.")
    w = Witness.find(3270)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3274).comments.create!(user_id: 415, content: "בשנה שעברה, 'נחמה חרמון' (3274) היה/הייתה מצוות/ת למארח/ת זמור לורנס (5774). בצד של המארחים הוא/היא 13223.")
    w = Witness.find(3274)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3281).comments.create!(user_id: 415, content: "בשנה שעברה, 'צביקה אונגר' (3281) היה/הייתה מצוות/ת למארח/ת שי פינצ׳בסקי (4320). בצד של המארחים הוא/היא 10532.")
    w = Witness.find(3281)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3269).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברדה יעקב' (3269) היה/הייתה מצוות/ת למארח/ת בלה מסיקה (8844). בצד של המארחים הוא/היא 20082.")
    w = Witness.find(3269)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(631).comments.create!(user_id: 415, content: "בשנה שעברה, 'יצחק אברמוביץ'' (631) היה/הייתה מצוות/ת למארח/ת רחל מלוקה (9622). בצד של המארחים הוא/היא 22947.")
    w = Witness.find(631)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(187).comments.create!(user_id: 415, content: "בשנה שעברה, 'רבקה פז' (187) היה/הייתה מצוות/ת למארח/ת יעל דהאן (4099). בצד של המארחים הוא/היא 10261.")
    w = Witness.find(187)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(909).comments.create!(user_id: 415, content: "בשנה שעברה, 'דוד ארביב' (909) היה/הייתה מצוות/ת למארח/ת מיכל כבביה (3276). בצד של המארחים הוא/היא 9158.")
    w = Witness.find(909)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3267).comments.create!(user_id: 415, content: "בשנה שעברה, 'ציפורה גרשון' (3267) היה/הייתה מצוות/ת למארח/ת לימור ומנו אמסלם (3872). בצד של המארחים הוא/היא 9956.")
    w = Witness.find(3267)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(824).comments.create!(user_id: 415, content: "בשנה שעברה, 'שושנה חגבי' (824) היה/הייתה מצוות/ת למארח/ת נופר זבולון (7701). בצד של המארחים הוא/היא 15796.")
    w = Witness.find(824)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3279).comments.create!(user_id: 415, content: "בשנה שעברה, 'יונה גוטל' (3279) היה/הייתה מצוות/ת למארח/ת נעמי כרמיאל (8325). בצד של המארחים הוא/היא 19148.")
    w = Witness.find(3279)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3268).comments.create!(user_id: 415, content: "בשנה שעברה, 'טום בן ישראל' (3268) היה/הייתה מצוות/ת למארח/ת שירי קליינר (9207). בצד של המארחים הוא/היא 21151.")
    w = Witness.find(3268)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3264).comments.create!(user_id: 415, content: "בשנה שעברה, 'אודי ברנשטיין' (3264) היה/הייתה מצוות/ת למארח/ת רביד כהן-חגי (2216). בצד של המארחים הוא/היא 4132.")
    w = Witness.find(3264)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3283).comments.create!(user_id: 415, content: "בשנה שעברה, 'דוד ארד' (3283) היה/הייתה מצוות/ת למארח/ת רוני גור (4662). בצד של המארחים הוא/היא 11003.")
    w = Witness.find(3283)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3277).comments.create!(user_id: 415, content: "בשנה שעברה, 'אברהמל'ה ליטמן' (3277) היה/הייתה מצוות/ת למארח/ת שחר דרי (8324). בצד של המארחים הוא/היא 19147.")
    w = Witness.find(3277)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3273).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרגרטה בורגר' (3273) היה/הייתה מצוות/ת למארח/ת בת אל מן (9646). בצד של המארחים הוא/היא 23116.")
    w = Witness.find(3273)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(608).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה כהן' (608) היה/הייתה מצוות/ת למארח/ת פני רוזנברג (8955). בצד של המארחים הוא/היא 20323.")
    w = Witness.find(608)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3286).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה רודיטי' (3286) היה/הייתה מצוות/ת למארח/ת מכינת בארי (8201). בצד של המארחים הוא/היא 18981.")
    w = Witness.find(3286)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1029).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוסי בליי' (1029) היה/הייתה מצוות/ת למארח/ת מיכל ששון (7667). בצד של המארחים הוא/היא 6741.")
    w = Witness.find(1029)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3287).comments.create!(user_id: 415, content: "בשנה שעברה, 'דן הגני' (3287) היה/הייתה מצוות/ת למארח/ת אלירז כהן (3096). בצד של המארחים הוא/היא 8978.")
    w = Witness.find(3287)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3290).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל שפרונג' (3290) היה/הייתה מצוות/ת למארח/ת תמר עמיתי (7577). בצד של המארחים הוא/היא 18239.")
    w = Witness.find(3290)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1013).comments.create!(user_id: 415, content: "בשנה שעברה, 'מלי וסרמן' (1013) היה/הייתה מצוות/ת למארח/ת סיגל כזום (679). בצד של המארחים הוא/היא 731.")
    w = Witness.find(1013)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1048).comments.create!(user_id: 415, content: "בשנה שעברה, 'שלמה שרצר' (1048) היה/הייתה מצוות/ת למארח/ת גילי קרני (6601). בצד של המארחים הוא/היא 17147.")
    w = Witness.find(1048)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(441).comments.create!(user_id: 415, content: "בשנה שעברה, 'דורה רוט' (441) היה/הייתה מצוות/ת למארח/ת שלהבת שורר (7331). בצד של המארחים הוא/היא 17950.")
    w = Witness.find(441)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3278).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרים בוקר' (3278) היה/הייתה מצוות/ת למארח/ת יעל כהן-ניסים (8585). בצד של המארחים הוא/היא 19564.")
    w = Witness.find(3278)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1209).comments.create!(user_id: 415, content: "בשנה שעברה, 'מטילדה בייזר' (1209) היה/הייתה מצוות/ת למארח/ת שירלי קנובל (8553). בצד של המארחים הוא/היא 19521.")
    w = Witness.find(1209)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1129).comments.create!(user_id: 415, content: "בשנה שעברה, 'רינה ננתין' (1129) היה/הייתה מצוות/ת למארח/ת שיר דרורי (3251). בצד של המארחים הוא/היא 9134.")
    w = Witness.find(1129)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(211).comments.create!(user_id: 415, content: "בשנה שעברה, 'בלה קופטש' (211) היה/הייתה מצוות/ת למארח/ת עדי אשכנזי (8648). בצד של המארחים הוא/היא 19668.")
    w = Witness.find(211)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(291).comments.create!(user_id: 415, content: "בשנה שעברה, 'דינה טייב' (291) היה/הייתה מצוות/ת למארח/ת שרית פינטו (8981). בצד של המארחים הוא/היא 20387.")
    w = Witness.find(291)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3285).comments.create!(user_id: 415, content: "בשנה שעברה, 'עליזה רדין' (3285) היה/הייתה מצוות/ת למארח/ת סניף הסתדרות כפר סבא (9744). בצד של המארחים הוא/היא 23761.")
    w = Witness.find(3285)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1194).comments.create!(user_id: 415, content: "בשנה שעברה, 'גרוברג מוטל מרדכי' (1194) היה/הייתה מצוות/ת למארח/ת אוריה (8086). בצד של המארחים הוא/היא 18830.")
    w = Witness.find(1194)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1141).comments.create!(user_id: 415, content: "בשנה שעברה, 'מאשה' (1141) היה/הייתה מצוות/ת למארח/ת מאיה פלג (1054). בצד של המארחים הוא/היא 1230.")
    w = Witness.find(1141)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1221).comments.create!(user_id: 415, content: "בשנה שעברה, 'שלום ליאני' (1221) היה/הייתה מצוות/ת למארח/ת ספיר חלפון (7163). בצד של המארחים הוא/היא 17753.")
    w = Witness.find(1221)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(901).comments.create!(user_id: 415, content: "בשנה שעברה, 'שלמה אנגלמן' (901) היה/הייתה מצוות/ת למארח/ת דפנה פטישי ורביב פרילוק (1245). בצד של המארחים הוא/היא 1601.")
    w = Witness.find(901)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(100).comments.create!(user_id: 415, content: "בשנה שעברה, 'אבי רז' (100) היה/הייתה מצוות/ת למארח/ת הדס קירי (9457). בצד של המארחים הוא/היא 22218.")
    w = Witness.find(100)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(50).comments.create!(user_id: 415, content: "בשנה שעברה, 'דינה פרידה' (50) היה/הייתה מצוות/ת למארח/ת מיטל בורק (47). בצד של המארחים הוא/היא 49.")
    w = Witness.find(50)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(70).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהושוע מוסקוביץ לקנר' (70) היה/הייתה מצוות/ת למארח/ת שרון שר וייס -היחידה לקידום נוער ק. ביאליק (5107). בצד של המארחים הוא/היא 11728.")
    w = Witness.find(70)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(112).comments.create!(user_id: 415, content: "בשנה שעברה, 'לולה קלו' (112) היה/הייתה מצוות/ת למארח/ת ליז מדעי (9724). בצד של המארחים הוא/היא 23646.")
    w = Witness.find(112)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(122).comments.create!(user_id: 415, content: "בשנה שעברה, 'רבקה אלבוים' (122) היה/הייתה מצוות/ת למארח/ת ליפשיץ רחלי (2805). בצד של המארחים הוא/היא 8206.")
    w = Witness.find(122)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(195).comments.create!(user_id: 415, content: "בשנה שעברה, 'פנחס כהנא' (195) היה/הייתה מצוות/ת למארח/ת ניר בלדב (9182). בצד של המארחים הוא/היא 21083.")
    w = Witness.find(195)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(226).comments.create!(user_id: 415, content: "בשנה שעברה, 'קלריס שכטר' (226) היה/הייתה מצוות/ת למארח/ת אדווה פוטזניק (8336). בצד של המארחים הוא/היא 19160.")
    w = Witness.find(226)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(234).comments.create!(user_id: 415, content: "בשנה שעברה, 'צבי שפט' (234) היה/הייתה מצוות/ת למארח/ת קפה אמא (7124). בצד של המארחים הוא/היא 17708.")
    w = Witness.find(234)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(220).comments.create!(user_id: 415, content: "בשנה שעברה, 'פנינה זייצמן' (220) היה/הייתה מצוות/ת למארח/ת אורי (7954). בצד של המארחים הוא/היא 18679.")
    w = Witness.find(220)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(506).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית ווארי' (506) היה/הייתה מצוות/ת למארח/ת מוריה קרמרמן (7889). בצד של המארחים הוא/היא 18601.")
    w = Witness.find(506)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(313).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרים חביב' (313) היה/הייתה מצוות/ת למארח/ת איתי רענן (9135). בצד של המארחים הוא/היא 20848.")
    w = Witness.find(313)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(320).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרי בוייר' (320) היה/הייתה מצוות/ת למארח/ת חנה קדוש (8649). בצד של המארחים הוא/היא 19675.")
    w = Witness.find(320)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(271).comments.create!(user_id: 415, content: "בשנה שעברה, 'ורד קאופמן' (271) היה/הייתה מצוות/ת למארח/ת עינה לקח (6725). בצד של המארחים הוא/היא 17268.")
    w = Witness.find(271)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3289).comments.create!(user_id: 415, content: "בשנה שעברה, 'רויטמן בטי' (3289) היה/הייתה מצוות/ת למארח/ת שרה דינרשטיין (9429). בצד של המארחים הוא/היא 22023.")
    w = Witness.find(3289)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(443).comments.create!(user_id: 415, content: "בשנה שעברה, 'רפי לוי' (443) היה/הייתה מצוות/ת למארח/ת ציפי בנדר (4069). בצד של המארחים הוא/היא 10229.")
    w = Witness.find(443)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(683).comments.create!(user_id: 415, content: "בשנה שעברה, 'אברהם שלומי' (683) היה/הייתה מצוות/ת למארח/ת אד סטרומר (6702). בצד של המארחים הוא/היא 17245.")
    w = Witness.find(683)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(372).comments.create!(user_id: 415, content: "בשנה שעברה, 'קטלין שוורץ' (372) היה/הייתה מצוות/ת למארח/ת מורן דויטשמן (6622). בצד של המארחים הוא/היא 17168.")
    w = Witness.find(372)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(484).comments.create!(user_id: 415, content: "בשנה שעברה, 'זהבה גלנטי' (484) היה/הייתה מצוות/ת למארח/ת דיויד רוז (8438). בצד של המארחים הוא/היא 19348.")
    w = Witness.find(484)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(448).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתי בוזי' (448) היה/הייתה מצוות/ת למארח/ת מורן בן ישי מלח (7329). בצד של המארחים הוא/היא 17948.")
    w = Witness.find(448)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(374).comments.create!(user_id: 415, content: "בשנה שעברה, 'מנחם יוסוביץ'' (374) היה/הייתה מצוות/ת למארח/ת נטע שר (7798). בצד של המארחים הוא/היא 18497.")
    w = Witness.find(374)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(682).comments.create!(user_id: 415, content: "בשנה שעברה, 'שפרה דוד' (682) היה/הייתה מצוות/ת למארח/ת דור אזולאי (5934). בצד של המארחים הוא/היא 13677.")
    w = Witness.find(682)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(725).comments.create!(user_id: 415, content: "בשנה שעברה, 'צבי פרנק' (725) היה/הייתה מצוות/ת למארח/ת עלי ברוק (6924). בצד של המארחים הוא/היא 17480.")
    w = Witness.find(725)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(734).comments.create!(user_id: 415, content: "בשנה שעברה, 'יעקב סימקוביץ'' (734) היה/הייתה מצוות/ת למארח/ת תם צייגר (5870). בצד של המארחים הוא/היא 13463.")
    w = Witness.find(734)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3288).comments.create!(user_id: 415, content: "בשנה שעברה, 'שלום קלנר' (3288) היה/הייתה מצוות/ת למארח/ת יובל לוי (9038). בצד של המארחים הוא/היא 20581.")
    w = Witness.find(3288)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(773).comments.create!(user_id: 415, content: "בשנה שעברה, 'לילי כהן' (773) היה/הייתה מצוות/ת למארח/ת הוסטל סלעית-אסנת (8356). בצד של המארחים הוא/היא 19182.")
    w = Witness.find(773)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(605).comments.create!(user_id: 415, content: "בשנה שעברה, 'זבלודובסקי לילה' (605) היה/הייתה מצוות/ת למארח/ת ירדן אלפסי (7514). בצד של המארחים הוא/היא 18166.")
    w = Witness.find(605)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(589).comments.create!(user_id: 415, content: "בשנה שעברה, 'דן צור' (589) היה/הייתה מצוות/ת למארח/ת שירה גורלי (7083). בצד של המארחים הוא/היא 17665.")
    w = Witness.find(589)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(640).comments.create!(user_id: 415, content: "בשנה שעברה, 'בתיה רפפורט' (640) היה/הייתה מצוות/ת למארח/ת דורון רנצר (8296). בצד של המארחים הוא/היא 19096.")
    w = Witness.find(640)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(577).comments.create!(user_id: 415, content: "בשנה שעברה, 'הדסה המבורגר' (577) היה/הייתה מצוות/ת למארח/ת סימה (7491). בצד של המארחים הוא/היא 5512.")
    w = Witness.find(577)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1425).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה יענקוביץ' (1425) היה/הייתה מצוות/ת למארח/ת ליאור לנצר (8775). בצד של המארחים הוא/היא 19905.")
    w = Witness.find(1425)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(753).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית אליס באר' (753) היה/הייתה מצוות/ת למארח/ת ניצן דיין (8323). בצד של המארחים הוא/היא 19146.")
    w = Witness.find(753)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3293).comments.create!(user_id: 415, content: "בשנה שעברה, 'יפים מנקין' (3293) היה/הייתה מצוות/ת למארח/ת נעמי חסין דברה (9856). בצד של המארחים הוא/היא 24916.")
    w = Witness.find(3293)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(326).comments.create!(user_id: 415, content: "בשנה שעברה, 'דליה פורן' (326) היה/הייתה מצוות/ת למארח/ת קטרין אשורוב (8870). בצד של המארחים הוא/היא 20131.")
    w = Witness.find(326)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(68).comments.create!(user_id: 415, content: "בשנה שעברה, 'שלומית טמיר' (68) היה/הייתה מצוות/ת למארח/ת הילה קולן ששון (7085). בצד של המארחים הוא/היא 17667.")
    w = Witness.find(68)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1522).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוליוס בראון' (1522) היה/הייתה מצוות/ת למארח/ת אדוה וזאנה (1004). בצד של המארחים הוא/היא 1137.")
    w = Witness.find(1522)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(749).comments.create!(user_id: 415, content: "בשנה שעברה, 'אדה פרימר' (749) היה/הייתה מצוות/ת למארח/ת ערן ויצנר (7221). בצד של המארחים הוא/היא 17818.")
    w = Witness.find(749)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1401).comments.create!(user_id: 415, content: "בשנה שעברה, 'עליזה טננבאום' (1401) היה/הייתה מצוות/ת למארח/ת טלי מלינוביץ (7236). בצד של המארחים הוא/היא 12008.")
    w = Witness.find(1401)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(419).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה פסיה דוידוביץ רבי' (419) היה/הייתה מצוות/ת למארח/ת יפית עזר (9559). בצד של המארחים הוא/היא 22654.")
    w = Witness.find(419)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3291).comments.create!(user_id: 415, content: "בשנה שעברה, 'הינדה' (3291) היה/הייתה מצוות/ת למארח/ת הילה גולן (3815). בצד של המארחים הוא/היא 9890.")
    w = Witness.find(3291)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1771).comments.create!(user_id: 415, content: "בשנה שעברה, 'פטר בכרך' (1771) היה/הייתה מצוות/ת למארח/ת לארה ברק (8854). בצד של המארחים הוא/היא 20109.")
    w = Witness.find(1771)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1646).comments.create!(user_id: 415, content: "בשנה שעברה, 'נלי פרזמה' (1646) היה/הייתה מצוות/ת למארח/ת מוטי בן אשר (8271). בצד של המארחים הוא/היא 19063.")
    w = Witness.find(1646)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1624).comments.create!(user_id: 415, content: "בשנה שעברה, 'מוריס גליק' (1624) היה/הייתה מצוות/ת למארח/ת אולפנית \"הראל\" (7216). בצד של המארחים הוא/היא 17813.")
    w = Witness.find(1624)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1660).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתר דובלין' (1660) היה/הייתה מצוות/ת למארח/ת מיכל פרגו (7921). בצד של המארחים הוא/היא 18636.")
    w = Witness.find(1660)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1975).comments.create!(user_id: 415, content: "בשנה שעברה, 'דבורה ברגר - לא לצוות 2017' (1975) היה/הייתה מצוות/ת למארח/ת אביבה (7059). בצד של המארחים הוא/היא 17638.")
    w = Witness.find(1975)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2338).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיים בסיסט' (2338) היה/הייתה מצוות/ת למארח/ת קשת נוסצקי (4604). בצד של המארחים הוא/היא 10925.")
    w = Witness.find(2338)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3292).comments.create!(user_id: 415, content: "בשנה שעברה, 'נוסיה וייס' (3292) היה/הייתה מצוות/ת למארח/ת תמר סגל (7869). בצד של המארחים הוא/היא 18575.")
    w = Witness.find(3292)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1769).comments.create!(user_id: 415, content: "בשנה שעברה, 'שושנה מזור' (1769) היה/הייתה מצוות/ת למארח/ת משה טסלר (4671). בצד של המארחים הוא/היא 11014.")
    w = Witness.find(1769)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3299).comments.create!(user_id: 415, content: "בשנה שעברה, 'רוני' (3299) היה/הייתה מצוות/ת למארח/ת גאוי מזל לילך (7207). בצד של המארחים הוא/היא 17799.")
    w = Witness.find(3299)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3300).comments.create!(user_id: 415, content: "בשנה שעברה, 'אדווה גאות' (3300) היה/הייתה מצוות/ת למארח/ת ליאת פיטוסי (6440). בצד של המארחים הוא/היא 16981.")
    w = Witness.find(3300)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3297).comments.create!(user_id: 415, content: "בשנה שעברה, 'מירה רז' (3297) היה/הייתה מצוות/ת למארח/ת דן רושנסקי (9795). בצד של המארחים הוא/היא 24306.")
    w = Witness.find(3297)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(968).comments.create!(user_id: 415, content: "בשנה שעברה, 'יצחק יעקבי' (968) היה/הייתה מצוות/ת למארח/ת אדוה (7866). בצד של המארחים הוא/היא 18572.")
    w = Witness.find(968)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1562).comments.create!(user_id: 415, content: "בשנה שעברה, 'זהבה וינשטיין' (1562) היה/הייתה מצוות/ת למארח/ת רינת אלימלך (9246). בצד של המארחים הוא/היא 21260.")
    w = Witness.find(1562)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(986).comments.create!(user_id: 415, content: "בשנה שעברה, 'שאול גטניו' (986) היה/הייתה מצוות/ת למארח/ת טל גולסט (7580). בצד של המארחים הוא/היא 18244.")
    w = Witness.find(986)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1453).comments.create!(user_id: 415, content: "בשנה שעברה, 'גוטמן פייגה ציפי' (1453) היה/הייתה מצוות/ת למארח/ת חלי סינאי (8141). בצד של המארחים הוא/היא 18892.")
    w = Witness.find(1453)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1559).comments.create!(user_id: 415, content: "בשנה שעברה, 'פלה רביב' (1559) היה/הייתה מצוות/ת למארח/ת יעל טרוחיו (6527). בצד של המארחים הוא/היא 17074.")
    w = Witness.find(1559)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1972).comments.create!(user_id: 415, content: "בשנה שעברה, 'קובי קבלק' (1972) היה/הייתה מצוות/ת למארח/ת ספיר אמזלג (7996). בצד של המארחים הוא/היא 18729.")
    w = Witness.find(1972)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2315).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלחנן בר לב' (2315) היה/הייתה מצוות/ת למארח/ת tomer shockner (7744). בצד של המארחים הוא/היא 18437.")
    w = Witness.find(2315)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3298).comments.create!(user_id: 415, content: "בשנה שעברה, 'פנחס בריס' (3298) היה/הייתה מצוות/ת למארח/ת אילנה מרכוס (6031). בצד של המארחים הוא/היא 14015.")
    w = Witness.find(3298)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2340).comments.create!(user_id: 415, content: "בשנה שעברה, 'נאווה חרובי' (2340) היה/הייתה מצוות/ת למארח/ת אורטל לאלזר (748). בצד של המארחים הוא/היא 801.")
    w = Witness.find(2340)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2335).comments.create!(user_id: 415, content: "בשנה שעברה, 'עליזה מרמלשטיין' (2335) היה/הייתה מצוות/ת למארח/ת סתיו פרלה (7248). בצד של המארחים הוא/היא 17845.")
    w = Witness.find(2335)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(598).comments.create!(user_id: 415, content: "בשנה שעברה, 'אדית מרגלית' (598) היה/הייתה מצוות/ת למארח/ת סילברמן אברהמית (8745). בצד של המארחים הוא/היא 19852.")
    w = Witness.find(598)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1923).comments.create!(user_id: 415, content: "בשנה שעברה, 'אבירם רוזנטל' (1923) היה/הייתה מצוות/ת למארח/ת טל צור (6501). בצד של המארחים הוא/היא 17051.")
    w = Witness.find(1923)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(978).comments.create!(user_id: 415, content: "בשנה שעברה, 'יצחק צלאל' (978) היה/הייתה מצוות/ת למארח/ת ירדן אורן (7015). בצד של המארחים הוא/היא 17584.")
    w = Witness.find(978)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2348).comments.create!(user_id: 415, content: "בשנה שעברה, 'צבי וריקי פלד' (2348) היה/הייתה מצוות/ת למארח/ת טל פריתס (8837). בצד של המארחים הוא/היא 20063.")
    w = Witness.find(2348)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(764).comments.create!(user_id: 415, content: "בשנה שעברה, 'אדוארד בלושנקו' (764) היה/הייתה מצוות/ת למארח/ת יעל גרינפלד (8037). בצד של המארחים הוא/היא 18769.")
    w = Witness.find(764)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2375).comments.create!(user_id: 415, content: "בשנה שעברה, 'דינה גבאי' (2375) היה/הייתה מצוות/ת למארח/ת אורן סודאי (6922). בצד של המארחים הוא/היא 17478.")
    w = Witness.find(2375)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2358).comments.create!(user_id: 415, content: "בשנה שעברה, 'מיכה טסלר' (2358) היה/הייתה מצוות/ת למארח/ת גבי קלור (562). בצד של המארחים הוא/היא 611.")
    w = Witness.find(2358)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3295).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמואל דוד' (3295) היה/הייתה מצוות/ת למארח/ת מועצת התלמידים המחוזית (9370). בצד של המארחים הוא/היא 21708.")
    w = Witness.find(3295)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2382).comments.create!(user_id: 415, content: "בשנה שעברה, 'ישראל מרמלשטיין' (2382) היה/הייתה מצוות/ת למארח/ת עמית מאיר (8212). בצד של המארחים הוא/היא 18993.")
    w = Witness.find(2382)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1324).comments.create!(user_id: 415, content: "בשנה שעברה, 'רמי קמחי' (1324) היה/הייתה מצוות/ת למארח/ת שני לנדאו (בית העמותות) (3726). בצד של המארחים הוא/היא 9785.")
    w = Witness.find(1324)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2385).comments.create!(user_id: 415, content: "בשנה שעברה, 'בני פרל' (2385) היה/הייתה מצוות/ת למארח/ת עמית דלמדיגו (7378). בצד של המארחים הוא/היא 18004.")
    w = Witness.find(2385)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2394).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית גנור' (2394) היה/הייתה מצוות/ת למארח/ת מעין ויצחק מרקוביץ (9364). בצד של המארחים הוא/היא 21674.")
    w = Witness.find(2394)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2396).comments.create!(user_id: 415, content: "בשנה שעברה, 'עטרה אנגל' (2396) היה/הייתה מצוות/ת למארח/ת דורית תמיר (6736). בצד של המארחים הוא/היא 17279.")
    w = Witness.find(2396)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(428).comments.create!(user_id: 415, content: "בשנה שעברה, 'הלין רומני' (428) היה/הייתה מצוות/ת למארח/ת אבישג גל (9769). בצד של המארחים הוא/היא 23996.")
    w = Witness.find(428)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2397).comments.create!(user_id: 415, content: "בשנה שעברה, 'אריק הולדר' (2397) היה/הייתה מצוות/ת למארח/ת עדי גינל (6663). בצד של המארחים הוא/היא 17207.")
    w = Witness.find(2397)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2399).comments.create!(user_id: 415, content: "בשנה שעברה, 'אריה ביבאס' (2399) היה/הייתה מצוות/ת למארח/ת נועה גולדנברג (8140). בצד של המארחים הוא/היא 18889.")
    w = Witness.find(2399)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2390).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל מורן' (2390) היה/הייתה מצוות/ת למארח/ת גיא בורשצ'וק (7265). בצד של המארחים הוא/היא 17868.")
    w = Witness.find(2390)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2400).comments.create!(user_id: 415, content: "בשנה שעברה, 'בלה בלשניקוב' (2400) היה/הייתה מצוות/ת למארח/ת תהילה מאמו (7422). בצד של המארחים הוא/היא 6018.")
    w = Witness.find(2400)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2389).comments.create!(user_id: 415, content: "בשנה שעברה, 'קטי לוי' (2389) היה/הייתה מצוות/ת למארח/ת ליה מעור-בקר (7862). בצד של המארחים הוא/היא 18568.")
    w = Witness.find(2389)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2413).comments.create!(user_id: 415, content: "בשנה שעברה, 'מנחם פרי' (2413) היה/הייתה מצוות/ת למארח/ת זהר קפלן וטלי חנין (223). בצד של המארחים הוא/היא 229.")
    w = Witness.find(2413)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2175).comments.create!(user_id: 415, content: "בשנה שעברה, 'ורה מייזלס' (2175) היה/הייתה מצוות/ת למארח/ת נדב מנדלסון (611). בצד של המארחים הוא/היא 660.")
    w = Witness.find(2175)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2251).comments.create!(user_id: 415, content: "בשנה שעברה, 'דבורה שרייבר' (2251) היה/הייתה מצוות/ת למארח/ת רן בן עטיה (8066). בצד של המארחים הוא/היא 18803.")
    w = Witness.find(2251)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2466).comments.create!(user_id: 415, content: "בשנה שעברה, 'כץ פריצה' (2466) היה/הייתה מצוות/ת למארח/ת שרון שקד (5985). בצד של המארחים הוא/היא 7427.")
    w = Witness.find(2466)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2064).comments.create!(user_id: 415, content: "בשנה שעברה, 'חגי זילברברג' (2064) היה/הייתה מצוות/ת למארח/ת איטה גור אריה (1489). בצד של המארחים הוא/היא 2116.")
    w = Witness.find(2064)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2404).comments.create!(user_id: 415, content: "בשנה שעברה, 'ליאורה גול' (2404) היה/הייתה מצוות/ת למארח/ת נורית ושרון (7626). בצד של המארחים הוא/היא 18299.")
    w = Witness.find(2404)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2414).comments.create!(user_id: 415, content: "בשנה שעברה, 'שלום טמיר' (2414) היה/הייתה מצוות/ת למארח/ת עליזה מרגוליס (8878). בצד של המארחים הוא/היא 20155.")
    w = Witness.find(2414)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2458).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברגר מיקי' (2458) היה/הייתה מצוות/ת למארח/ת ליטל אפרתי (8724). בצד של המארחים הוא/היא 19816.")
    w = Witness.find(2458)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2417).comments.create!(user_id: 415, content: "בשנה שעברה, 'ריקרדו לפין' (2417) היה/הייתה מצוות/ת למארח/ת מיכלי ישראלי (7575). בצד של המארחים הוא/היא 18237.")
    w = Witness.find(2417)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2425).comments.create!(user_id: 415, content: "בשנה שעברה, 'ד\"ר חדווה טרגר' (2425) היה/הייתה מצוות/ת למארח/ת שחר שרביט (7340). בצד של המארחים הוא/היא 12028.")
    w = Witness.find(2425)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2433).comments.create!(user_id: 415, content: "בשנה שעברה, 'פולט פוקס' (2433) היה/הייתה מצוות/ת למארח/ת נועה שדמי (3246). בצד של המארחים הוא/היא 9130.")
    w = Witness.find(2433)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2423).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה\tקאופמן' (2423) היה/הייתה מצוות/ת למארח/ת מוטי שקד (6548). בצד של המארחים הוא/היא 17097.")
    w = Witness.find(2423)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2416).comments.create!(user_id: 415, content: "בשנה שעברה, 'שפרה שידלובצקי' (2416) היה/הייתה מצוות/ת למארח/ת דוד גבאי (9372). בצד של המארחים הוא/היא 21738.")
    w = Witness.find(2416)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2411).comments.create!(user_id: 415, content: "בשנה שעברה, 'אפרים לעדן' (2411) היה/הייתה מצוות/ת למארח/ת רויטל זגלשטיין (7026). בצד של המארחים הוא/היא 17597.")
    w = Witness.find(2411)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2020).comments.create!(user_id: 415, content: "בשנה שעברה, 'ראובן קליין' (2020) היה/הייתה מצוות/ת למארח/ת אלי אלבז (6915). בצד של המארחים הוא/היא 17471.")
    w = Witness.find(2020)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2420).comments.create!(user_id: 415, content: "בשנה שעברה, 'גניה בן עזרא' (2420) היה/הייתה מצוות/ת למארח/ת עדי שגיא (7587). בצד של המארחים הוא/היא 18252.")
    w = Witness.find(2420)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2430).comments.create!(user_id: 415, content: "בשנה שעברה, 'צבי שלמוביץ' (2430) היה/הייתה מצוות/ת למארח/ת קמיל אמיר (6908). בצד של המארחים הוא/היא 17464.")
    w = Witness.find(2430)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2445).comments.create!(user_id: 415, content: "בשנה שעברה, 'הדסה חלמיש' (2445) היה/הייתה מצוות/ת למארח/ת טלי פסקל (6681). בצד של המארחים הוא/היא 17225.")
    w = Witness.find(2445)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3301).comments.create!(user_id: 415, content: "בשנה שעברה, 'מירים איתן' (3301) היה/הייתה מצוות/ת למארח/ת רויטל טורג'מן ג'וזף (4340). בצד של המארחים הוא/היא 10557.")
    w = Witness.find(3301)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2473).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברנד סנדובסקי' (2473) היה/הייתה מצוות/ת למארח/ת מיכל צור (7686). בצד של המארחים הוא/היא 18367.")
    w = Witness.find(2473)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2427).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרטין הרשקוביץ' (2427) היה/הייתה מצוות/ת למארח/ת עודד ברזילי (8763). בצד של המארחים הוא/היא 3579.")
    w = Witness.find(2427)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2456).comments.create!(user_id: 415, content: "בשנה שעברה, 'אוגמן לילי' (2456) היה/הייתה מצוות/ת למארח/ת אורי גור דותן (3493). בצד של המארחים הוא/היא 9408.")
    w = Witness.find(2456)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2489).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית גוטמן' (2489) היה/הייתה מצוות/ת למארח/ת סיליה גבאי (8013). בצד של המארחים הוא/היא 18747.")
    w = Witness.find(2489)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2488).comments.create!(user_id: 415, content: "בשנה שעברה, 'פולק מירה' (2488) היה/הייתה מצוות/ת למארח/ת יעל שורצברג (4506). בצד של המארחים הוא/היא 10789.")
    w = Witness.find(2488)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2442).comments.create!(user_id: 415, content: "בשנה שעברה, 'יעקב קראוס' (2442) היה/הייתה מצוות/ת למארח/ת זהר יפלח (7860). בצד של המארחים הוא/היא 18566.")
    w = Witness.find(2442)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2481).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמואל באום' (2481) היה/הייתה מצוות/ת למארח/ת אורית נבו (6942). בצד של המארחים הוא/היא 17507.")
    w = Witness.find(2481)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2524).comments.create!(user_id: 415, content: "בשנה שעברה, 'אברהמי ברכה' (2524) היה/הייתה מצוות/ת למארח/ת אורי הררי (6802). בצד של המארחים הוא/היא 17350.")
    w = Witness.find(2524)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2514).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלי צביאלי' (2514) היה/הייתה מצוות/ת למארח/ת טלאור לסרי (7073). בצד של המארחים הוא/היא 17655.")
    w = Witness.find(2514)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1700).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמשון פורר' (1700) היה/הייתה מצוות/ת למארח/ת אמילי שופן (2453). בצד של המארחים הוא/היא 5058.")
    w = Witness.find(1700)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2486).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמואל הרשקוביץ' (2486) היה/הייתה מצוות/ת למארח/ת אנה סומגין (9522). בצד של המארחים הוא/היא 22489.")
    w = Witness.find(2486)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2498).comments.create!(user_id: 415, content: "בשנה שעברה, 'מיכאל ברק' (2498) היה/הייתה מצוות/ת למארח/ת אלדד בר-אלי (4312). בצד של המארחים הוא/היא 5599.")
    w = Witness.find(2498)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2429).comments.create!(user_id: 415, content: "בשנה שעברה, 'נעה מימן' (2429) היה/הייתה מצוות/ת למארח/ת המרכז למנהיגות לב יפו (4243). בצד של המארחים הוא/היא 10440.")
    w = Witness.find(2429)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2483).comments.create!(user_id: 415, content: "בשנה שעברה, 'פרידה ורקשטטל' (2483) היה/הייתה מצוות/ת למארח/ת דנה דוידי (8276). בצד של המארחים הוא/היא 19068.")
    w = Witness.find(2483)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2491).comments.create!(user_id: 415, content: "בשנה שעברה, 'מלכה גילת' (2491) היה/הייתה מצוות/ת למארח/ת אבלין צברי (7636). בצד של המארחים הוא/היא 18314.")
    w = Witness.find(2491)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2480).comments.create!(user_id: 415, content: "בשנה שעברה, 'דוד טייב' (2480) היה/הייתה מצוות/ת למארח/ת מיי שמש (8942). בצד של המארחים הוא/היא 20290.")
    w = Witness.find(2480)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2513).comments.create!(user_id: 415, content: "בשנה שעברה, 'טובה מאיר' (2513) היה/הייתה מצוות/ת למארח/ת מארק ואיבט סורין (8018). בצד של המארחים הוא/היא 18752.")
    w = Witness.find(2513)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2536).comments.create!(user_id: 415, content: "בשנה שעברה, 'לאה גורודצקי' (2536) היה/הייתה מצוות/ת למארח/ת רועי ויינברגר (9422). בצד של המארחים הוא/היא 21978.")
    w = Witness.find(2536)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2418).comments.create!(user_id: 415, content: "בשנה שעברה, 'מיכל שפרנסקי פרידמן' (2418) היה/הייתה מצוות/ת למארח/ת שמרית מועלם (7900). בצד של המארחים הוא/היא 18614.")
    w = Witness.find(2418)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2500).comments.create!(user_id: 415, content: "בשנה שעברה, 'ריבה מנו' (2500) היה/הייתה מצוות/ת למארח/ת אלה טהורלב (8881). בצד של המארחים הוא/היא 5027.")
    w = Witness.find(2500)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2237).comments.create!(user_id: 415, content: "בשנה שעברה, 'ד\"ר ברכה רחמילביץ' (2237) היה/הייתה מצוות/ת למארח/ת נועה שטרן (1648). בצד של המארחים הוא/היא 2460.")
    w = Witness.find(2237)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2521).comments.create!(user_id: 415, content: "בשנה שעברה, 'יצחק לוין' (2521) היה/הייתה מצוות/ת למארח/ת רווית אלמקיאס - חברת TIME TO KNOW (7405). בצד של המארחים הוא/היא 18038.")
    w = Witness.find(2521)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2509).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמואל בונים (מומוס)' (2509) היה/הייתה מצוות/ת למארח/ת אמי (9788). בצד של המארחים הוא/היא 24259.")
    w = Witness.find(2509)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2374).comments.create!(user_id: 415, content: "בשנה שעברה, 'מלכה מלמד' (2374) היה/הייתה מצוות/ת למארח/ת מעין גלבוע (7324). בצד של המארחים הוא/היא 17943.")
    w = Witness.find(2374)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(250).comments.create!(user_id: 415, content: "בשנה שעברה, 'יואל דרורי' (250) היה/הייתה מצוות/ת למארח/ת קהילת 'סוכת שלום' (1633). בצד של המארחים הוא/היא 2430.")
    w = Witness.find(250)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2558).comments.create!(user_id: 415, content: "בשנה שעברה, 'לובה קמרמן' (2558) היה/הייתה מצוות/ת למארח/ת כרמית ארזוני (85). בצד של המארחים הוא/היא 89.")
    w = Witness.find(2558)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2542).comments.create!(user_id: 415, content: "בשנה שעברה, 'מוטי אלון' (2542) היה/הייתה מצוות/ת למארח/ת עדי גפן (8471). בצד של המארחים הוא/היא 19398.")
    w = Witness.find(2542)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2543).comments.create!(user_id: 415, content: "בשנה שעברה, 'דניאל נבנצאל' (2543) היה/הייתה מצוות/ת למארח/ת אלישיב הלפר (8497). בצד של המארחים הוא/היא 19426.")
    w = Witness.find(2543)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(206).comments.create!(user_id: 415, content: "בשנה שעברה, 'פליקס ברקן' (206) היה/הייתה מצוות/ת למארח/ת רועי וגנר (7121). בצד של המארחים הוא/היא 17704.")
    w = Witness.find(206)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2538).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה אשל' (2538) היה/הייתה מצוות/ת למארח/ת גילעד דנן (8118). בצד של המארחים הוא/היא 18862.")
    w = Witness.find(2538)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2484).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה הר ורדי' (2484) היה/הייתה מצוות/ת למארח/ת פריאל זיגדון (7741). בצד של המארחים הוא/היא 18433.")
    w = Witness.find(2484)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2525).comments.create!(user_id: 415, content: "בשנה שעברה, 'ריטה זילבר' (2525) היה/הייתה מצוות/ת למארח/ת ענבר תורגמן (4132). בצד של המארחים הוא/היא 10303.")
    w = Witness.find(2525)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2566).comments.create!(user_id: 415, content: "בשנה שעברה, 'בתי תורג׳מן' (2566) היה/הייתה מצוות/ת למארח/ת שני סולמי (7725). בצד של המארחים הוא/היא 18416.")
    w = Witness.find(2566)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2518).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל פיין' (2518) היה/הייתה מצוות/ת למארח/ת הדס פסטר-בכר, קהילת רענן בית שמואלי (7306). בצד של המארחים הוא/היא 17919.")
    w = Witness.find(2518)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2564).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיים גלעד' (2564) היה/הייתה מצוות/ת למארח/ת אבישג בצר (8357). בצד של המארחים הוא/היא 19185.")
    w = Witness.find(2564)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(701).comments.create!(user_id: 415, content: "בשנה שעברה, 'ריטה ג'קובס' (701) היה/הייתה מצוות/ת למארח/ת גדי כלטוב (4534). בצד של המארחים הוא/היא 10825.")
    w = Witness.find(701)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2639).comments.create!(user_id: 415, content: "בשנה שעברה, 'יעל שפיגלר' (2639) היה/הייתה מצוות/ת למארח/ת טלי וגידי הררי (332). בצד של המארחים הוא/היא 362.")
    w = Witness.find(2639)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2576).comments.create!(user_id: 415, content: "בשנה שעברה, 'יפים קסלר' (2576) היה/הייתה מצוות/ת למארח/ת עדי צברי (7788). בצד של המארחים הוא/היא 18485.")
    w = Witness.find(2576)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2650).comments.create!(user_id: 415, content: "בשנה שעברה, 'מיכל אמיר' (2650) היה/הייתה מצוות/ת למארח/ת ניצן חכם (3269). בצד של המארחים הוא/היא 9151.")
    w = Witness.find(2650)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1625).comments.create!(user_id: 415, content: "בשנה שעברה, 'הנרי למברגר - לא לצוות 2017' (1625) היה/הייתה מצוות/ת למארח/ת אביגיל ביילי (7789). בצד של המארחים הוא/היא 18487.")
    w = Witness.find(1625)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2636).comments.create!(user_id: 415, content: "בשנה שעברה, 'צביה גולן' (2636) היה/הייתה מצוות/ת למארח/ת אייל פינטו (6875). בצד של המארחים הוא/היא 17431.")
    w = Witness.find(2636)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2647).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרטה גורן' (2647) היה/הייתה מצוות/ת למארח/ת טלי בלומנטל (6679). בצד של המארחים הוא/היא 17223.")
    w = Witness.find(2647)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2548).comments.create!(user_id: 415, content: "בשנה שעברה, 'רבקה חברוני' (2548) היה/הייתה מצוות/ת למארח/ת מעיין רודן (751). בצד של המארחים הוא/היא 804.")
    w = Witness.find(2548)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3305).comments.create!(user_id: 415, content: "בשנה שעברה, 'מאיר דויטש' (3305) היה/הייתה מצוות/ת למארח/ת זהר שוק (9496). בצד של המארחים הוא/היא 22400.")
    w = Witness.find(3305)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2597).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל קרט' (2597) היה/הייתה מצוות/ת למארח/ת מוטי קרמר (5020). בצד של המארחים הוא/היא 11570.")
    w = Witness.find(2597)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2586).comments.create!(user_id: 415, content: "בשנה שעברה, 'קוקין פאינה' (2586) היה/הייתה מצוות/ת למארח/ת ורדה קורן (6950). בצד של המארחים הוא/היא 17516.")
    w = Witness.find(2586)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2614).comments.create!(user_id: 415, content: "בשנה שעברה, 'טרקנוב שרה' (2614) היה/הייתה מצוות/ת למארח/ת שירלי (6967). בצד של המארחים הוא/היא 17534.")
    w = Witness.find(2614)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1628).comments.create!(user_id: 415, content: "בשנה שעברה, 'ג'וזף שרייבר' (1628) היה/הייתה מצוות/ת למארח/ת שושנה זיגלמן (7692). בצד של המארחים הוא/היא 15991.")
    w = Witness.find(1628)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2606).comments.create!(user_id: 415, content: "בשנה שעברה, 'נעמי משיח' (2606) היה/הייתה מצוות/ת למארח/ת זיוה גינוסר (9513). בצד של המארחים הוא/היא 22461.")
    w = Witness.find(2606)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2596).comments.create!(user_id: 415, content: "בשנה שעברה, 'הדסה קליימן' (2596) היה/הייתה מצוות/ת למארח/ת אמילי שופן וגל פרידמן (4752). בצד של המארחים הוא/היא 11114.")
    w = Witness.find(2596)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2600).comments.create!(user_id: 415, content: "בשנה שעברה, 'פרידה אלזנר' (2600) היה/הייתה מצוות/ת למארח/ת אפרת חובב (7450). בצד של המארחים הוא/היא 18090.")
    w = Witness.find(2600)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2612).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית פישל' (2612) היה/הייתה מצוות/ת למארח/ת מורן רם (4617). בצד של המארחים הוא/היא 10940.")
    w = Witness.find(2612)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(5).comments.create!(user_id: 415, content: "בשנה שעברה, 'מינה שרגאי' (5) היה/הייתה מצוות/ת למארח/ת עדי מויאל (5694). בצד של המארחים הוא/היא 7494.")
    w = Witness.find(5)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(972).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודה זילברשטרס' (972) היה/הייתה מצוות/ת למארח/ת רינת גבאי (8811). בצד של המארחים הוא/היא 19986.")
    w = Witness.find(972)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2605).comments.create!(user_id: 415, content: "בשנה שעברה, 'מאירה אור-לבן' (2605) היה/הייתה מצוות/ת למארח/ת רוני טרוסטלר קרניאל (7240). בצד של המארחים הוא/היא 17836.")
    w = Witness.find(2605)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3304).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל פיקסלר' (3304) היה/הייתה מצוות/ת למארח/ת דניאל פרידמן (7957). בצד של המארחים הוא/היא 18682.")
    w = Witness.find(3304)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2604).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרדכי נוימן' (2604) היה/הייתה מצוות/ת למארח/ת יעל ליבוביץ (8576). בצד של המארחים הוא/היא 19550.")
    w = Witness.find(2604)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2601).comments.create!(user_id: 415, content: "בשנה שעברה, 'בטי שמואלי' (2601) היה/הייתה מצוות/ת למארח/ת יוסי מארי (מרכז צעירים בת-ים) (7666). בצד של המארחים הוא/היא 18346.")
    w = Witness.find(2601)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2603).comments.create!(user_id: 415, content: "בשנה שעברה, 'איצקוביץ' מלכה' (2603) היה/הייתה מצוות/ת למארח/ת הילה נוימן (6926). בצד של המארחים הוא/היא 17482.")
    w = Witness.find(2603)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2594).comments.create!(user_id: 415, content: "בשנה שעברה, 'אייל מעוז' (2594) היה/הייתה מצוות/ת למארח/ת מרכז קהילתי רמת ישראל- ביצרון (7782). בצד של המארחים הוא/היא 18480.")
    w = Witness.find(2594)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2618).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה מרון' (2618) היה/הייתה מצוות/ת למארח/ת תמר כהן (8778). בצד של המארחים הוא/היא 19912.")
    w = Witness.find(2618)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2607).comments.create!(user_id: 415, content: "בשנה שעברה, 'יעל שפירא' (2607) היה/הייתה מצוות/ת למארח/ת יונית רימון (6545). בצד של המארחים הוא/היא 17094.")
    w = Witness.find(2607)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2599).comments.create!(user_id: 415, content: "בשנה שעברה, 'דורה קופר' (2599) היה/הייתה מצוות/ת למארח/ת שרון גל-עמותת אנוש ראשל\"צ (6526). בצד של המארחים הוא/היא 17073.")
    w = Witness.find(2599)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2593).comments.create!(user_id: 415, content: "בשנה שעברה, 'רות צימרמן' (2593) היה/הייתה מצוות/ת למארח/ת לילך גדול (4201). בצד של המארחים הוא/היא 10394.")
    w = Witness.find(2593)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2602).comments.create!(user_id: 415, content: "בשנה שעברה, 'דיויד הנדקנופף' (2602) היה/הייתה מצוות/ת למארח/ת יונה סטוקי (7801). בצד של המארחים הוא/היא 18500.")
    w = Witness.find(2602)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2634).comments.create!(user_id: 415, content: "בשנה שעברה, 'גבי מעיני' (2634) היה/הייתה מצוות/ת למארח/ת גיל ינאי (8101). בצד של המארחים הוא/היא 12377.")
    w = Witness.find(2634)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2635).comments.create!(user_id: 415, content: "בשנה שעברה, 'סנדלר עמי' (2635) היה/הייתה מצוות/ת למארח/ת מעין ברנע זהר (6366). בצד של המארחים הוא/היא 16815.")
    w = Witness.find(2635)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1336).comments.create!(user_id: 415, content: "בשנה שעברה, 'זכר אברמזון' (1336) היה/הייתה מצוות/ת למארח/ת יעקב ספיר (8393). בצד של המארחים הוא/היא 19241.")
    w = Witness.find(1336)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2623).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל ליפשיץ' (2623) היה/הייתה מצוות/ת למארח/ת נאהב ידעי (7739). בצד של המארחים הוא/היא 18431.")
    w = Witness.find(2623)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2628).comments.create!(user_id: 415, content: "בשנה שעברה, 'היימנס יהודית' (2628) היה/הייתה מצוות/ת למארח/ת נמרוד שאולסקי (4012). בצד של המארחים הוא/היא 10153.")
    w = Witness.find(2628)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2637).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה רבקה וייץ' (2637) היה/הייתה מצוות/ת למארח/ת חנה ועמוס להמן (6579). בצד של המארחים הוא/היא 17126.")
    w = Witness.find(2637)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2663).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתר ויטקו' (2663) היה/הייתה מצוות/ת למארח/ת אהוד אסגלי (3972). בצד של המארחים הוא/היא 10107.")
    w = Witness.find(2663)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2617).comments.create!(user_id: 415, content: "בשנה שעברה, 'רות מיטלמן' (2617) היה/הייתה מצוות/ת למארח/ת ענבר שגיא (6532). בצד של המארחים הוא/היא 17077.")
    w = Witness.find(2617)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2642).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתר כץ' (2642) היה/הייתה מצוות/ת למארח/ת רביד אליהו (6935). בצד של המארחים הוא/היא 17497.")
    w = Witness.find(2642)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2620).comments.create!(user_id: 415, content: "בשנה שעברה, 'מריאן סוחר' (2620) היה/הייתה מצוות/ת למארח/ת אושרית רוזמרין (6626). בצד של המארחים הוא/היא 17171.")
    w = Witness.find(2620)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2622).comments.create!(user_id: 415, content: "בשנה שעברה, 'ורד גולדמן' (2622) היה/הייתה מצוות/ת למארח/ת בית הנוער קדימה גבעת אולגה (3016). בצד של המארחים הוא/היא 8898.")
    w = Witness.find(2622)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2629).comments.create!(user_id: 415, content: "בשנה שעברה, 'דורית מונדרר' (2629) היה/הייתה מצוות/ת למארח/ת טלי (9806). בצד של המארחים הוא/היא 24394.")
    w = Witness.find(2629)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2640).comments.create!(user_id: 415, content: "בשנה שעברה, 'צבי אורים' (2640) היה/הייתה מצוות/ת למארח/ת יניר ורחלי פינקר (8097). בצד של המארחים הוא/היא 18842.")
    w = Witness.find(2640)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2641).comments.create!(user_id: 415, content: "בשנה שעברה, 'מיכאל בראון' (2641) היה/הייתה מצוות/ת למארח/ת שירה גולובינסקי (6697). בצד של המארחים הוא/היא 17240.")
    w = Witness.find(2641)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2651).comments.create!(user_id: 415, content: "בשנה שעברה, 'ד\"ר ליאור אלפרוביץ' (2651) היה/הייתה מצוות/ת למארח/ת אוריה טיברגר (3383). בצד של המארחים הוא/היא 9272.")
    w = Witness.find(2651)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2631).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה הולשטיין' (2631) היה/הייתה מצוות/ת למארח/ת שמעונוביץ שרה (9233). בצד של המארחים הוא/היא 21233.")
    w = Witness.find(2631)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2627).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודה (הודי) ליברמן' (2627) היה/הייתה מצוות/ת למארח/ת פנינה עזריאל (8162). בצד של המארחים הוא/היא 18930.")
    w = Witness.find(2627)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2646).comments.create!(user_id: 415, content: "בשנה שעברה, 'רותי אברהם' (2646) היה/הייתה מצוות/ת למארח/ת רחל אבקסיס (8057). בצד של המארחים הוא/היא 18792.")
    w = Witness.find(2646)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3246).comments.create!(user_id: 415, content: "בשנה שעברה, 'יעקב ליפקוביץ'' (3246) היה/הייתה מצוות/ת למארח/ת ליאור בן סימון (9336). בצד של המארחים הוא/היא 21584.")
    w = Witness.find(3246)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2645).comments.create!(user_id: 415, content: "בשנה שעברה, 'חוי רוזנברג' (2645) היה/הייתה מצוות/ת למארח/ת אהרון שרייבר (7584). בצד של המארחים הוא/היא 18249.")
    w = Witness.find(2645)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2300).comments.create!(user_id: 415, content: "בשנה שעברה, 'מיכל דונסקי' (2300) היה/הייתה מצוות/ת למארח/ת מבל ארצי (6528). בצד של המארחים הוא/היא 17075.")
    w = Witness.find(2300)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2665).comments.create!(user_id: 415, content: "בשנה שעברה, 'חריטון גרינבלת' (2665) היה/הייתה מצוות/ת למארח/ת שומר  שרגא (9388). בצד של המארחים הוא/היא 21800.")
    w = Witness.find(2665)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2657).comments.create!(user_id: 415, content: "בשנה שעברה, 'יעקב באומן' (2657) היה/הייתה מצוות/ת למארח/ת מעין מירצ'ין (584). בצד של המארחים הוא/היא 633.")
    w = Witness.find(2657)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(540).comments.create!(user_id: 415, content: "בשנה שעברה, 'פנינה קראוס' (540) היה/הייתה מצוות/ת למארח/ת דקלה יונה (2953). בצד של המארחים הוא/היא 8841.")
    w = Witness.find(540)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1993).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברוריה פלדשטיין' (1993) היה/הייתה מצוות/ת למארח/ת מעיין זמיר (8831). בצד של המארחים הוא/היא 20038.")
    w = Witness.find(1993)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(247).comments.create!(user_id: 415, content: "בשנה שעברה, 'דורית בן זאב' (247) היה/הייתה מצוות/ת למארח/ת שירן עטרי (8829). בצד של המארחים הוא/היא 20029.")
    w = Witness.find(247)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1131).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלימלך רוט' (1131) היה/הייתה מצוות/ת למארח/ת שלומי אבוטבול (9764). בצד של המארחים הוא/היא 23943.")
    w = Witness.find(1131)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2086).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתי אדלר' (2086) היה/הייתה מצוות/ת למארח/ת שרה לינדר להב (9438). בצד של המארחים הוא/היא 22084.")
    w = Witness.find(2086)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1040).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתי ליבר' (1040) היה/הייתה מצוות/ת למארח/ת כפר הסטודנטים (8131). בצד של המארחים הוא/היא 18879.")
    w = Witness.find(1040)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2894).comments.create!(user_id: 415, content: "בשנה שעברה, 'דבורה רם' (2894) היה/הייתה מצוות/ת למארח/ת מרטה סיני (4598). בצד של המארחים הוא/היא 10918.")
    w = Witness.find(2894)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1575).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתר ריכטמן' (1575) היה/הייתה מצוות/ת למארח/ת טל מיבלט ארגון נוער לתת סניף קרית גת (7391). בצד של המארחים הוא/היא 18023.")
    w = Witness.find(1575)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1009).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרתה כהן' (1009) היה/הייתה מצוות/ת למארח/ת הדר דהן (7284). בצד של המארחים הוא/היא 17891.")
    w = Witness.find(1009)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2038).comments.create!(user_id: 415, content: "בשנה שעברה, 'מנה חלפון' (2038) היה/הייתה מצוות/ת למארח/ת יונתן שילר (6861). בצד של המארחים הוא/היא 17417.")
    w = Witness.find(2038)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(189).comments.create!(user_id: 415, content: "בשנה שעברה, 'דינה חיון' (189) היה/הייתה מצוות/ת למארח/ת אורית למפל (8046). בצד של המארחים הוא/היא 18779.")
    w = Witness.find(189)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(378).comments.create!(user_id: 415, content: "בשנה שעברה, 'רגינה טבל וצבי' (378) היה/הייתה מצוות/ת למארח/ת הילה הובר (7868). בצד של המארחים הוא/היא 18574.")
    w = Witness.find(378)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3306).comments.create!(user_id: 415, content: "בשנה שעברה, 'גיל הדני' (3306) היה/הייתה מצוות/ת למארח/ת טל אביטן (5349). בצד של המארחים הוא/היא 12244.")
    w = Witness.find(3306)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2033).comments.create!(user_id: 415, content: "בשנה שעברה, 'נתן (נתי) כהן (פרופ')' (2033) היה/הייתה מצוות/ת למארח/ת אביתר שמוע (4435). בצד של המארחים הוא/היא 10692.")
    w = Witness.find(2033)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(396).comments.create!(user_id: 415, content: "בשנה שעברה, 'אהרון אופן' (396) היה/הייתה מצוות/ת למארח/ת מיה פלפלי (7068). בצד של המארחים הוא/היא 17649.")
    w = Witness.find(396)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2268).comments.create!(user_id: 415, content: "בשנה שעברה, 'אריה לוב' (2268) היה/הייתה מצוות/ת למארח/ת דוריה אור (7136). בצד של המארחים הוא/היא 17721.")
    w = Witness.find(2268)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1601).comments.create!(user_id: 415, content: "בשנה שעברה, 'אוולין המרשלג' (1601) היה/הייתה מצוות/ת למארח/ת עדן נאור (6668). בצד של המארחים הוא/היא 17212.")
    w = Witness.find(1601)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(553).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברכה שרף אלון' (553) היה/הייתה מצוות/ת למארח/ת רוני שריר (8987). בצד של המארחים הוא/היא 20404.")
    w = Witness.find(553)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(162).comments.create!(user_id: 415, content: "בשנה שעברה, 'רינה רוטברג' (162) היה/הייתה מצוות/ת למארח/ת כרמל בן חורין (7864). בצד של המארחים הוא/היא 18570.")
    w = Witness.find(162)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(513).comments.create!(user_id: 415, content: "בשנה שעברה, 'נעמי איזק' (513) היה/הייתה מצוות/ת למארח/ת עדי גרינברג (3451). בצד של המארחים הוא/היא 9354.")
    w = Witness.find(513)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(492).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרדכי מנדלסון' (492) היה/הייתה מצוות/ת למארח/ת דביר בן חיים (8688). בצד של המארחים הוא/היא 19738.")
    w = Witness.find(492)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2071).comments.create!(user_id: 415, content: "בשנה שעברה, 'מקס מדר' (2071) היה/הייתה מצוות/ת למארח/ת שני בונה עמיחי (3904). בצד של המארחים הוא/היא 10000.")
    w = Witness.find(2071)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(524).comments.create!(user_id: 415, content: "בשנה שעברה, 'מלכה סולומון' (524) היה/הייתה מצוות/ת למארח/ת אורטל (5624). בצד של המארחים הוא/היא 12807.")
    w = Witness.find(524)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(494).comments.create!(user_id: 415, content: "בשנה שעברה, 'לריסה ליטבק' (494) היה/הייתה מצוות/ת למארח/ת ליאת מימון (7320). בצד של המארחים הוא/היא 17934.")
    w = Witness.find(494)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(451).comments.create!(user_id: 415, content: "בשנה שעברה, 'דוד מצגר' (451) היה/הייתה מצוות/ת למארח/ת רן בנדר (7147). בצד של המארחים הוא/היא 17732.")
    w = Witness.find(451)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1072).comments.create!(user_id: 415, content: "בשנה שעברה, 'אורנה רוטנברג' (1072) היה/הייתה מצוות/ת למארח/ת חגית שגב (7665). בצד של המארחים הוא/היא 18345.")
    w = Witness.find(1072)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(552).comments.create!(user_id: 415, content: "בשנה שעברה, 'ז'אק קנו' (552) היה/הייתה מצוות/ת למארח/ת נועה יודיצקי (מכינת גל) (8222). בצד של המארחים הוא/היא 19007.")
    w = Witness.find(552)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2088).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה הוכשטיין' (2088) היה/הייתה מצוות/ת למארח/ת חן אברהם (5614). בצד של המארחים הוא/היא 12779.")
    w = Witness.find(2088)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1881).comments.create!(user_id: 415, content: "בשנה שעברה, 'אנה סלעי' (1881) היה/הייתה מצוות/ת למארח/ת גל בן - דור (351). בצד של המארחים הוא/היא 382.")
    w = Witness.find(1881)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(744).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית רותם' (744) היה/הייתה מצוות/ת למארח/ת ניצה לויט (7341). בצד של המארחים הוא/היא 17962.")
    w = Witness.find(744)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(638).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרים סיגלובסקי' (638) היה/הייתה מצוות/ת למארח/ת מאי דגן (7444). בצד של המארחים הוא/היא 18084.")
    w = Witness.find(638)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(548).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברוריה קליין' (548) היה/הייתה מצוות/ת למארח/ת ברק כוכבי (4411). בצד של המארחים הוא/היא 10659.")
    w = Witness.find(548)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1857).comments.create!(user_id: 415, content: "בשנה שעברה, 'ורדה שפייזר' (1857) היה/הייתה מצוות/ת למארח/ת עדיה פרץ (1215). בצד של המארחים הוא/היא 1545.")
    w = Witness.find(1857)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1634).comments.create!(user_id: 415, content: "בשנה שעברה, 'אריה תמיר' (1634) היה/הייתה מצוות/ת למארח/ת חן כהן (7446). בצד של המארחים הוא/היא 18086.")
    w = Witness.find(1634)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(582).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוסף קליימן' (582) היה/הייתה מצוות/ת למארח/ת יובל מלחי (924). בצד של המארחים הוא/היא 999.")
    w = Witness.find(582)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2066).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל הרצל' (2066) היה/הייתה מצוות/ת למארח/ת עמית אפרתי (8627). בצד של המארחים הוא/היא 19625.")
    w = Witness.find(2066)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(597).comments.create!(user_id: 415, content: "בשנה שעברה, 'שלמה אדלר' (597) היה/הייתה מצוות/ת למארח/ת מרכז קיפוד- קרן (6558). בצד של המארחים הוא/היא 17106.")
    w = Witness.find(597)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(208).comments.create!(user_id: 415, content: "בשנה שעברה, 'ראובן דרורי' (208) היה/הייתה מצוות/ת למארח/ת מירב פישר (7836). בצד של המארחים הוא/היא 18536.")
    w = Witness.find(208)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(649).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית שבתאי' (649) היה/הייתה מצוות/ת למארח/ת יעל גלברד (7563). בצד של המארחים הוא/היא 18220.")
    w = Witness.find(649)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1940).comments.create!(user_id: 415, content: "בשנה שעברה, 'יניב פוריה' (1940) היה/הייתה מצוות/ת למארח/ת שיר גלימידי (8463). בצד של המארחים הוא/היא 19386.")
    w = Witness.find(1940)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1315).comments.create!(user_id: 415, content: "בשנה שעברה, 'סילבן ברכפלד' (1315) היה/הייתה מצוות/ת למארח/ת נועה שוויקי בשם השגרירות הבריטית (7193). בצד של המארחים הוא/היא 17784.")
    w = Witness.find(1315)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2224).comments.create!(user_id: 415, content: "בשנה שעברה, 'סימה שמילוביץ' (2224) היה/הייתה מצוות/ת למארח/ת לירון לביא (7966). בצד של המארחים הוא/היא 18693.")
    w = Witness.find(2224)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(988).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית אשריאל' (988) היה/הייתה מצוות/ת למארח/ת מאיה סגל לבקוביץ (7964). בצד של המארחים הוא/היא 18691.")
    w = Witness.find(988)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(842).comments.create!(user_id: 415, content: "בשנה שעברה, 'מיכאל אדם' (842) היה/הייתה מצוות/ת למארח/ת איגור רונין (8489). בצד של המארחים הוא/היא 19418.")
    w = Witness.find(842)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(515).comments.create!(user_id: 415, content: "בשנה שעברה, 'גורקא שאול' (515) היה/הייתה מצוות/ת למארח/ת אלינור פרידמן (8582). בצד של המארחים הוא/היא 19559.")
    w = Witness.find(515)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(468).comments.create!(user_id: 415, content: "בשנה שעברה, 'ד\"ר משה שוורץ' (468) היה/הייתה מצוות/ת למארח/ת חוה ניקחה (207). בצד של המארחים הוא/היא 211.")
    w = Witness.find(468)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(930).comments.create!(user_id: 415, content: "בשנה שעברה, 'אדית זק' (930) היה/הייתה מצוות/ת למארח/ת אלה סנה (5384). בצד של המארחים הוא/היא 12304.")
    w = Witness.find(930)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1174).comments.create!(user_id: 415, content: "בשנה שעברה, 'צבי גיל' (1174) היה/הייתה מצוות/ת למארח/ת עיריית תל אביב יפו - לשכת רון חולדאי (9009). בצד של המארחים הוא/היא 20489.")
    w = Witness.find(1174)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1788).comments.create!(user_id: 415, content: "בשנה שעברה, 'אורית רז' (1788) היה/הייתה מצוות/ת למארח/ת שמי מיה גרין. רוצה לקיים מפגש בחברה בה אני עובדת Stratoscale (6750). בצד של המארחים הוא/היא 17294.")
    w = Witness.find(1788)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(521).comments.create!(user_id: 415, content: "בשנה שעברה, 'איטה אסיף' (521) היה/הייתה מצוות/ת למארח/ת מרסל אפרת כהן (7070). בצד של המארחים הוא/היא 17651.")
    w = Witness.find(521)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(731).comments.create!(user_id: 415, content: "בשנה שעברה, 'רוברט רפאל (רפי)' (731) היה/הייתה מצוות/ת למארח/ת שני אליהו (7185). בצד של המארחים הוא/היא 17775.")
    w = Witness.find(731)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3307).comments.create!(user_id: 415, content: "בשנה שעברה, 'דורית חן' (3307) היה/הייתה מצוות/ת למארח/ת שירה ליבנה (8312). בצד של המארחים הוא/היא 19130.")
    w = Witness.find(3307)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(290).comments.create!(user_id: 415, content: "בשנה שעברה, 'ציפי אוריאל' (290) היה/הייתה מצוות/ת למארח/ת לירון אדוק (7894). בצד של המארחים הוא/היא 18607.")
    w = Witness.find(290)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(602).comments.create!(user_id: 415, content: "בשנה שעברה, 'מנחם טאוב' (602) היה/הייתה מצוות/ת למארח/ת לימור קורנגוט (8551). בצד של המארחים הוא/היא 19518.")
    w = Witness.find(602)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3308).comments.create!(user_id: 415, content: "בשנה שעברה, 'שלמה פרנקל' (3308) היה/הייתה מצוות/ת למארח/ת הדר (8529). בצד של המארחים הוא/היא 6637.")
    w = Witness.find(3308)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2363).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמחה יוקלה' (2363) היה/הייתה מצוות/ת למארח/ת מירב עוזרי (8397). בצד של המארחים הוא/היא 19250.")
    w = Witness.find(2363)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2365).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוסי בוייר' (2365) היה/הייתה מצוות/ת למארח/ת אדל בוסביב (7090). בצד של המארחים הוא/היא 17672.")
    w = Witness.find(2365)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2391).comments.create!(user_id: 415, content: "בשנה שעברה, 'חוה לוסטיג' (2391) היה/הייתה מצוות/ת למארח/ת חנה ילוז (7707). בצד של המארחים הוא/היא 18395.")
    w = Witness.find(2391)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1170).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלי מנדל' (1170) היה/הייתה מצוות/ת למארח/ת הילה פרידמן (6281). בצד של המארחים הוא/היא 15978.")
    w = Witness.find(1170)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2700).comments.create!(user_id: 415, content: "בשנה שעברה, 'אילנה דרוקר' (2700) היה/הייתה מצוות/ת למארח/ת קמי ברמלי (6529). בצד של המארחים הוא/היא 17076.")
    w = Witness.find(2700)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2379).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלי קינדלר' (2379) היה/הייתה מצוות/ת למארח/ת אורלי אדלרסברג (7338). בצד של המארחים הוא/היא 17959.")
    w = Witness.find(2379)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2361).comments.create!(user_id: 415, content: "בשנה שעברה, 'פרנקל יחיאל' (2361) היה/הייתה מצוות/ת למארח/ת מכינת אדרת (6857). בצד של המארחים הוא/היא 17413.")
    w = Witness.find(2361)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2362).comments.create!(user_id: 415, content: "בשנה שעברה, 'מישי שטרנברג' (2362) היה/הייתה מצוות/ת למארח/ת זיו אייזנברג (6497). בצד של המארחים הוא/היא 17047.")
    w = Witness.find(2362)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1358).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה שוורץ' (1358) היה/הייתה מצוות/ת למארח/ת מתנאל (7278). בצד של המארחים הוא/היא 17885.")
    w = Witness.find(1358)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2393).comments.create!(user_id: 415, content: "בשנה שעברה, 'נחום פנחס ויורלנה' (2393) היה/הייתה מצוות/ת למארח/ת רותם שוקרון (5638). בצד של המארחים הוא/היא 12838.")
    w = Witness.find(2393)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2376).comments.create!(user_id: 415, content: "בשנה שעברה, 'יעקב פיליפסון ערמון' (2376) היה/הייתה מצוות/ת למארח/ת לירון קקו\"ן (6221). בצד של המארחים הוא/היא 15443.")
    w = Witness.find(2376)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2364).comments.create!(user_id: 415, content: "בשנה שעברה, 'דוד הרשקוביץ' (2364) היה/הייתה מצוות/ת למארח/ת תמר קוזר (9464). בצד של המארחים הוא/היא 6122.")
    w = Witness.find(2364)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2384).comments.create!(user_id: 415, content: "בשנה שעברה, 'יואל קפלן' (2384) היה/הייתה מצוות/ת למארח/ת מרכז קהילתי פלורנטין (4136). בצד של המארחים הוא/היא 10307.")
    w = Witness.find(2384)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2582).comments.create!(user_id: 415, content: "בשנה שעברה, 'אדוארד יאנקובסקי' (2582) היה/הייתה מצוות/ת למארח/ת ענבר ארז (7886). בצד של המארחים הוא/היא 18597.")
    w = Witness.find(2582)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2534).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרים רוזנר' (2534) היה/הייתה מצוות/ת למארח/ת רינה אילסר (7838). בצד של המארחים הוא/היא 18538.")
    w = Witness.find(2534)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2174).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרדכי פפירבלט' (2174) היה/הייתה מצוות/ת למארח/ת ירדן שכטר (7029). בצד של המארחים הוא/היא 17601.")
    w = Witness.find(2174)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2691).comments.create!(user_id: 415, content: "בשנה שעברה, 'מצא צדוק' (2691) היה/הייתה מצוות/ת למארח/ת מזל גלב (6508). בצד של המארחים הוא/היא 17057.")
    w = Witness.find(2691)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2292).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרים זילברשטיין' (2292) היה/הייתה מצוות/ת למארח/ת מור אלקיים שפלר (6594). בצד של המארחים הוא/היא 17139.")
    w = Witness.find(2292)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2649).comments.create!(user_id: 415, content: "בשנה שעברה, 'מינה לשסקו' (2649) היה/הייתה מצוות/ת למארח/ת אהרון בר (6547). בצד של המארחים הוא/היא 17096.")
    w = Witness.find(2649)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2686).comments.create!(user_id: 415, content: "בשנה שעברה, 'מיכל ארץ' (2686) היה/הייתה מצוות/ת למארח/ת עדי יוגב אלצפון (5905). בצד של המארחים הוא/היא 13571.")
    w = Witness.find(2686)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2318).comments.create!(user_id: 415, content: "בשנה שעברה, 'מירית גרד' (2318) היה/הייתה מצוות/ת למארח/ת דורית כנפי (7201). בצד של המארחים הוא/היא 17793.")
    w = Witness.find(2318)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(519).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודה בייליס' (519) היה/הייתה מצוות/ת למארח/ת עדן בורג (9138). בצד של המארחים הוא/היא 20863.")
    w = Witness.find(519)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(235).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה פלדמן' (235) היה/הייתה מצוות/ת למארח/ת איילת רומם פלד (9552). בצד של המארחים הוא/היא 22601.")
    w = Witness.find(235)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2690).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה הראל' (2690) היה/הייתה מצוות/ת למארח/ת נטע עדני (8758). בצד של המארחים הוא/היא 19869.")
    w = Witness.find(2690)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(367).comments.create!(user_id: 415, content: "בשנה שעברה, 'איילת גרוס גפן' (367) היה/הייתה מצוות/ת למארח/ת שרי ליפל (8100). בצד של המארחים הוא/היא 18845.")
    w = Witness.find(367)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2687).comments.create!(user_id: 415, content: "בשנה שעברה, 'דודי רונן' (2687) היה/הייתה מצוות/ת למארח/ת פז בר שלום (7703). בצד של המארחים הוא/היא 18389.")
    w = Witness.find(2687)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2045).comments.create!(user_id: 415, content: "בשנה שעברה, 'יפה זהבי' (2045) היה/הייתה מצוות/ת למארח/ת יונתן בן חיים (1475). בצד של המארחים הוא/היא 2084.")
    w = Witness.find(2045)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1546).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל ארליך' (1546) היה/הייתה מצוות/ת למארח/ת נעמה עמיר (3950). בצד של המארחים הוא/היא 10080.")
    w = Witness.find(1546)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2912).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוסי והדסה ריטר' (2912) היה/הייתה מצוות/ת למארח/ת מרכז יה\"ל ראשל\"צ (6820). בצד של המארחים הוא/היא 17375.")
    w = Witness.find(2912)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2698).comments.create!(user_id: 415, content: "בשנה שעברה, 'יצחק שחר' (2698) היה/הייתה מצוות/ת למארח/ת קורין נמר (8820). בצד של המארחים הוא/היא 14343.")
    w = Witness.find(2698)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(942).comments.create!(user_id: 415, content: "בשנה שעברה, 'יותם זיו' (942) היה/הייתה מצוות/ת למארח/ת מרכז קהילתי צהלה (7696). בצד של המארחים הוא/היא 18379.")
    w = Witness.find(942)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(172).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה ועודד מיוחס' (172) היה/הייתה מצוות/ת למארח/ת אלחנן יוסף (9550). בצד של המארחים הוא/היא 22593.")
    w = Witness.find(172)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2515).comments.create!(user_id: 415, content: "בשנה שעברה, 'צחי דרורי' (2515) היה/הייתה מצוות/ת למארח/ת תמר גבע (6978). בצד של המארחים הוא/היא 17545.")
    w = Witness.find(2515)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2695).comments.create!(user_id: 415, content: "בשנה שעברה, 'נטלי פישלר' (2695) היה/הייתה מצוות/ת למארח/ת ערבה אשד חיים (7845). בצד של המארחים הוא/היא 18547.")
    w = Witness.find(2695)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(617).comments.create!(user_id: 415, content: "בשנה שעברה, 'אבי אל בחרי' (617) היה/הייתה מצוות/ת למארח/ת גלי בר נר (7920). בצד של המארחים הוא/היא 18635.")
    w = Witness.find(617)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2435).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברוך הולנדר' (2435) היה/הייתה מצוות/ת למארח/ת תמר מילוא (7267). בצד של המארחים הוא/היא 17871.")
    w = Witness.find(2435)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2699).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה ארנון' (2699) היה/הייתה מצוות/ת למארח/ת נאוה פירר (6812). בצד של המארחים הוא/היא 17362.")
    w = Witness.find(2699)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3078).comments.create!(user_id: 415, content: "בשנה שעברה, 'דניאל פורסט' (3078) היה/הייתה מצוות/ת למארח/ת אורית אידי לבאן (8232). בצד של המארחים הוא/היא 19017.")
    w = Witness.find(3078)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2368).comments.create!(user_id: 415, content: "בשנה שעברה, 'בתיה שפירא' (2368) היה/הייתה מצוות/ת למארח/ת יהודית שטרן (6710). בצד של המארחים הוא/היא 17253.")
    w = Witness.find(2368)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2016).comments.create!(user_id: 415, content: "בשנה שעברה, 'אנדריי שמעוני' (2016) היה/הייתה מצוות/ת למארח/ת מעיין גודאט (5289). בצד של המארחים הוא/היא 12129.")
    w = Witness.find(2016)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(143).comments.create!(user_id: 415, content: "בשנה שעברה, 'ישראל חרג' (143) היה/הייתה מצוות/ת למארח/ת חן נדל בני עקיבא רמת עמידר (7257). בצד של המארחים הוא/היא 17858.")
    w = Witness.find(143)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2609).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית דרורי' (2609) היה/הייתה מצוות/ת למארח/ת חוליאן קסנוביץ (6536). בצד של המארחים הוא/היא 17081.")
    w = Witness.find(2609)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2517).comments.create!(user_id: 415, content: "בשנה שעברה, 'ציפי שורני' (2517) היה/הייתה מצוות/ת למארח/ת ‫יהודית לוזון‬‎ (7123). בצד של המארחים הוא/היא 17706.")
    w = Witness.find(2517)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2271).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוסף פלייסהואור' (2271) היה/הייתה מצוות/ת למארח/ת oneday ירושלים (7462). בצד של המארחים הוא/היא 18103.")
    w = Witness.find(2271)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1564).comments.create!(user_id: 415, content: "בשנה שעברה, 'הדס ויסמן' (1564) היה/הייתה מצוות/ת למארח/ת נאוה סבר (7738). בצד של המארחים הוא/היא 18430.")
    w = Witness.find(1564)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2113).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתר  וייס אור' (2113) היה/הייתה מצוות/ת למארח/ת אורית אוליאל (7853). בצד של המארחים הוא/היא 18557.")
    w = Witness.find(2113)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1931).comments.create!(user_id: 415, content: "בשנה שעברה, 'כרמלה יגב' (1931) היה/הייתה מצוות/ת למארח/ת אביב לוין (6813). בצד של המארחים הוא/היא 17363.")
    w = Witness.find(1931)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2701).comments.create!(user_id: 415, content: "בשנה שעברה, 'לאה יניב' (2701) היה/הייתה מצוות/ת למארח/ת עמית וסר (6759). בצד של המארחים הוא/היא 17303.")
    w = Witness.find(2701)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2132).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסי ניסלסון' (2132) היה/הייתה מצוות/ת למארח/ת רחלי הניג (6862). בצד של המארחים הוא/היא 17418.")
    w = Witness.find(2132)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1953).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיים זליג' (1953) היה/הייתה מצוות/ת למארח/ת בנימין אלבוים (7848). בצד של המארחים הוא/היא 18551.")
    w = Witness.find(1953)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(730).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה עמנואל הורוביץ' (730) היה/הייתה מצוות/ת למארח/ת תהל מלכה (8002). בצד של המארחים הוא/היא 18736.")
    w = Witness.find(730)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2702).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרצל אברבמוביץ' (2702) היה/הייתה מצוות/ת למארח/ת ענת כהן (8032). בצד של המארחים הוא/היא 18764.")
    w = Witness.find(2702)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2359).comments.create!(user_id: 415, content: "בשנה שעברה, 'ידידיה ברדה' (2359) היה/הייתה מצוות/ת למארח/ת יואב גרויסמן (1601). בצד של המארחים הוא/היא 2344.")
    w = Witness.find(2359)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(918).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל גליקמן' (918) היה/הייתה מצוות/ת למארח/ת אליה דנינו (917). בצד של המארחים הוא/היא 990.")
    w = Witness.find(918)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(981).comments.create!(user_id: 415, content: "בשנה שעברה, 'אילנה פורמן' (981) היה/הייתה מצוות/ת למארח/ת זיו דבורה (6140). בצד של המארחים הוא/היא 14634.")
    w = Witness.find(981)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2684).comments.create!(user_id: 415, content: "בשנה שעברה, 'פנינה אליהו' (2684) היה/הייתה מצוות/ת למארח/ת אושרת יצחק (8121). בצד של המארחים הוא/היא 18866.")
    w = Witness.find(2684)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2685).comments.create!(user_id: 415, content: "בשנה שעברה, 'מיכל מלכובסקי' (2685) היה/הייתה מצוות/ת למארח/ת טל אזולאי (6474). בצד של המארחים הוא/היא 17026.")
    w = Witness.find(2685)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2706).comments.create!(user_id: 415, content: "בשנה שעברה, 'רגינה בייגל' (2706) היה/הייתה מצוות/ת למארח/ת מרכז צעירים נהריה (7300). בצד של המארחים הוא/היא 17912.")
    w = Witness.find(2706)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(511).comments.create!(user_id: 415, content: "בשנה שעברה, 'רות גורדון' (511) היה/הייתה מצוות/ת למארח/ת רעות ושדי (9020). בצד של המארחים הוא/היא 20525.")
    w = Witness.find(511)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2696).comments.create!(user_id: 415, content: "בשנה שעברה, 'טובה פרלמוטר (ד\"ר)' (2696) היה/הייתה מצוות/ת למארח/ת אופק סלמה (3802). בצד של המארחים הוא/היא 9876.")
    w = Witness.find(2696)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3316).comments.create!(user_id: 415, content: "בשנה שעברה, 'נסיון נסיון' (3316) היה/הייתה מצוות/ת למארח/ת גאיה גבעון (91). בצד של המארחים הוא/היא 95.")
    w = Witness.find(3316)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2347).comments.create!(user_id: 415, content: "בשנה שעברה, 'זינה פרידלנד' (2347) היה/הייתה מצוות/ת למארח/ת לאה אספיס (7249). בצד של המארחים הוא/היא 17846.")
    w = Witness.find(2347)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(939).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל קולנדר' (939) היה/הייתה מצוות/ת למארח/ת רווית שמאי גל (24). בצד של המארחים הוא/היא 26.")
    w = Witness.find(939)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2688).comments.create!(user_id: 415, content: "בשנה שעברה, 'ארצית בר-נר' (2688) היה/הייתה מצוות/ת למארח/ת לירום הולינגר (4577). בצד של המארחים הוא/היא 10887.")
    w = Witness.find(2688)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(963).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודה באואר (פרופ')' (963) היה/הייתה מצוות/ת למארח/ת נועה האוזר (7658). בצד של המארחים הוא/היא 18336.")
    w = Witness.find(963)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(907).comments.create!(user_id: 415, content: "בשנה שעברה, 'אברהם אשכנזי' (907) היה/הייתה מצוות/ת למארח/ת רעות אללוף (741). בצד של המארחים הוא/היא 794.")
    w = Witness.find(907)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1949).comments.create!(user_id: 415, content: "בשנה שעברה, 'פנינה רוזנברג (ד\"ר)' (1949) היה/הייתה מצוות/ת למארח/ת עדי מור (8019). בצד של המארחים הוא/היא 18753.")
    w = Witness.find(1949)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(595).comments.create!(user_id: 415, content: "בשנה שעברה, 'פאפו עזרא וטובה' (595) היה/הייתה מצוות/ת למארח/ת יעל נביפור (6520). בצד של המארחים הוא/היא 17068.")
    w = Witness.find(595)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2019).comments.create!(user_id: 415, content: "בשנה שעברה, 'עודד היילברונר (פרופ')' (2019) היה/הייתה מצוות/ת למארח/ת פאולוס (9785). בצד של המארחים הוא/היא 24230.")
    w = Witness.find(2019)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2708).comments.create!(user_id: 415, content: "בשנה שעברה, 'נועה כהן-אורלוב' (2708) היה/הייתה מצוות/ת למארח/ת הצופים (8802). בצד של המארחים הוא/היא 19968.")
    w = Witness.find(2708)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1752).comments.create!(user_id: 415, content: "בשנה שעברה, 'ליאור מאיק' (1752) היה/הייתה מצוות/ת למארח/ת יעל (7875). בצד של המארחים הוא/היא 18582.")
    w = Witness.find(1752)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3109).comments.create!(user_id: 415, content: "בשנה שעברה, 'אריה רבינוביץ' (3109) היה/הייתה מצוות/ת למארח/ת מיה (7025). בצד של המארחים הוא/היא 17596.")
    w = Witness.find(3109)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1959).comments.create!(user_id: 415, content: "בשנה שעברה, 'מיכאל אברהם (הרב)' (1959) היה/הייתה מצוות/ת למארח/ת בת אל ונאור פיס (9344). בצד של המארחים הוא/היא 21617.")
    w = Witness.find(1959)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(937).comments.create!(user_id: 415, content: "בשנה שעברה, 'עידית גיל' (937) היה/הייתה מצוות/ת למארח/ת בית קוסאר (8236). בצד של המארחים הוא/היא 19021.")
    w = Witness.find(937)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(37).comments.create!(user_id: 415, content: "בשנה שעברה, 'שוש טריסטר' (37) היה/הייתה מצוות/ת למארח/ת גיל עומר (7583). בצד של המארחים הוא/היא 18246.")
    w = Witness.find(37)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1777).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוסף בריח' (1777) היה/הייתה מצוות/ת למארח/ת יובל סרור (6946). בצד של המארחים הוא/היא 17511.")
    w = Witness.find(1777)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1925).comments.create!(user_id: 415, content: "בשנה שעברה, 'בלה גוטרמן' (1925) היה/הייתה מצוות/ת למארח/ת אורית לנט (9603). בצד של המארחים הוא/היא 22855.")
    w = Witness.find(1925)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1136).comments.create!(user_id: 415, content: "בשנה שעברה, 'ליאור פורמן' (1136) היה/הייתה מצוות/ת למארח/ת נעמה דרור (3290). בצד של המארחים הוא/היא 9171.")
    w = Witness.find(1136)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1204).comments.create!(user_id: 415, content: "בשנה שעברה, 'אריה וייף' (1204) היה/הייתה מצוות/ת למארח/ת אורן גולן (7351). בצד של המארחים הוא/היא 17973.")
    w = Witness.find(1204)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3303).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה פלמאי' (3303) היה/הייתה מצוות/ת למארח/ת נעמה שמש הלוי (9874). בצד של המארחים הוא/היא 25190.")
    w = Witness.find(3303)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(391).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתר וזאב הרסט' (391) היה/הייתה מצוות/ת למארח/ת אוהד מושלי (9007). בצד של המארחים הוא/היא 20481.")
    w = Witness.find(391)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(410).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרדכי רייזמנן' (410) היה/הייתה מצוות/ת למארח/ת שירה ציפריס (1327). בצד של המארחים הוא/היא 1788.")
    w = Witness.find(410)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1998).comments.create!(user_id: 415, content: "בשנה שעברה, 'מיכל גלטר' (1998) היה/הייתה מצוות/ת למארח/ת גיל אוזן (8496). בצד של המארחים הוא/היא 19425.")
    w = Witness.find(1998)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2871).comments.create!(user_id: 415, content: "בשנה שעברה, 'תלמה מאסטרו' (2871) היה/הייתה מצוות/ת למארח/ת קרוננבלום תהילה ושי (8950). בצד של המארחים הוא/היא 20309.")
    w = Witness.find(2871)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2772).comments.create!(user_id: 415, content: "בשנה שעברה, 'פרץ לב' (2772) היה/הייתה מצוות/ת למארח/ת רותם מלאכי (4759). בצד של המארחים הוא/היא 11122.")
    w = Witness.find(2772)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(409).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוליה גרו' (409) היה/הייתה מצוות/ת למארח/ת רות משאט (1686). בצד של המארחים הוא/היא 2571.")
    w = Witness.find(409)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1497).comments.create!(user_id: 415, content: "בשנה שעברה, 'טובה שפיגלמן' (1497) היה/הייתה מצוות/ת למארח/ת פלג מגן (7413). בצד של המארחים הוא/היא 18050.")
    w = Witness.find(1497)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1767).comments.create!(user_id: 415, content: "בשנה שעברה, 'אביבה פורת' (1767) היה/הייתה מצוות/ת למארח/ת מיתר תבל (5471). בצד של המארחים הוא/היא 12446.")
    w = Witness.find(1767)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2874).comments.create!(user_id: 415, content: "בשנה שעברה, 'תומי עמית' (2874) היה/הייתה מצוות/ת למארח/ת איתי חזן (7093). בצד של המארחים הוא/היא 17676.")
    w = Witness.find(2874)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(783).comments.create!(user_id: 415, content: "בשנה שעברה, 'מאיר יוזף' (783) היה/הייתה מצוות/ת למארח/ת מירלה גל (263). בצד של המארחים הוא/היא 284.")
    w = Witness.find(783)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2763).comments.create!(user_id: 415, content: "בשנה שעברה, 'בראונשטיין אידה' (2763) היה/הייתה מצוות/ת למארח/ת עומרי שמואלי (3147). בצד של המארחים הוא/היא 9030.")
    w = Witness.find(2763)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(660).comments.create!(user_id: 415, content: "בשנה שעברה, 'פנינה פרוכטר' (660) היה/הייתה מצוות/ת למארח/ת נעמה משולם (728). בצד של המארחים הוא/היא 781.")
    w = Witness.find(660)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2873).comments.create!(user_id: 415, content: "בשנה שעברה, 'פרנק גיורא' (2873) היה/הייתה מצוות/ת למארח/ת אבישג בצר (8362). בצד של המארחים הוא/היא 19190.")
    w = Witness.find(2873)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(517).comments.create!(user_id: 415, content: "בשנה שעברה, 'גליה גביש' (517) היה/הייתה מצוות/ת למארח/ת קרן ברוק (8664). בצד של המארחים הוא/היא 19703.")
    w = Witness.find(517)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1496).comments.create!(user_id: 415, content: "בשנה שעברה, 'שושנה שדמי' (1496) היה/הייתה מצוות/ת למארח/ת הדס שטנגר (6517). בצד של המארחים הוא/היא 17065.")
    w = Witness.find(1496)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(774).comments.create!(user_id: 415, content: "בשנה שעברה, 'חווה וולפשנייצר' (774) היה/הייתה מצוות/ת למארח/ת גיל בן נון (6810). בצד של המארחים הוא/היא 17360.")
    w = Witness.find(774)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2765).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברודרמן מרים' (2765) היה/הייתה מצוות/ת למארח/ת גור ורקפת לביא (2889). בצד של המארחים הוא/היא 8764.")
    w = Witness.find(2765)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2799).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית פרידמן' (2799) היה/הייתה מצוות/ת למארח/ת אפרת (6816). בצד של המארחים הוא/היא 17366.")
    w = Witness.find(2799)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1247).comments.create!(user_id: 415, content: "בשנה שעברה, 'גדעון אקהאוז' (1247) היה/הייתה מצוות/ת למארח/ת Denise Feiger (2598). בצד של המארחים הוא/היא 5872.")
    w = Witness.find(1247)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(385).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל קולברסקי' (385) היה/הייתה מצוות/ת למארח/ת עומר זרחיה (3331). בצד של המארחים הוא/היא 9212.")
    w = Witness.find(385)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2855).comments.create!(user_id: 415, content: "בשנה שעברה, 'מוטי שפיר' (2855) היה/הייתה מצוות/ת למארח/ת אילנית ארבל (7983). בצד של המארחים הוא/היא 18715.")
    w = Witness.find(2855)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(781).comments.create!(user_id: 415, content: "בשנה שעברה, 'מיכל שבות' (781) היה/הייתה מצוות/ת למארח/ת שני ארן (3833). בצד של המארחים הוא/היא 9911.")
    w = Witness.find(781)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(671).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה גופרית' (671) היה/הייתה מצוות/ת למארח/ת מזא\"ה 9 (377). בצד של המארחים הוא/היא 409.")
    w = Witness.find(671)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(685).comments.create!(user_id: 415, content: "בשנה שעברה, 'ג'קוב קורץ' (685) היה/הייתה מצוות/ת למארח/ת אורי מנדי (8164). בצד של המארחים הוא/היא 18935.")
    w = Witness.find(685)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(18).comments.create!(user_id: 415, content: "בשנה שעברה, 'הלן שגב' (18) היה/הייתה מצוות/ת למארח/ת רן לוי (3445). בצד של המארחים הוא/היא 9348.")
    w = Witness.find(18)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1138).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרגלית שרון' (1138) היה/הייתה מצוות/ת למארח/ת קמילה שרלין (3818). בצד של המארחים הוא/היא 9895.")
    w = Witness.find(1138)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1412).comments.create!(user_id: 415, content: "בשנה שעברה, 'מיכל בר' (1412) היה/הייתה מצוות/ת למארח/ת ערן שחורי (3366). בצד של המארחים הוא/היא 9249.")
    w = Witness.find(1412)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3239).comments.create!(user_id: 415, content: "בשנה שעברה, 'אברהם וודוב' (3239) היה/הייתה מצוות/ת למארח/ת שקד קליין (7526). בצד של המארחים הוא/היא 18178.")
    w = Witness.find(3239)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(215).comments.create!(user_id: 415, content: "בשנה שעברה, 'בלהה לוטן' (215) היה/הייתה מצוות/ת למארח/ת גליה בן שושן (7427). בצד של המארחים הוא/היא 18064.")
    w = Witness.find(215)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1578).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיים מגירה' (1578) היה/הייתה מצוות/ת למארח/ת תמר לאופר (9656). בצד של המארחים הוא/היא 23186.")
    w = Witness.find(1578)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2820).comments.create!(user_id: 415, content: "בשנה שעברה, 'הרב אברהם אנגל' (2820) היה/הייתה מצוות/ת למארח/ת ניר קבלו (8384). בצד של המארחים הוא/היא 19224.")
    w = Witness.find(2820)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(539).comments.create!(user_id: 415, content: "בשנה שעברה, 'דוד כהן ושרה כהן' (539) היה/הייתה מצוות/ת למארח/ת אופק טל (7498). בצד של המארחים הוא/היא 18147.")
    w = Witness.find(539)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2730).comments.create!(user_id: 415, content: "בשנה שעברה, 'ציפי מורבאי' (2730) היה/הייתה מצוות/ת למארח/ת שמעון גל (6691). בצד של המארחים הוא/היא 17234.")
    w = Witness.find(2730)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(377).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברוך קופולד' (377) היה/הייתה מצוות/ת למארח/ת עמית מובס (6639). בצד של המארחים הוא/היא 17184.")
    w = Witness.find(377)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1033).comments.create!(user_id: 415, content: "בשנה שעברה, 'ד\"ר שמוליק לדרמן' (1033) היה/הייתה מצוות/ת למארח/ת לינוי נגר (7905). בצד של המארחים הוא/היא 18619.")
    w = Witness.find(1033)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1663).comments.create!(user_id: 415, content: "בשנה שעברה, 'אהרון וייסמן' (1663) היה/הייתה מצוות/ת למארח/ת גל ריגר כהן (6955). בצד של המארחים הוא/היא 17521.")
    w = Witness.find(1663)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(567).comments.create!(user_id: 415, content: "בשנה שעברה, 'אמיל פרקש' (567) היה/הייתה מצוות/ת למארח/ת אור אמיתי (7244). בצד של המארחים הוא/היא 17840.")
    w = Witness.find(567)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2681).comments.create!(user_id: 415, content: "בשנה שעברה, 'ישראל בן דורי' (2681) היה/הייתה מצוות/ת למארח/ת מירה פרץ (4798). בצד של המארחים הוא/היא 11191.")
    w = Witness.find(2681)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1818).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיים גני' (1818) היה/הייתה מצוות/ת למארח/ת Nufar Margalit (7645). בצד של המארחים הוא/היא 18323.")
    w = Witness.find(1818)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(516).comments.create!(user_id: 415, content: "בשנה שעברה, 'ראובן פולצ'יק' (516) היה/הייתה מצוות/ת למארח/ת הדר פרנקל (7961). בצד של המארחים הוא/היא 18688.")
    w = Witness.find(516)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(150).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה מזוז' (150) היה/הייתה מצוות/ת למארח/ת תום פרידמן (7234). בצד של המארחים הוא/היא 7370.")
    w = Witness.find(150)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(761).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל גורסקי' (761) היה/הייתה מצוות/ת למארח/ת נטע יסוד (3278). בצד של המארחים הוא/היא 9160.")
    w = Witness.find(761)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2713).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיה אורן' (2713) היה/הייתה מצוות/ת למארח/ת ניתאי שיין (7955). בצד של המארחים הוא/היא 18680.")
    w = Witness.find(2713)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1823).comments.create!(user_id: 415, content: "בשנה שעברה, 'מיקה וצלר' (1823) היה/הייתה מצוות/ת למארח/ת אופיר לוז דקל (9203). בצד של המארחים הוא/היא 21138.")
    w = Witness.find(1823)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1618).comments.create!(user_id: 415, content: "בשנה שעברה, 'דוד אריאל' (1618) היה/הייתה מצוות/ת למארח/ת רוני ספאחי (7507). בצד של המארחים הוא/היא 18159.")
    w = Witness.find(1618)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1851).comments.create!(user_id: 415, content: "בשנה שעברה, 'דב רוזן' (1851) היה/הייתה מצוות/ת למארח/ת שרית מזן הררי (6701). בצד של המארחים הוא/היא 17244.")
    w = Witness.find(1851)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1817).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלה פריד' (1817) היה/הייתה מצוות/ת למארח/ת מירב צור ברוך (7071). בצד של המארחים הוא/היא 17652.")
    w = Witness.find(1817)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2653).comments.create!(user_id: 415, content: "בשנה שעברה, 'מלכיאל (מיקי) ויהודית יונש' (2653) היה/הייתה מצוות/ת למארח/ת דניאל ליכטשיין (6544). בצד של המארחים הוא/היא 17093.")
    w = Witness.find(2653)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(905).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרגא קלוש' (905) היה/הייתה מצוות/ת למארח/ת עדי שחם (6817). בצד של המארחים הוא/היא 17367.")
    w = Witness.find(905)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2133).comments.create!(user_id: 415, content: "בשנה שעברה, 'שולמית אברדם' (2133) היה/הייתה מצוות/ת למארח/ת נורית קנטרוביץ' (7740). בצד של המארחים הוא/היא 18432.")
    w = Witness.find(2133)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(674).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלי בר דוד' (674) היה/הייתה מצוות/ת למארח/ת שיר צרפתי (7166). בצד של המארחים הוא/היא 17756.")
    w = Witness.find(674)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(404).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה גליקמן' (404) היה/הייתה מצוות/ת למארח/ת רז בולקובשטיין (8903). בצד של המארחים הוא/היא 20197.")
    w = Witness.find(404)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2621).comments.create!(user_id: 415, content: "בשנה שעברה, 'רינה בירנהק' (2621) היה/הייתה מצוות/ת למארח/ת שני חביב (3511). בצד של המארחים הוא/היא 9428.")
    w = Witness.find(2621)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2782).comments.create!(user_id: 415, content: "בשנה שעברה, 'שושנה בוטווין' (2782) היה/הייתה מצוות/ת למארח/ת עיריית תל אביב יפו - בניין העירייה 3 (9013). בצד של המארחים הוא/היא 20495.")
    w = Witness.find(2782)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2960).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרצל גולדמן' (2960) היה/הייתה מצוות/ת למארח/ת אמילי (7827). בצד של המארחים הוא/היא 18526.")
    w = Witness.find(2960)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(227).comments.create!(user_id: 415, content: "בשנה שעברה, 'אליזבט בונצל' (227) היה/הייתה מצוות/ת למארח/ת רשת בתי הנוער קדימה (2932). בצד של המארחים הוא/היא 8819.")
    w = Witness.find(227)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2939).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתי לנגזם' (2939) היה/הייתה מצוות/ת למארח/ת ולרי שפע (7882). בצד של המארחים הוא/היא 18593.")
    w = Witness.find(2939)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3000).comments.create!(user_id: 415, content: "בשנה שעברה, 'אידלמן אהרון' (3000) היה/הייתה מצוות/ת למארח/ת גלית גולדנברג (9168). בצד של המארחים הוא/היא 20999.")
    w = Witness.find(3000)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2726).comments.create!(user_id: 415, content: "בשנה שעברה, 'לימור מזן' (2726) היה/הייתה מצוות/ת למארח/ת שלהבת אסולין (8109). בצד של המארחים הוא/היא 18851.")
    w = Witness.find(2726)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2494).comments.create!(user_id: 415, content: "בשנה שעברה, 'גילה טולקובסקי' (2494) היה/הייתה מצוות/ת למארח/ת סתיו יוסטר (7191). בצד של המארחים הוא/היא 17781.")
    w = Witness.find(2494)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2958).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרגא אניס' (2958) היה/הייתה מצוות/ת למארח/ת עדי קובריגרו (8252). בצד של המארחים הוא/היא 19039.")
    w = Witness.find(2958)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3038).comments.create!(user_id: 415, content: "בשנה שעברה, 'זאב רטנר' (3038) היה/הייתה מצוות/ת למארח/ת אניה זיסקינה (1978). בצד של המארחים הוא/היא 3408.")
    w = Witness.find(3038)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2905).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה בן צבי' (2905) היה/הייתה מצוות/ת למארח/ת הילה סלומון (7904). בצד של המארחים הוא/היא 18618.")
    w = Witness.find(2905)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2737).comments.create!(user_id: 415, content: "בשנה שעברה, 'כתריאל פוקס' (2737) היה/הייתה מצוות/ת למארח/ת מאיה ישראל (4250). בצד של המארחים הוא/היא 5810.")
    w = Witness.find(2737)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2738).comments.create!(user_id: 415, content: "בשנה שעברה, 'יצחק אלנר' (2738) היה/הייתה מצוות/ת למארח/ת נאוה ברלב (8803). בצד של המארחים הוא/היא 19969.")
    w = Witness.find(2738)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2736).comments.create!(user_id: 415, content: "בשנה שעברה, 'סבטלנה אוצ'יטל' (2736) היה/הייתה מצוות/ת למארח/ת זכור וכבד -חיפה (282). בצד של המארחים הוא/היא 307.")
    w = Witness.find(2736)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2732).comments.create!(user_id: 415, content: "בשנה שעברה, 'עירית דנציגר' (2732) היה/הייתה מצוות/ת למארח/ת שני הלוי (7119). בצד של המארחים הוא/היא 17702.")
    w = Witness.find(2732)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2739).comments.create!(user_id: 415, content: "בשנה שעברה, 'כרמלה דינר' (2739) היה/הייתה מצוות/ת למארח/ת עדן שילוח (4580). בצד של המארחים הוא/היא 10890.")
    w = Witness.find(2739)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2733).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה אבני' (2733) היה/הייתה מצוות/ת למארח/ת נתן בלנק (8960). בצד של המארחים הוא/היא 20330.")
    w = Witness.find(2733)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(176).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרים פרגר' (176) היה/הייתה מצוות/ת למארח/ת חברת לייב יו (7076). בצד של המארחים הוא/היא 17658.")
    w = Witness.find(176)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1017).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוכבד זיו' (1017) היה/הייתה מצוות/ת למארח/ת מירב שעיבי (9573). בצד של המארחים הוא/היא 22736.")
    w = Witness.find(1017)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(165).comments.create!(user_id: 415, content: "בשנה שעברה, 'רונית בריגה' (165) היה/הייתה מצוות/ת למארח/ת פנימיית עלומים כפר סבא (7212). בצד של המארחים הוא/היא 17809.")
    w = Witness.find(165)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2252).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוכי פאר' (2252) היה/הייתה מצוות/ת למארח/ת רותם חומסקי (7113). בצד של המארחים הוא/היא 17696.")
    w = Witness.find(2252)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2265).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה אברוצקי' (2265) היה/הייתה מצוות/ת למארח/ת חנה ארקין (576). בצד של המארחים הוא/היא 625.")
    w = Witness.find(2265)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2742).comments.create!(user_id: 415, content: "בשנה שעברה, 'רנה גיל' (2742) היה/הייתה מצוות/ת למארח/ת קובי נחמיאס (8120). בצד של המארחים הוא/היא 18865.")
    w = Witness.find(2742)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1361).comments.create!(user_id: 415, content: "בשנה שעברה, 'שושנה כלדי' (1361) היה/הייתה מצוות/ת למארח/ת נגה אהרון (5293). בצד של המארחים הוא/היא 12137.")
    w = Witness.find(1361)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2592).comments.create!(user_id: 415, content: "בשנה שעברה, 'אריאל (הרב אריאל) סולומון' (2592) היה/הייתה מצוות/ת למארח/ת מאיה נרדי (8780). בצד של המארחים הוא/היא 19915.")
    w = Witness.find(2592)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1997).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיים לורנס' (1997) היה/הייתה מצוות/ת למארח/ת יהודית רוזנפלד (6628). בצד של המארחים הוא/היא 17173.")
    w = Witness.find(1997)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2745).comments.create!(user_id: 415, content: "בשנה שעברה, 'ציפי נחשון' (2745) היה/הייתה מצוות/ת למארח/ת סימה בראל (8060). בצד של המארחים הוא/היא 18795.")
    w = Witness.find(2745)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2741).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה יעקובוביץ' (2741) היה/הייתה מצוות/ת למארח/ת לירז בראון (6461). בצד של המארחים הוא/היא 17009.")
    w = Witness.find(2741)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2878).comments.create!(user_id: 415, content: "בשנה שעברה, 'דינה גודשלק' (2878) היה/הייתה מצוות/ת למארח/ת דליה טיאר (2112). בצד של המארחים הוא/היא 3719.")
    w = Witness.find(2878)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1827).comments.create!(user_id: 415, content: "בשנה שעברה, 'מנס בוגן' (1827) היה/הייתה מצוות/ת למארח/ת מורן ומיכאל חיימוביץ (6603). בצד של המארחים הוא/היא 17149.")
    w = Witness.find(1827)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2409).comments.create!(user_id: 415, content: "בשנה שעברה, 'פרופ' רפי ולדן' (2409) היה/הייתה מצוות/ת למארח/ת שרון גולדפרב (4082). בצד של המארחים הוא/היא 10242.")
    w = Witness.find(2409)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2519).comments.create!(user_id: 415, content: "בשנה שעברה, 'יצחק זילברברג' (2519) היה/הייתה מצוות/ת למארח/ת ג'סיקה קוסטובסקי (8259). בצד של המארחים הוא/היא 19048.")
    w = Witness.find(2519)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2746).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרגא שתיל' (2746) היה/הייתה מצוות/ת למארח/ת אלעזר גלזר (8035). בצד של המארחים הוא/היא 18766.")
    w = Witness.find(2746)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2744).comments.create!(user_id: 415, content: "בשנה שעברה, 'מירה פלד' (2744) היה/הייתה מצוות/ת למארח/ת שרונה קייסר רכזת מרכז חברתי \"אנוש\" (3076). בצד של המארחים הוא/היא 8958.")
    w = Witness.find(2744)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1486).comments.create!(user_id: 415, content: "בשנה שעברה, 'ד\"ר דניאל שליט' (1486) היה/הייתה מצוות/ת למארח/ת שרון קריה (9150). בצד של המארחים הוא/היא 20915.")
    w = Witness.find(1486)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(202).comments.create!(user_id: 415, content: "בשנה שעברה, 'רבקה מולדובן' (202) היה/הייתה מצוות/ת למארח/ת מירב בן-שמחון (7148). בצד של המארחים הוא/היא 17733.")
    w = Witness.find(202)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(114).comments.create!(user_id: 415, content: "בשנה שעברה, 'יעקב יהושוע' (114) היה/הייתה מצוות/ת למארח/ת דורון פלייש (7586). בצד של המארחים הוא/היא 18251.")
    w = Witness.find(114)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2751).comments.create!(user_id: 415, content: "בשנה שעברה, 'אטז סוזי' (2751) היה/הייתה מצוות/ת למארח/ת בן שבירו (8148). בצד של המארחים הוא/היא 18902.")
    w = Witness.find(2751)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2555).comments.create!(user_id: 415, content: "בשנה שעברה, 'חווה שילה' (2555) היה/הייתה מצוות/ת למארח/ת הדס גל (4030). בצד של המארחים הוא/היא 10177.")
    w = Witness.find(2555)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2766).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברודרמן ישראל' (2766) היה/הייתה מצוות/ת למארח/ת טל אייזנר (8143). בצד של המארחים הוא/היא 18897.")
    w = Witness.find(2766)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1256).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוכבד גרינבלט' (1256) היה/הייתה מצוות/ת למארח/ת DARMON Deborah and Nathan (8431). בצד של המארחים הוא/היא 19337.")
    w = Witness.find(1256)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2775).comments.create!(user_id: 415, content: "בשנה שעברה, 'טובה וצבי שפיר' (2775) היה/הייתה מצוות/ת למארח/ת שירה אשכנזי (6537). בצד של המארחים הוא/היא 17082.")
    w = Witness.find(2775)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2778).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודה ספורטה' (2778) היה/הייתה מצוות/ת למארח/ת סמדר הופ (7406). בצד של המארחים הוא/היא 18039.")
    w = Witness.find(2778)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2081).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיה קניג' (2081) היה/הייתה מצוות/ת למארח/ת דניאל איבינדר (7682). בצד של המארחים הוא/היא 18362.")
    w = Witness.find(2081)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2795).comments.create!(user_id: 415, content: "בשנה שעברה, 'סילביה אייזנשטיין' (2795) היה/הייתה מצוות/ת למארח/ת גל שטנדל (260). בצד של המארחים הוא/היא 280.")
    w = Witness.find(2795)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2783).comments.create!(user_id: 415, content: "בשנה שעברה, 'רוזנמאיר פרדי' (2783) היה/הייתה מצוות/ת למארח/ת חמודי אבו סלאח (7006). בצד של המארחים הוא/היא 17574.")
    w = Witness.find(2783)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2787).comments.create!(user_id: 415, content: "בשנה שעברה, 'סיבור דוד' (2787) היה/הייתה מצוות/ת למארח/ת שחר ניר (419). בצד של המארחים הוא/היא 456.")
    w = Witness.find(2787)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1689).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלעד הופר' (1689) היה/הייתה מצוות/ת למארח/ת עינב עטר (9156). בצד של המארחים הוא/היא 6965.")
    w = Witness.find(1689)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2796).comments.create!(user_id: 415, content: "בשנה שעברה, 'מריה שרייר' (2796) היה/הייתה מצוות/ת למארח/ת נטע יפרח (6694). בצד של המארחים הוא/היא 17237.")
    w = Witness.find(2796)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2784).comments.create!(user_id: 415, content: "בשנה שעברה, 'דני בר אילן' (2784) היה/הייתה מצוות/ת למארח/ת סיגל כהן (3006). בצד של המארחים הוא/היא 8888.")
    w = Witness.find(2784)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2786).comments.create!(user_id: 415, content: "בשנה שעברה, 'גרדה שטיינפלד' (2786) היה/הייתה מצוות/ת למארח/ת איה (6495). בצד של המארחים הוא/היא 15306.")
    w = Witness.find(2786)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2794).comments.create!(user_id: 415, content: "בשנה שעברה, 'אווה ארבן' (2794) היה/הייתה מצוות/ת למארח/ת ניב סגל-חזק (4189). בצד של המארחים הוא/היא 10380.")
    w = Witness.find(2794)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2059).comments.create!(user_id: 415, content: "בשנה שעברה, 'גיטה קויפמן' (2059) היה/הייתה מצוות/ת למארח/ת טלי סוקניק (4264). בצד של המארחים הוא/היא 10463.")
    w = Witness.find(2059)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2712).comments.create!(user_id: 415, content: "בשנה שעברה, 'גונתר דמניג' (2712) היה/הייתה מצוות/ת למארח/ת אברהם הוסטל תל אביב (8345). בצד של המארחים הוא/היא 19169.")
    w = Witness.find(2712)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2879).comments.create!(user_id: 415, content: "בשנה שעברה, 'מאשה גורן' (2879) היה/הייתה מצוות/ת למארח/ת ליאור גורן (8052). בצד של המארחים הוא/היא 18786.")
    w = Witness.find(2879)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2813).comments.create!(user_id: 415, content: "בשנה שעברה, 'אוה שפנר' (2813) היה/הייתה מצוות/ת למארח/ת גולדי אלבז (1290). בצד של המארחים הוא/היא 1692.")
    w = Witness.find(2813)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1135).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלי כהן' (1135) היה/הייתה מצוות/ת למארח/ת ספריית בי\"ס כוכב הצפון (7595). בצד של המארחים הוא/היא 18265.")
    w = Witness.find(1135)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2978).comments.create!(user_id: 415, content: "בשנה שעברה, 'יניב בן שושן' (2978) היה/הייתה מצוות/ת למארח/ת גאיה בן סירה (8364). בצד של המארחים הוא/היא 19195.")
    w = Witness.find(2978)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2814).comments.create!(user_id: 415, content: "בשנה שעברה, 'עדנה קדם' (2814) היה/הייתה מצוות/ת למארח/ת עדנה קדם (7822). בצד של המארחים הוא/היא 18520.")
    w = Witness.find(2814)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2850).comments.create!(user_id: 415, content: "בשנה שעברה, 'ריטה קסימאו-בראון' (2850) היה/הייתה מצוות/ת למארח/ת אור אבקסיס (4760). בצד של המארחים הוא/היא 11125.")
    w = Witness.find(2850)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2802).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמואל צין' (2802) היה/הייתה מצוות/ת למארח/ת אסתר אבו צדקה- בני עקיבא רעננה צפון (4028). בצד של המארחים הוא/היא 10174.")
    w = Witness.find(2802)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2816).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתר נניש' (2816) היה/הייתה מצוות/ת למארח/ת לבנת לאוה (2567). בצד של המארחים הוא/היא 5689.")
    w = Witness.find(2816)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2805).comments.create!(user_id: 415, content: "בשנה שעברה, 'ציפורה אושרי' (2805) היה/הייתה מצוות/ת למארח/ת נועם סולומון (7711). בצד של המארחים הוא/היא 18400.")
    w = Witness.find(2805)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1038).comments.create!(user_id: 415, content: "בשנה שעברה, 'רבקה קושניר' (1038) היה/הייתה מצוות/ת למארח/ת מישל סמיונוב (8172). בצד של המארחים הוא/היא 18945.")
    w = Witness.find(1038)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2807).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוכבד ברוש' (2807) היה/הייתה מצוות/ת למארח/ת שלומית כפיר (6961). בצד של המארחים הוא/היא 17527.")
    w = Witness.find(2807)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2808).comments.create!(user_id: 415, content: "בשנה שעברה, 'גלבר פייביש (פייקו)' (2808) היה/הייתה מצוות/ת למארח/ת רחלי תדהר קנר (7736). בצד של המארחים הוא/היא 18428.")
    w = Witness.find(2808)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2470).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית ברעם' (2470) היה/הייתה מצוות/ת למארח/ת הוסטל בן גלים (8096). בצד של המארחים הוא/היא 18841.")
    w = Witness.find(2470)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2815).comments.create!(user_id: 415, content: "בשנה שעברה, 'ליאת שמעון' (2815) היה/הייתה מצוות/ת למארח/ת איילת ריקנטי (7495). בצד של המארחים הוא/היא 18145.")
    w = Witness.find(2815)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2979).comments.create!(user_id: 415, content: "בשנה שעברה, 'פרדי דגן' (2979) היה/הייתה מצוות/ת למארח/ת מעיין צוראל (8546). בצד של המארחים הוא/היא 19509.")
    w = Witness.find(2979)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1871).comments.create!(user_id: 415, content: "בשנה שעברה, 'בקר איגור' (1871) היה/הייתה מצוות/ת למארח/ת ורוניקה דבורקין (8464). בצד של המארחים הוא/היא 19387.")
    w = Witness.find(1871)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2817).comments.create!(user_id: 415, content: "בשנה שעברה, 'מתי גרינברג' (2817) היה/הייתה מצוות/ת למארח/ת הגר לופו (7315). בצד של המארחים הוא/היא 17929.")
    w = Witness.find(2817)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2818).comments.create!(user_id: 415, content: "בשנה שעברה, 'רזי אילן' (2818) היה/הייתה מצוות/ת למארח/ת מור דוידור (7100). בצד של המארחים הוא/היא 17685.")
    w = Witness.find(2818)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2826).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלכס זליקוביץ' (2826) היה/הייתה מצוות/ת למארח/ת אילא קרמל שיפמן (3806). בצד של המארחים הוא/היא 5261.")
    w = Witness.find(2826)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2892).comments.create!(user_id: 415, content: "בשנה שעברה, 'גד ברוש' (2892) היה/הייתה מצוות/ת למארח/ת עידו גרינבלום (7098). בצד של המארחים הוא/היא 17682.")
    w = Witness.find(2892)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2819).comments.create!(user_id: 415, content: "בשנה שעברה, 'אורית זהבי' (2819) היה/הייתה מצוות/ת למארח/ת דבורה דניאלי (7302). בצד של המארחים הוא/היא 17915.")
    w = Witness.find(2819)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(747).comments.create!(user_id: 415, content: "בשנה שעברה, 'אברהם דניאלי' (747) היה/הייתה מצוות/ת למארח/ת סהר אלימלך - ארגון המרכז לחינוך סייבר (6980). בצד של המארחים הוא/היא 17547.")
    w = Witness.find(747)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2835).comments.create!(user_id: 415, content: "בשנה שעברה, 'הדסה לנגסם' (2835) היה/הייתה מצוות/ת למארח/ת עמית אבן (6635). בצד של המארחים הוא/היא 17180.")
    w = Witness.find(2835)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2959).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנן גרין' (2959) היה/הייתה מצוות/ת למארח/ת קרן רונן (8218). בצד של המארחים הוא/היא 19002.")
    w = Witness.find(2959)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2837).comments.create!(user_id: 415, content: "בשנה שעברה, 'יצחק סימון' (2837) היה/הייתה מצוות/ת למארח/ת חן מלקא (9531). בצד של המארחים הוא/היא 22523.")
    w = Witness.find(2837)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2824).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה פון שורצה' (2824) היה/הייתה מצוות/ת למארח/ת קאנטרי חשמונאים (7943). בצד של המארחים הוא/היא 18666.")
    w = Witness.find(2824)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2867).comments.create!(user_id: 415, content: "בשנה שעברה, 'ראובן שפיץ' (2867) היה/הייתה מצוות/ת למארח/ת רוית אלקיס יגרמן (3154). בצד של המארחים הוא/היא 9037.")
    w = Witness.find(2867)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2839).comments.create!(user_id: 415, content: "בשנה שעברה, 'דבורה ברין' (2839) היה/הייתה מצוות/ת למארח/ת בירן אסנת (1530). בצד של המארחים הוא/היא 2207.")
    w = Witness.find(2839)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(499).comments.create!(user_id: 415, content: "בשנה שעברה, 'דינה מרחב' (499) היה/הייתה מצוות/ת למארח/ת עירית זמט (8451). בצד של המארחים הוא/היא 19369.")
    w = Witness.find(499)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2443).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברוך קראוס' (2443) היה/הייתה מצוות/ת למארח/ת ericsson (6853). בצד של המארחים הוא/היא 17409.")
    w = Witness.find(2443)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2901).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלה פאר' (2901) היה/הייתה מצוות/ת למארח/ת פיני שניר (8705). בצד של המארחים הוא/היא 19772.")
    w = Witness.find(2901)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2779).comments.create!(user_id: 415, content: "בשנה שעברה, 'אביבה פז' (2779) היה/הייתה מצוות/ת למארח/ת שקד לוי (6874). בצד של המארחים הוא/היא 17430.")
    w = Witness.find(2779)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2956).comments.create!(user_id: 415, content: "בשנה שעברה, 'ירדנה זיגמן איגרה' (2956) היה/הייתה מצוות/ת למארח/ת שיר מזרחי (6727). בצד של המארחים הוא/היא 17270.")
    w = Witness.find(2956)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2788).comments.create!(user_id: 415, content: "בשנה שעברה, 'נורית בלכנר' (2788) היה/הייתה מצוות/ת למארח/ת מרינה - משטרת נהריה (7125). בצד של המארחים הוא/היא 17709.")
    w = Witness.find(2788)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(236).comments.create!(user_id: 415, content: "בשנה שעברה, 'רותי טורקניץ' (236) היה/הייתה מצוות/ת למארח/ת שגיא פרידמן (9159). בצד של המארחים הוא/היא 20948.")
    w = Witness.find(236)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2522).comments.create!(user_id: 415, content: "בשנה שעברה, 'כרמיאל יוסף' (2522) היה/הייתה מצוות/ת למארח/ת מיקי לוי (6115). בצד של המארחים הוא/היא 14431.")
    w = Witness.find(2522)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1416).comments.create!(user_id: 415, content: "בשנה שעברה, 'אביחי אורן' (1416) היה/הייתה מצוות/ת למארח/ת בית קמחי (7603). בצד של המארחים הוא/היא 18273.")
    w = Witness.find(1416)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2275).comments.create!(user_id: 415, content: "בשנה שעברה, 'רות אברכהן' (2275) היה/הייתה מצוות/ת למארח/ת מירב גביש (6588). בצד של המארחים הוא/היא 17135.")
    w = Witness.find(2275)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(279).comments.create!(user_id: 415, content: "בשנה שעברה, 'איציק חידרסקי' (279) היה/הייתה מצוות/ת למארח/ת ענת ויונטה (7508). בצד של המארחים הוא/היא 18160.")
    w = Witness.find(279)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2501).comments.create!(user_id: 415, content: "בשנה שעברה, 'הדסה נחושתן' (2501) היה/הייתה מצוות/ת למארח/ת שוש בן שושן (8597). בצד של המארחים הוא/היא 19587.")
    w = Witness.find(2501)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1637).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל ישראלי' (1637) היה/הייתה מצוות/ת למארח/ת לינוי דמרי (8505). בצד של המארחים הוא/היא 19443.")
    w = Witness.find(1637)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(714).comments.create!(user_id: 415, content: "בשנה שעברה, 'נוח שטרן' (714) היה/הייתה מצוות/ת למארח/ת שחר ברגר (7436). בצד של המארחים הוא/היא 18075.")
    w = Witness.find(714)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2434).comments.create!(user_id: 415, content: "בשנה שעברה, 'אבירם צבי' (2434) היה/הייתה מצוות/ת למארח/ת אילנה דיכטר (6763). בצד של המארחים הוא/היא 17308.")
    w = Witness.find(2434)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2477).comments.create!(user_id: 415, content: "בשנה שעברה, 'שלישיית \"הדור השלישי\" (אודי ברינדט)' (2477) היה/הייתה מצוות/ת למארח/ת גילי טל (3362). בצד של המארחים הוא/היא 9245.")
    w = Witness.find(2477)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2326).comments.create!(user_id: 415, content: "בשנה שעברה, 'זיוה לוי' (2326) היה/הייתה מצוות/ת למארח/ת טל שפיצר (7048). בצד של המארחים הוא/היא 17626.")
    w = Witness.find(2326)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2849).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרדכי ליבר' (2849) היה/הייתה מצוות/ת למארח/ת כרמל רבינוביץ (233). בצד של המארחים הוא/היא 242.")
    w = Witness.find(2849)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2848).comments.create!(user_id: 415, content: "בשנה שעברה, 'קרלה פלפל' (2848) היה/הייתה מצוות/ת למארח/ת דנה קיזלשטיין (7504). בצד של המארחים הוא/היא 18156.")
    w = Witness.find(2848)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2846).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה שפיצר' (2846) היה/הייתה מצוות/ת למארח/ת עידן רוזנפלד (7502). בצד של המארחים הוא/היא 18153.")
    w = Witness.find(2846)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2845).comments.create!(user_id: 415, content: "בשנה שעברה, 'מירה שקד' (2845) היה/הייתה מצוות/ת למארח/ת צמרת קניזניק (7547). בצד של המארחים הוא/היא 18200.")
    w = Witness.find(2845)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2851).comments.create!(user_id: 415, content: "בשנה שעברה, 'יעל המבורג' (2851) היה/הייתה מצוות/ת למארח/ת דיאנה דבטיאן (3272). בצד של המארחים הוא/היא 9154.")
    w = Witness.find(2851)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2847).comments.create!(user_id: 415, content: "בשנה שעברה, 'מימי הופרט' (2847) היה/הייתה מצוות/ת למארח/ת אמילי שופן ואמיתי קראוס (7020). בצד של המארחים הוא/היא 17589.")
    w = Witness.find(2847)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2856).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה רוזן' (2856) היה/הייתה מצוות/ת למארח/ת הילה קורן (987). בצד של המארחים הוא/היא 1105.")
    w = Witness.find(2856)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2857).comments.create!(user_id: 415, content: "בשנה שעברה, 'שולה שטיינמץ' (2857) היה/הייתה מצוות/ת למארח/ת נטע בן סעדון (6751). בצד של המארחים הוא/היא 17295.")
    w = Witness.find(2857)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(218).comments.create!(user_id: 415, content: "בשנה שעברה, 'רבקה הר אריה' (218) היה/הייתה מצוות/ת למארח/ת ויקי קרויטור (7400). בצד של המארחים הוא/היא 18033.")
    w = Witness.find(218)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2371).comments.create!(user_id: 415, content: "בשנה שעברה, 'זיוה סוסק' (2371) היה/הייתה מצוות/ת למארח/ת הגר שמואלי (4125). בצד של המארחים הוא/היא 10295.")
    w = Witness.find(2371)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1793).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה פלס' (1793) היה/הייתה מצוות/ת למארח/ת מתן קפל (6785). בצד של המארחים הוא/היא 17333.")
    w = Witness.find(1793)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2868).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרסל שיוביץ' (2868) היה/הייתה מצוות/ת למארח/ת מלכי רוטנר (6555). בצד של המארחים הוא/היא 17103.")
    w = Witness.find(2868)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2859).comments.create!(user_id: 415, content: "בשנה שעברה, 'מזל דאי' (2859) היה/הייתה מצוות/ת למארח/ת ארומה סיטי אשדוד (1506). בצד של המארחים הוא/היא 2152.")
    w = Witness.find(2859)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(601).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברנרד שפיק' (601) היה/הייתה מצוות/ת למארח/ת מועדון גמלאי יוספטל כפ\"ס (6743). בצד של המארחים הוא/היא 17287.")
    w = Witness.find(601)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2866).comments.create!(user_id: 415, content: "בשנה שעברה, 'דורון נידרלנד (פרופ')' (2866) היה/הייתה מצוות/ת למארח/ת ש\"י איבלמן לוין (7295). בצד של המארחים הוא/היא 17907.")
    w = Witness.find(2866)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2865).comments.create!(user_id: 415, content: "בשנה שעברה, 'זינה ואברהם' (2865) היה/הייתה מצוות/ת למארח/ת סיגלית יחזקאל (4059). בצד של המארחים הוא/היא 10216.")
    w = Witness.find(2865)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2864).comments.create!(user_id: 415, content: "בשנה שעברה, 'יעקב תל אור' (2864) היה/הייתה מצוות/ת למארח/ת יעל פרנבך (4891). בצד של המארחים הוא/היא 11359.")
    w = Witness.find(2864)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2861).comments.create!(user_id: 415, content: "בשנה שעברה, 'יפה ארקליס' (2861) היה/הייתה מצוות/ת למארח/ת איציק שעבן (8577). בצד של המארחים הוא/היא 19551.")
    w = Witness.find(2861)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2863).comments.create!(user_id: 415, content: "בשנה שעברה, 'אריה פיטמן' (2863) היה/הייתה מצוות/ת למארח/ת אתי רון (8302). בצד של המארחים הוא/היא 19116.")
    w = Witness.find(2863)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2870).comments.create!(user_id: 415, content: "בשנה שעברה, 'יונה ארנשטיין' (2870) היה/הייתה מצוות/ת למארח/ת יהודה ארנשטיין (8130). בצד של המארחים הוא/היא 18878.")
    w = Witness.find(2870)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2862).comments.create!(user_id: 415, content: "בשנה שעברה, 'לאה ינוביץ' (2862) היה/הייתה מצוות/ת למארח/ת אילנה פצ'רסקי (8292). בצד של המארחים הוא/היא 19090.")
    w = Witness.find(2862)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(917).comments.create!(user_id: 415, content: "בשנה שעברה, 'יפה כושר' (917) היה/הייתה מצוות/ת למארח/ת הדס ברלב כהן (271). בצד של המארחים הוא/היא 295.")
    w = Witness.find(917)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2638).comments.create!(user_id: 415, content: "בשנה שעברה, 'רון יוסף' (2638) היה/הייתה מצוות/ת למארח/ת נועה דהן (7771). בצד של המארחים הוא/היא 18468.")
    w = Witness.find(2638)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1572).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודה ורדי' (1572) היה/הייתה מצוות/ת למארח/ת אביטל מאירי (7388). בצד של המארחים הוא/היא 18018.")
    w = Witness.find(1572)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1568).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה שטריכליכט' (1568) היה/הייתה מצוות/ת למארח/ת יעל ניזרי (6933). בצד של המארחים הוא/היא 17495.")
    w = Witness.find(1568)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1593).comments.create!(user_id: 415, content: "בשנה שעברה, 'ראובן וחדווה גיל' (1593) היה/הייתה מצוות/ת למארח/ת נעה ספיר (7953). בצד של המארחים הוא/היא 18676.")
    w = Witness.find(1593)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2882).comments.create!(user_id: 415, content: "בשנה שעברה, 'ישי רדל' (2882) היה/הייתה מצוות/ת למארח/ת אפרת ששון (1264). בצד של המארחים הוא/היא 1632.")
    w = Witness.find(2882)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2881).comments.create!(user_id: 415, content: "בשנה שעברה, 'סעדיה בהט' (2881) היה/הייתה מצוות/ת למארח/ת דגנית אפלר (6135). בצד של המארחים הוא/היא 14586.")
    w = Witness.find(2881)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2898).comments.create!(user_id: 415, content: "בשנה שעברה, 'חווה מוריס' (2898) היה/הייתה מצוות/ת למארח/ת דורית נווה (8318). בצד של המארחים הוא/היא 19139.")
    w = Witness.find(2898)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2889).comments.create!(user_id: 415, content: "בשנה שעברה, 'מנחם בן יצחק' (2889) היה/הייתה מצוות/ת למארח/ת אלמוג אייזנמן (6569). בצד של המארחים הוא/היא 17116.")
    w = Witness.find(2889)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2886).comments.create!(user_id: 415, content: "בשנה שעברה, 'עידן רגב' (2886) היה/הייתה מצוות/ת למארח/ת חגית דמרי (6987). בצד של המארחים הוא/היא 17555.")
    w = Witness.find(2886)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2883).comments.create!(user_id: 415, content: "בשנה שעברה, 'ציפורה אולגה הירש' (2883) היה/הייתה מצוות/ת למארח/ת הניה פישמן (6986). בצד של המארחים הוא/היא 17554.")
    w = Witness.find(2883)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2888).comments.create!(user_id: 415, content: "בשנה שעברה, 'הרב יצחק אליפנט- הרב הראשי לדימונה' (2888) היה/הייתה מצוות/ת למארח/ת עודד הרוש (7493). בצד של המארחים הוא/היא 18143.")
    w = Witness.find(2888)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2885).comments.create!(user_id: 415, content: "בשנה שעברה, 'גרשון צ'יבוטרו' (2885) היה/הייתה מצוות/ת למארח/ת מעיין ירושלמי- כהן (7512). בצד של המארחים הוא/היא 18164.")
    w = Witness.find(2885)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2890).comments.create!(user_id: 415, content: "בשנה שעברה, 'הלן קרמון' (2890) היה/הייתה מצוות/ת למארח/ת משה בר (3734). בצד של המארחים הוא/היא 9793.")
    w = Witness.find(2890)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2937).comments.create!(user_id: 415, content: "בשנה שעברה, 'ציפי נוביק ויינברג' (2937) היה/הייתה מצוות/ת למארח/ת ‫אפרת בשרי‬‎ (3946). בצד של המארחים הוא/היא 10069.")
    w = Witness.find(2937)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2933).comments.create!(user_id: 415, content: "בשנה שעברה, 'יונה אונגר' (2933) היה/הייתה מצוות/ת למארח/ת אידית שפט (7594). בצד של המארחים הוא/היא 18264.")
    w = Witness.find(2933)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1445).comments.create!(user_id: 415, content: "בשנה שעברה, 'אביבה ברמי' (1445) היה/הייתה מצוות/ת למארח/ת שרי (8040). בצד של המארחים הוא/היא 18773.")
    w = Witness.find(1445)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2884).comments.create!(user_id: 415, content: "בשנה שעברה, 'שושנה וינברגר' (2884) היה/הייתה מצוות/ת למארח/ת אבישג עמית-שפירא (8544). בצד של המארחים הוא/היא 13186.")
    w = Witness.find(2884)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2897).comments.create!(user_id: 415, content: "בשנה שעברה, 'עינת כהן' (2897) היה/הייתה מצוות/ת למארח/ת אביב ניר (בשם בית תמי - מרכז קהילתי לב תל אביב) (147). בצד של המארחים הוא/היא 151.")
    w = Witness.find(2897)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2896).comments.create!(user_id: 415, content: "בשנה שעברה, 'מינה שומרון' (2896) היה/הייתה מצוות/ת למארח/ת אילי הדר (8216). בצד של המארחים הוא/היא 18998.")
    w = Witness.find(2896)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2903).comments.create!(user_id: 415, content: "בשנה שעברה, 'בן נון אביגיל' (2903) היה/הייתה מצוות/ת למארח/ת נעמי אהרונוביץ (6543). בצד של המארחים הוא/היא 17092.")
    w = Witness.find(2903)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2214).comments.create!(user_id: 415, content: "בשנה שעברה, 'קרפניך בלה' (2214) היה/הייתה מצוות/ת למארח/ת שרית פריינטה (9050). בצד של המארחים הוא/היא 20617.")
    w = Witness.find(2214)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2904).comments.create!(user_id: 415, content: "בשנה שעברה, 'סילביה אהרון' (2904) היה/הייתה מצוות/ת למארח/ת יסמין אלבחרי (2841). בצד של המארחים הוא/היא 8622.")
    w = Witness.find(2904)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2940).comments.create!(user_id: 415, content: "בשנה שעברה, 'רנה שיפוני' (2940) היה/הייתה מצוות/ת למארח/ת חן גילאור שרעבי (9466). בצד של המארחים הוא/היא 22259.")
    w = Witness.find(2940)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2932).comments.create!(user_id: 415, content: "בשנה שעברה, 'אריק ריטר' (2932) היה/הייתה מצוות/ת למארח/ת עינת אהרון  מטעם עמותת שלומית (6870). בצד של המארחים הוא/היא 17426.")
    w = Witness.find(2932)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2934).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיים הרצל' (2934) היה/הייתה מצוות/ת למארח/ת מורי הרצל (9381). בצד של המארחים הוא/היא 21776.")
    w = Witness.find(2934)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1508).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלירם ג'נה' (1508) היה/הייתה מצוות/ת למארח/ת סמאי דוד (1208). בצד של המארחים הוא/היא 1535.")
    w = Witness.find(1508)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(405).comments.create!(user_id: 415, content: "בשנה שעברה, 'ד\"ר אדלה מורנו' (405) היה/הייתה מצוות/ת למארח/ת קהילת קודש וחול בחולון (8001). בצד של המארחים הוא/היא 18735.")
    w = Witness.find(405)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2918).comments.create!(user_id: 415, content: "בשנה שעברה, 'רינה כהן' (2918) היה/הייתה מצוות/ת למארח/ת זהר קפלן (5306). בצד של המארחים הוא/היא 12161.")
    w = Witness.find(2918)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2843).comments.create!(user_id: 415, content: "בשנה שעברה, 'סימה לבנטל' (2843) היה/הייתה מצוות/ת למארח/ת ענת רייזמן (7713). בצד של המארחים הוא/היא 18403.")
    w = Witness.find(2843)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2916).comments.create!(user_id: 415, content: "בשנה שעברה, 'אילנה קראוס' (2916) היה/הייתה מצוות/ת למארח/ת שירה ביטון (5225). בצד של המארחים הוא/היא 11999.")
    w = Witness.find(2916)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2915).comments.create!(user_id: 415, content: "בשנה שעברה, 'פאני ויוסף נישטט' (2915) היה/הייתה מצוות/ת למארח/ת רעות ליפשיץ (7808). בצד של המארחים הוא/היא 18507.")
    w = Witness.find(2915)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2557).comments.create!(user_id: 415, content: "בשנה שעברה, 'אתי בדיחי' (2557) היה/הייתה מצוות/ת למארח/ת יעל אשר (7396). בצד של המארחים הוא/היא 18029.")
    w = Witness.find(2557)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2926).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנוך שחר' (2926) היה/הייתה מצוות/ת למארח/ת הדסי לילך (6954). בצד של המארחים הוא/היא 17520.")
    w = Witness.find(2926)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2162).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהושוע ורשבסקי' (2162) היה/הייתה מצוות/ת למארח/ת ברק חדריאן (1639). בצד של המארחים הוא/היא 2441.")
    w = Witness.find(2162)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2930).comments.create!(user_id: 415, content: "בשנה שעברה, 'בצלאל קופרווסר' (2930) היה/הייתה מצוות/ת למארח/ת אמילי זיידל (8347). בצד של המארחים הוא/היא 19170.")
    w = Witness.find(2930)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2928).comments.create!(user_id: 415, content: "בשנה שעברה, 'אורי טמל' (2928) היה/הייתה מצוות/ת למארח/ת ענת ווקסמן (7411). בצד של המארחים הוא/היא 16065.")
    w = Witness.find(2928)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2919).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה קציר' (2919) היה/הייתה מצוות/ת למארח/ת עינבר ויינברגר (7970). בצד של המארחים הוא/היא 18700.")
    w = Witness.find(2919)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2920).comments.create!(user_id: 415, content: "בשנה שעברה, 'לבו מירון' (2920) היה/הייתה מצוות/ת למארח/ת מור (8221). בצד של המארחים הוא/היא 19006.")
    w = Witness.find(2920)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2929).comments.create!(user_id: 415, content: "בשנה שעברה, 'דליה רבינוביץ' (2929) היה/הייתה מצוות/ת למארח/ת חנית ברום (8145). בצד של המארחים הוא/היא 6936.")
    w = Witness.find(2929)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2925).comments.create!(user_id: 415, content: "בשנה שעברה, 'זמירה בר לב' (2925) היה/הייתה מצוות/ת למארח/ת רויטל צבאן (7449). בצד של המארחים הוא/היא 18089.")
    w = Witness.find(2925)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2170).comments.create!(user_id: 415, content: "בשנה שעברה, 'הרמינה גולדשטיין' (2170) היה/הייתה מצוות/ת למארח/ת טל רוזין (6911). בצד של המארחים הוא/היא 17467.")
    w = Witness.find(2170)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2936).comments.create!(user_id: 415, content: "בשנה שעברה, 'סוזי רוסק' (2936) היה/הייתה מצוות/ת למארח/ת נירה שפק (8235). בצד של המארחים הוא/היא 19020.")
    w = Witness.find(2936)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2931).comments.create!(user_id: 415, content: "בשנה שעברה, 'שאול הונדלר' (2931) היה/הייתה מצוות/ת למארח/ת ענת בן שיטרית (8657). בצד של המארחים הוא/היא 19691.")
    w = Witness.find(2931)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2938).comments.create!(user_id: 415, content: "בשנה שעברה, 'הנרי ומרים רוזן' (2938) היה/הייתה מצוות/ת למארח/ת דפנה ורונן קניג (8408). בצד של המארחים הוא/היא 19282.")
    w = Witness.find(2938)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2748).comments.create!(user_id: 415, content: "בשנה שעברה, 'אגמון מרים' (2748) היה/הייתה מצוות/ת למארח/ת שירלי חברוני (2220). בצד של המארחים הוא/היא 4150.")
    w = Witness.find(2748)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1408).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית משה' (1408) היה/הייתה מצוות/ת למארח/ת נטע וארנון מוזר (8111). בצד של המארחים הוא/היא 18855.")
    w = Witness.find(1408)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2950).comments.create!(user_id: 415, content: "בשנה שעברה, 'פנחס זינגר' (2950) היה/הייתה מצוות/ת למארח/ת ליאת צדקני (7364). בצד של המארחים הוא/היא 17987.")
    w = Witness.find(2950)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2949).comments.create!(user_id: 415, content: "בשנה שעברה, 'קרול נודלמן' (2949) היה/הייתה מצוות/ת למארח/ת מאיה לוי (6618). בצד של המארחים הוא/היא 17164.")
    w = Witness.find(2949)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2948).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיים מנדלוביץ' (2948) היה/הייתה מצוות/ת למארח/ת רן וייסברוט (8293). בצד של המארחים הוא/היא 19092.")
    w = Witness.find(2948)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2947).comments.create!(user_id: 415, content: "בשנה שעברה, 'דניאל שוואב' (2947) היה/הייתה מצוות/ת למארח/ת נועה שבת (8146). בצד של המארחים הוא/היא 18900.")
    w = Witness.find(2947)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2954).comments.create!(user_id: 415, content: "בשנה שעברה, 'יעקב יחמוביץ'' (2954) היה/הייתה מצוות/ת למארח/ת ספיר כהן (7637). בצד של המארחים הוא/היא 18315.")
    w = Witness.find(2954)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2052).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרדכי מרקשייד' (2052) היה/הייתה מצוות/ת למארח/ת נופר נגר (2369). בצד של המארחים הוא/היא 4631.")
    w = Witness.find(2052)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2961).comments.create!(user_id: 415, content: "בשנה שעברה, 'תמר גולן' (2961) היה/הייתה מצוות/ת למארח/ת קורל חכים (9044). בצד של המארחים הוא/היא 20593.")
    w = Witness.find(2961)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2974).comments.create!(user_id: 415, content: "בשנה שעברה, 'ליאור כץ' (2974) היה/הייתה מצוות/ת למארח/ת אורלי שושני (5239). בצד של המארחים הוא/היא 12023.")
    w = Witness.find(2974)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2963).comments.create!(user_id: 415, content: "בשנה שעברה, 'פרלה דדיש' (2963) היה/הייתה מצוות/ת למארח/ת נועה לייקוב (9257). בצד של המארחים הוא/היא 21299.")
    w = Witness.find(2963)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2973).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמחה אברהמי' (2973) היה/הייתה מצוות/ת למארח/ת אבישג (8361). בצד של המארחים הוא/היא 19189.")
    w = Witness.find(2973)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2965).comments.create!(user_id: 415, content: "בשנה שעברה, 'ליודמילה גרצ'יוב' (2965) היה/הייתה מצוות/ת למארח/ת ארתור גרופ (8750). בצד של המארחים הוא/היא 19858.")
    w = Witness.find(2965)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2976).comments.create!(user_id: 415, content: "בשנה שעברה, 'ילנה לוייטר' (2976) היה/הייתה מצוות/ת למארח/ת שירה ג'רג'י (8305). בצד של המארחים הוא/היא 19121.")
    w = Witness.find(2976)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2975).comments.create!(user_id: 415, content: "בשנה שעברה, 'דבורה פנג' (2975) היה/הייתה מצוות/ת למארח/ת אלמוג פישר (4361). בצד של המארחים הוא/היא 10584.")
    w = Witness.find(2975)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2964).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוסף יוסף' (2964) היה/הייתה מצוות/ת למארח/ת מיטל יעקובוב (8624). בצד של המארחים הוא/היא 19621.")
    w = Witness.find(2964)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2924).comments.create!(user_id: 415, content: "בשנה שעברה, 'דני לרנר' (2924) היה/הייתה מצוות/ת למארח/ת טח קרת (7830). בצד של המארחים הוא/היא 18529.")
    w = Witness.find(2924)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1701).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה מלכה' (1701) היה/הייתה מצוות/ת למארח/ת ברק מטס (3131). בצד של המארחים הוא/היא 9014.")
    w = Witness.find(1701)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(612).comments.create!(user_id: 415, content: "בשנה שעברה, 'רות שרון' (612) היה/הייתה מצוות/ת למארח/ת רונית גבאי(שרון) (3949). בצד של המארחים הוא/היא 10079.")
    w = Witness.find(612)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2977).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרים אברמוביץ'' (2977) היה/הייתה מצוות/ת למארח/ת עמית שמש (3212). בצד של המארחים הוא/היא 9097.")
    w = Witness.find(2977)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2844).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה עקרוני' (2844) היה/הייתה מצוות/ת למארח/ת קרן שפיר (8391). בצד של המארחים הוא/היא 19239.")
    w = Witness.find(2844)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3077).comments.create!(user_id: 415, content: "בשנה שעברה, 'איריס בלום' (3077) היה/הייתה מצוות/ת למארח/ת יגל חנוכה (9556). בצד של המארחים הוא/היא 22647.")
    w = Witness.find(3077)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2996).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתר פריזר' (2996) היה/הייתה מצוות/ת למארח/ת BINA Secular Yeshiva in Tel Aviv (3360). בצד של המארחים הוא/היא 9242.")
    w = Witness.find(2996)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2981).comments.create!(user_id: 415, content: "בשנה שעברה, 'בנימין גנור' (2981) היה/הייתה מצוות/ת למארח/ת פנימיית גבעת הוד/בית הנוער (7454). בצד של המארחים הוא/היא 18094.")
    w = Witness.find(2981)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2993).comments.create!(user_id: 415, content: "בשנה שעברה, 'אווה לזר' (2993) היה/הייתה מצוות/ת למארח/ת טלי אילני (3181). בצד של המארחים הוא/היא 9066.")
    w = Witness.find(2993)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2995).comments.create!(user_id: 415, content: "בשנה שעברה, 'יצחק גולדשטיין' (2995) היה/הייתה מצוות/ת למארח/ת שי סבג (7082). בצד של המארחים הוא/היא 17664.")
    w = Witness.find(2995)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1511).comments.create!(user_id: 415, content: "בשנה שעברה, 'דשה ושמעון ציבקין' (1511) היה/הייתה מצוות/ת למארח/ת יעל ויזל (7897). בצד של המארחים הוא/היא 18610.")
    w = Witness.find(1511)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(712).comments.create!(user_id: 415, content: "בשנה שעברה, 'דוד אייזמן' (712) היה/הייתה מצוות/ת למארח/ת אסנת בנאי (9663). בצד של המארחים הוא/היא 23242.")
    w = Witness.find(712)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3001).comments.create!(user_id: 415, content: "בשנה שעברה, 'עמי ברנזון' (3001) היה/הייתה מצוות/ת למארח/ת הילה מזוז (7332). בצד של המארחים הוא/היא 17951.")
    w = Witness.find(3001)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3041).comments.create!(user_id: 415, content: "בשנה שעברה, 'איבון יונה בנדה' (3041) היה/הייתה מצוות/ת למארח/ת אופיר גורלי (8211). בצד של המארחים הוא/היא 18992.")
    w = Witness.find(3041)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3002).comments.create!(user_id: 415, content: "בשנה שעברה, 'מקס נתנס' (3002) היה/הייתה מצוות/ת למארח/ת עופר ונילי בן צבי (8392). בצד של המארחים הוא/היא 19240.")
    w = Witness.find(3002)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1571).comments.create!(user_id: 415, content: "בשנה שעברה, 'בנימין סגל' (1571) היה/הייתה מצוות/ת למארח/ת קומונת קרית גת כנפיים של קרמבו (7042). בצד של המארחים הוא/היא 17616.")
    w = Witness.find(1571)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3012).comments.create!(user_id: 415, content: "בשנה שעברה, 'מישל למפל' (3012) היה/הייתה מצוות/ת למארח/ת Esther Levenson (8773). בצד של המארחים הוא/היא 15003.")
    w = Witness.find(3012)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(379).comments.create!(user_id: 415, content: "בשנה שעברה, 'לילי קאופמן' (379) היה/הייתה מצוות/ת למארח/ת שיר קליין (6789). בצד של המארחים הוא/היא 17338.")
    w = Witness.find(379)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2055).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה רוזנברג' (2055) היה/הייתה מצוות/ת למארח/ת רותם שושנה (6852). בצד של המארחים הוא/היא 17408.")
    w = Witness.find(2055)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3039).comments.create!(user_id: 415, content: "בשנה שעברה, 'לאה סמט' (3039) היה/הייתה מצוות/ת למארח/ת אביב עגיב (6481). בצד של המארחים הוא/היא 17032.")
    w = Witness.find(3039)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1502).comments.create!(user_id: 415, content: "בשנה שעברה, 'סלי זייפמן' (1502) היה/הייתה מצוות/ת למארח/ת רבקה (9728). בצד של המארחים הוא/היא 23663.")
    w = Witness.find(1502)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3036).comments.create!(user_id: 415, content: "בשנה שעברה, 'מתי דוד' (3036) היה/הייתה מצוות/ת למארח/ת כאן תאגיד השידור (9132). בצד של המארחים הוא/היא 20832.")
    w = Witness.find(3036)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3016).comments.create!(user_id: 415, content: "בשנה שעברה, 'אליהו ומטלידה שאואט' (3016) היה/הייתה מצוות/ת למארח/ת אופיר צירט (9536). בצד של המארחים הוא/היא 22545.")
    w = Witness.find(3016)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3019).comments.create!(user_id: 415, content: "בשנה שעברה, 'שושנה ברייאר' (3019) היה/הייתה מצוות/ת למארח/ת קובי גלעדי (6503). בצד של המארחים הוא/היא 17053.")
    w = Witness.find(3019)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1835).comments.create!(user_id: 415, content: "בשנה שעברה, 'זונדל מנחם' (1835) היה/הייתה מצוות/ת למארח/ת איתי ארבל (8990). בצד של המארחים הוא/היא 20415.")
    w = Witness.find(1835)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3037).comments.create!(user_id: 415, content: "בשנה שעברה, 'לאה בהגאון' (3037) היה/הייתה מצוות/ת למארח/ת הדס ברלב כהן (141). בצד של המארחים הוא/היא 145.")
    w = Witness.find(3037)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3009).comments.create!(user_id: 415, content: "בשנה שעברה, 'גרציה רומן' (3009) היה/הייתה מצוות/ת למארח/ת נדב כהן (7369). בצד של המארחים הוא/היא 17993.")
    w = Witness.find(3009)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3013).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרונה קומם' (3013) היה/הייתה מצוות/ת למארח/ת אריאלה מן (8492). בצד של המארחים הוא/היא 19421.")
    w = Witness.find(3013)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3044).comments.create!(user_id: 415, content: "בשנה שעברה, 'בית אבות שמשון 55' (3044) היה/הייתה מצוות/ת למארח/ת תימור לינדר (6492). בצד של המארחים הוא/היא 17043.")
    w = Witness.find(3044)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3018).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרי כהן' (3018) היה/הייתה מצוות/ת למארח/ת שרון פיינגולד (770). בצד של המארחים הוא/היא 823.")
    w = Witness.find(3018)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3017).comments.create!(user_id: 415, content: "בשנה שעברה, 'טובה קליין' (3017) היה/הייתה מצוות/ת למארח/ת ניב שמרון (8765). בצד של המארחים הוא/היא 19887.")
    w = Witness.find(3017)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3020).comments.create!(user_id: 415, content: "בשנה שעברה, 'שולמית ויחזקאל נתן' (3020) היה/הייתה מצוות/ת למארח/ת רותי אסמרה (7702). בצד של המארחים הוא/היא 18387.")
    w = Witness.find(3020)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2957).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרון דגון קלדרון' (2957) היה/הייתה מצוות/ת למארח/ת סופיה לייקו (8727). בצד של המארחים הוא/היא 19820.")
    w = Witness.find(2957)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2261).comments.create!(user_id: 415, content: "בשנה שעברה, 'עזריאל (פטר) דנסקי' (2261) היה/הייתה מצוות/ת למארח/ת זוהר ברוש כהן (8675). בצד של המארחים הוא/היא 19717.")
    w = Witness.find(2261)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2097).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית אטינגר' (2097) היה/הייתה מצוות/ת למארח/ת ‫בר בשירי‬‎ (7387). בצד של המארחים הוא/היא 18016.")
    w = Witness.find(2097)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3060).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרים תמיר' (3060) היה/הייתה מצוות/ת למארח/ת מרצ'לה ברקוביץ' (7745). בצד של המארחים הוא/היא 18438.")
    w = Witness.find(3060)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3030).comments.create!(user_id: 415, content: "בשנה שעברה, 'בטי קרחי' (3030) היה/הייתה מצוות/ת למארח/ת יהודה יזרעאלי (6043). בצד של המארחים הוא/היא 14055.")
    w = Witness.find(3030)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3022).comments.create!(user_id: 415, content: "בשנה שעברה, 'הרמן אלטהולץ' (3022) היה/הייתה מצוות/ת למארח/ת דפנה הד (9075). בצד של המארחים הוא/היא 20719.")
    w = Witness.find(3022)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(390).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודה אייל' (390) היה/הייתה מצוות/ת למארח/ת רונית פיכמן (7447). בצד של המארחים הוא/היא 18087.")
    w = Witness.find(390)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3031).comments.create!(user_id: 415, content: "בשנה שעברה, 'בתיה וייל' (3031) היה/הייתה מצוות/ת למארח/ת adie (8841). בצד של המארחים הוא/היא 20071.")
    w = Witness.find(3031)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3033).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית הירשברג' (3033) היה/הייתה מצוות/ת למארח/ת דקלה מצוינים-תמשס (8326). בצד של המארחים הוא/היא 19149.")
    w = Witness.find(3033)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1973).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמעון גליק (פרופ')' (1973) היה/הייתה מצוות/ת למארח/ת מאי טאנן (7135). בצד של המארחים הוא/היא 17720.")
    w = Witness.find(1973)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3061).comments.create!(user_id: 415, content: "בשנה שעברה, 'אברהם רוזנפלד' (3061) היה/הייתה מצוות/ת למארח/ת מושב אניעם (7898). בצד של המארחים הוא/היא 18611.")
    w = Witness.find(3061)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(562).comments.create!(user_id: 415, content: "בשנה שעברה, 'שולמית שוויצר' (562) היה/הייתה מצוות/ת למארח/ת איתי צורף (7538). בצד של המארחים הוא/היא 18191.")
    w = Witness.find(562)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3057).comments.create!(user_id: 415, content: "בשנה שעברה, 'גלית שפרינגוט' (3057) היה/הייתה מצוות/ת למארח/ת מירב שיינס (7301). בצד של המארחים הוא/היא 17914.")
    w = Witness.find(3057)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3065).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיים גרינברג' (3065) היה/הייתה מצוות/ת למארח/ת גל פוגל (9052). בצד של המארחים הוא/היא 20619.")
    w = Witness.find(3065)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3052).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה גואטה' (3052) היה/הייתה מצוות/ת למארח/ת מירב סלע (6079). בצד של המארחים הוא/היא 14236.")
    w = Witness.find(3052)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3058).comments.create!(user_id: 415, content: "בשנה שעברה, 'ז'סלין קורז'יניאק' (3058) היה/הייתה מצוות/ת למארח/ת מיקי מוסנג'אד (9055). בצד של המארחים הוא/היא 20634.")
    w = Witness.find(3058)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2426).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודית וינברגר' (2426) היה/הייתה מצוות/ת למארח/ת ליאור (2199). בצד של המארחים הוא/היא 4040.")
    w = Witness.find(2426)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3056).comments.create!(user_id: 415, content: "בשנה שעברה, 'מריאנה ווייס' (3056) היה/הייתה מצוות/ת למארח/ת חמדה בלסבלג (7627). בצד של המארחים הוא/היא 18301.")
    w = Witness.find(3056)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3062).comments.create!(user_id: 415, content: "בשנה שעברה, 'שאול גרשנוביץ'' (3062) היה/הייתה מצוות/ת למארח/ת תמר רובין (9547). בצד של המארחים הוא/היא 22572.")
    w = Witness.find(3062)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3063).comments.create!(user_id: 415, content: "בשנה שעברה, 'נטלי גטה' (3063) היה/הייתה מצוות/ת למארח/ת חגי זיו (9539). בצד של המארחים הוא/היא 22550.")
    w = Witness.find(3063)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3055).comments.create!(user_id: 415, content: "בשנה שעברה, 'מיכל גולדברג' (3055) היה/הייתה מצוות/ת למארח/ת מכינת מיצר (9067). בצד של המארחים הוא/היא 20687.")
    w = Witness.find(3055)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3054).comments.create!(user_id: 415, content: "בשנה שעברה, 'בלומה רזמוביץ' (3054) היה/הייתה מצוות/ת למארח/ת יעל אלבה (9056). בצד של המארחים הוא/היא 20642.")
    w = Witness.find(3054)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3007).comments.create!(user_id: 415, content: "בשנה שעברה, 'מיכאל מן' (3007) היה/הייתה מצוות/ת למארח/ת טטיאנה חזן (8764). בצד של המארחים הוא/היא 19881.")
    w = Witness.find(3007)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3085).comments.create!(user_id: 415, content: "בשנה שעברה, 'אביגדור בר חי' (3085) היה/הייתה מצוות/ת למארח/ת שירה כהן (6959). בצד של המארחים הוא/היא 17525.")
    w = Witness.find(3085)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3067).comments.create!(user_id: 415, content: "בשנה שעברה, 'עדנה שפר גיטלין' (3067) היה/הייתה מצוות/ת למארח/ת Daniel Dror (6478). בצד של המארחים הוא/היא 5558.")
    w = Witness.find(3067)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3082).comments.create!(user_id: 415, content: "בשנה שעברה, 'זהר לסקוב' (3082) היה/הייתה מצוות/ת למארח/ת שני מור (7647). בצד של המארחים הוא/היא 18325.")
    w = Witness.find(3082)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3076).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל ניר' (3076) היה/הייתה מצוות/ת למארח/ת דנה צוויפלר (6765). בצד של המארחים הוא/היא 15748.")
    w = Witness.find(3076)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3049).comments.create!(user_id: 415, content: "בשנה שעברה, 'פנינה טרנו' (3049) היה/הייתה מצוות/ת למארח/ת אמונה מלכיאלי (8450). בצד של המארחים הוא/היא 19368.")
    w = Witness.find(3049)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3072).comments.create!(user_id: 415, content: "בשנה שעברה, 'אילנה צוק' (3072) היה/הייתה מצוות/ת למארח/ת גרעין בנות שירות (8736). בצד של המארחים הוא/היא 19836.")
    w = Witness.find(3072)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3068).comments.create!(user_id: 415, content: "בשנה שעברה, 'דוד דואני-קוטלר' (3068) היה/הייתה מצוות/ת למארח/ת צופיה סיקסיק (4571). בצד של המארחים הוא/היא 10883.")
    w = Witness.find(3068)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3075).comments.create!(user_id: 415, content: "בשנה שעברה, 'תמר ינקו' (3075) היה/הייתה מצוות/ת למארח/ת יהודה רוט (8541). בצד של המארחים הוא/היא 19501.")
    w = Witness.find(3075)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(365).comments.create!(user_id: 415, content: "בשנה שעברה, 'טל אור' (365) היה/הייתה מצוות/ת למארח/ת מוטי עבו (3049). בצד של המארחים הוא/היא 8932.")
    w = Witness.find(365)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3029).comments.create!(user_id: 415, content: "בשנה שעברה, 'פסיה צור' (3029) היה/הייתה מצוות/ת למארח/ת ליבת כחלון (600). בצד של המארחים הוא/היא 649.")
    w = Witness.find(3029)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3069).comments.create!(user_id: 415, content: "בשנה שעברה, 'פטר זלץ' (3069) היה/הייתה מצוות/ת למארח/ת לירז ששון (7101). בצד של המארחים הוא/היא 17686.")
    w = Witness.find(3069)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3094).comments.create!(user_id: 415, content: "בשנה שעברה, 'אתי לב' (3094) היה/הייתה מצוות/ת למארח/ת יערה סניור (6119). בצד של המארחים הוא/היא 14451.")
    w = Witness.find(3094)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2152).comments.create!(user_id: 415, content: "בשנה שעברה, 'גרוס נחמן וחנה' (2152) היה/הייתה מצוות/ת למארח/ת נעמה ירושלם (6734). בצד של המארחים הוא/היא 17277.")
    w = Witness.find(2152)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3090).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיים ישרון' (3090) היה/הייתה מצוות/ת למארח/ת מור פנדריק (5482). בצד של המארחים הוא/היא 12464.")
    w = Witness.find(3090)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3086).comments.create!(user_id: 415, content: "בשנה שעברה, 'נופר גנור' (3086) היה/הייתה מצוות/ת למארח/ת יואב ארנון (4687). בצד של המארחים הוא/היא 11036.")
    w = Witness.find(3086)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(758).comments.create!(user_id: 415, content: "בשנה שעברה, 'ישראל ליכטנשטיין' (758) היה/הייתה מצוות/ת למארח/ת גלינה דבויריס-חסין (6781). בצד של המארחים הוא/היא 17330.")
    w = Witness.find(758)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3092).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתר ירון' (3092) היה/הייתה מצוות/ת למארח/ת מיכל עגני (5144). בצד של המארחים הוא/היא 11798.")
    w = Witness.find(3092)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3089).comments.create!(user_id: 415, content: "בשנה שעברה, 'ענת דור' (3089) היה/הייתה מצוות/ת למארח/ת יובל שקדי (בתור 'מיכאלה', בית קפה בקטמון, ירושלים) (7041). בצד של המארחים הוא/היא 17615.")
    w = Witness.find(3089)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3088).comments.create!(user_id: 415, content: "בשנה שעברה, 'ציפי שנקר' (3088) היה/הייתה מצוות/ת למארח/ת יעל מילר (9314). בצד של המארחים הוא/היא 21515.")
    w = Witness.find(3088)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3091).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרית שחם' (3091) היה/הייתה מצוות/ת למארח/ת יערה זנזורי (7120). בצד של המארחים הוא/היא 17703.")
    w = Witness.find(3091)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3095).comments.create!(user_id: 415, content: "בשנה שעברה, 'ליאונה פרקש' (3095) היה/הייתה מצוות/ת למארח/ת רחל ברוך (5580). בצד של המארחים הוא/היא 12717.")
    w = Witness.find(3095)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2670).comments.create!(user_id: 415, content: "בשנה שעברה, 'אברהם איימן' (2670) היה/הייתה מצוות/ת למארח/ת מרדכי פרל (8885). בצד של המארחים הוא/היא 20163.")
    w = Witness.find(2670)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2468).comments.create!(user_id: 415, content: "בשנה שעברה, 'ליברמן לאה' (2468) היה/הייתה מצוות/ת למארח/ת שרון ציפר (8622). בצד של המארחים הוא/היא 19619.")
    w = Witness.find(2468)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2455).comments.create!(user_id: 415, content: "בשנה שעברה, 'ארליך רעיה' (2455) היה/הייתה מצוות/ת למארח/ת המרפסת - מרכז הצעירים הרצליה (4147). בצד של המארחים הוא/היא 10320.")
    w = Witness.find(2455)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2465).comments.create!(user_id: 415, content: "בשנה שעברה, 'פלדמן יעקב' (2465) היה/הייתה מצוות/ת למארח/ת יעל בן סעדון (7716). בצד של המארחים הוא/היא 18406.")
    w = Witness.find(2465)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2520).comments.create!(user_id: 415, content: "בשנה שעברה, 'אהוד פאר' (2520) היה/הייתה מצוות/ת למארח/ת פביאנה (8447). בצד של המארחים הוא/היא 19364.")
    w = Witness.find(2520)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2453).comments.create!(user_id: 415, content: "בשנה שעברה, 'אריה מולכו' (2453) היה/הייתה מצוות/ת למארח/ת מועדון הכוכב השמיני (7126). בצד של המארחים הוא/היא 17711.")
    w = Witness.find(2453)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2968).comments.create!(user_id: 415, content: "בשנה שעברה, 'קלרה לוטפק' (2968) היה/הייתה מצוות/ת למארח/ת לנה גרשקוביץ (7883). בצד של המארחים הוא/היא 18594.")
    w = Witness.find(2968)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3050).comments.create!(user_id: 415, content: "בשנה שעברה, 'דורית טפרברג' (3050) היה/הייתה מצוות/ת למארח/ת קמילה מיכמן (8215). בצד של המארחים הוא/היא 18996.")
    w = Witness.find(3050)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2834).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלעד ורדי' (2834) היה/הייתה מצוות/ת למארח/ת שירן אלמקייס (7233). בצד של המארחים הוא/היא 17829.")
    w = Witness.find(2834)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2776).comments.create!(user_id: 415, content: "בשנה שעברה, 'אווה קראוס' (2776) היה/הייתה מצוות/ת למארח/ת דנה אוחנה (3502). בצד של המארחים הוא/היא 9417.")
    w = Witness.find(2776)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2774).comments.create!(user_id: 415, content: "בשנה שעברה, 'אסתר קליפצקיה' (2774) היה/הייתה מצוות/ת למארח/ת גיא רון (6760). בצד של המארחים הוא/היא 17304.")
    w = Witness.find(2774)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2875).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל אבידור' (2875) היה/הייתה מצוות/ת למארח/ת עודד שטיין (3902). בצד של המארחים הוא/היא 9997.")
    w = Witness.find(2875)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2689).comments.create!(user_id: 415, content: "בשנה שעברה, 'בני ברזילי' (2689) היה/הייתה מצוות/ת למארח/ת אור- מרכז קהילתי בית רק\"ע ביפו (7874). בצד של המארחים הוא/היא 18581.")
    w = Witness.find(2689)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2944).comments.create!(user_id: 415, content: "בשנה שעברה, 'קלרה וולמן' (2944) היה/הייתה מצוות/ת למארח/ת אסתי שי (7998). בצד של המארחים הוא/היא 18731.")
    w = Witness.find(2944)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2951).comments.create!(user_id: 415, content: "בשנה שעברה, 'לקס נתנס' (2951) היה/הייתה מצוות/ת למארח/ת נדב כהן (8343). בצד של המארחים הוא/היא 19167.")
    w = Witness.find(2951)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2953).comments.create!(user_id: 415, content: "בשנה שעברה, 'איילה שני' (2953) היה/הייתה מצוות/ת למארח/ת גלית בן אפרים (8703). בצד של המארחים הוא/היא 11219.")
    w = Witness.find(2953)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2955).comments.create!(user_id: 415, content: "בשנה שעברה, 'חנה כספי' (2955) היה/הייתה מצוות/ת למארח/ת מוניקה קרוטיק (6826). בצד של המארחים הוא/היא 17381.")
    w = Witness.find(2955)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(720).comments.create!(user_id: 415, content: "בשנה שעברה, 'מולה גוטנר' (720) היה/הייתה מצוות/ת למארח/ת הילה עטר (218). בצד של המארחים הוא/היא 223.")
    w = Witness.find(720)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(3080).comments.create!(user_id: 415, content: "בשנה שעברה, 'דן שטיינר' (3080) היה/הייתה מצוות/ת למארח/ת מיכל אלבז (4414). בצד של המארחים הוא/היא 10661.")
    w = Witness.find(3080)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2841).comments.create!(user_id: 415, content: "בשנה שעברה, 'גובר מרדכי' (2841) היה/הייתה מצוות/ת למארח/ת דנה בן עזרא (7906). בצד של המארחים הוא/היא 18620.")
    w = Witness.find(2841)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2969).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה מאיר' (2969) היה/הייתה מצוות/ת למארח/ת לילך אללוף (1068). בצד של המארחים הוא/היא 1271.")
    w = Witness.find(2969)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2967).comments.create!(user_id: 415, content: "בשנה שעברה, 'עמוס רובין' (2967) היה/הייתה מצוות/ת למארח/ת גתית דודיוף (5790). בצד של המארחים הוא/היא 13271.")
    w = Witness.find(2967)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2923).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחלי שלומי חן' (2923) היה/הייתה מצוות/ת למארח/ת מאור מדמון (7890). בצד של המארחים הוא/היא 18602.")
    w = Witness.find(2923)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2921).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברוריה לב' (2921) היה/הייתה מצוות/ת למארח/ת אדם ריגר (9859). בצד של המארחים הוא/היא 24953.")
    w = Witness.find(2921)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2877).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמואל אנגלמייר' (2877) היה/הייתה מצוות/ת למארח/ת יניב קדושים (9416). בצד של המארחים הוא/היא 21953.")
    w = Witness.find(2877)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(2970).comments.create!(user_id: 415, content: "בשנה שעברה, 'זלמה אהרון' (2970) היה/הייתה מצוות/ת למארח/ת שיראל רצאבי (9015). בצד של המארחים הוא/היא 20504.")
    w = Witness.find(2970)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(893).comments.create!(user_id: 415, content: "בשנה שעברה, 'אוריאל בר און' (893) היה/הייתה מצוות/ת למארח/ת לירז הילי רוסו (8335). בצד של המארחים הוא/היא 19159.")
    w = Witness.find(893)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(833).comments.create!(user_id: 415, content: "בשנה שעברה, 'הלן גידנסקי' (833) היה/הייתה מצוות/ת למארח/ת שי שטרק (8205). בצד של המארחים הוא/היא 18985.")
    w = Witness.find(833)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1328).comments.create!(user_id: 415, content: "בשנה שעברה, 'מיכאל יוריס' (1328) היה/הייתה מצוות/ת למארח/ת חן עזרא (7220). בצד של המארחים הוא/היא 17817.")
    w = Witness.find(1328)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1356).comments.create!(user_id: 415, content: "בשנה שעברה, 'ברוך הס' (1356) היה/הייתה מצוות/ת למארח/ת גיל אלתר (7392). בצד של המארחים הוא/היא 18024.")
    w = Witness.find(1356)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1346).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה הרן' (1346) היה/הייתה מצוות/ת למארח/ת ערן גבאי (8887). בצד של המארחים הוא/היא 20168.")
    w = Witness.find(1346)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1006).comments.create!(user_id: 415, content: "בשנה שעברה, 'דליה קרון' (1006) היה/הייתה מצוות/ת למארח/ת עינת פרבר (6617). בצד של המארחים הוא/היא 17163.")
    w = Witness.find(1006)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1345).comments.create!(user_id: 415, content: "בשנה שעברה, 'תמי פולק' (1345) היה/הייתה מצוות/ת למארח/ת רחל טביב (8226). בצד של המארחים הוא/היא 19011.")
    w = Witness.find(1345)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1388).comments.create!(user_id: 415, content: "בשנה שעברה, 'אלכסנדר ריפ' (1388) היה/הייתה מצוות/ת למארח/ת לידור קרדי (8288). בצד של המארחים הוא/היא 19084.")
    w = Witness.find(1388)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1265).comments.create!(user_id: 415, content: "בשנה שעברה, 'רות הראל' (1265) היה/הייתה מצוות/ת למארח/ת טרייסי פיין (5504). בצד של המארחים הוא/היא 12498.")
    w = Witness.find(1265)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(693).comments.create!(user_id: 415, content: "בשנה שעברה, 'דוד שמואל' (693) היה/הייתה מצוות/ת למארח/ת ליאור גוטמן-עדו ואמילי שופן (4756). בצד של המארחים הוא/היא 11119.")
    w = Witness.find(693)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1188).comments.create!(user_id: 415, content: "בשנה שעברה, 'איתמר לוין' (1188) היה/הייתה מצוות/ת למארח/ת ספריית בית ספר נופי ים (7597). בצד של המארחים הוא/היא 18267.")
    w = Witness.find(1188)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1234).comments.create!(user_id: 415, content: "בשנה שעברה, 'סוניה פרל' (1234) היה/הייתה מצוות/ת למארח/ת נופר שגב (5425). בצד של המארחים הוא/היא 12378.")
    w = Witness.find(1234)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1167).comments.create!(user_id: 415, content: "בשנה שעברה, 'יונה אליאן' (1167) היה/הייתה מצוות/ת למארח/ת בריכת גורדון (7781). בצד של המארחים הוא/היא 18479.")
    w = Witness.find(1167)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1287).comments.create!(user_id: 415, content: "בשנה שעברה, 'מאיר לויטנוס' (1287) היה/הייתה מצוות/ת למארח/ת מתנ\"ס צור שלום (4229). בצד של המארחים הוא/היא 10424.")
    w = Witness.find(1287)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(342).comments.create!(user_id: 415, content: "בשנה שעברה, 'רוברט פישרמן' (342) היה/הייתה מצוות/ת למארח/ת זהבה באום (2698). בצד של המארחים הוא/היא 6590.")
    w = Witness.find(342)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(698).comments.create!(user_id: 415, content: "בשנה שעברה, 'לילי עוזיאל' (698) היה/הייתה מצוות/ת למארח/ת ג'נט וצביקה אמיתי (6803). בצד של המארחים הוא/היא 17351.")
    w = Witness.find(698)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(368).comments.create!(user_id: 415, content: "בשנה שעברה, 'יחיאל מאיר' (368) היה/הייתה מצוות/ת למארח/ת דורית רוט - ויין (6610). בצד של המארחים הוא/היא 17156.")
    w = Witness.find(368)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(463).comments.create!(user_id: 415, content: "בשנה שעברה, 'יצחק הוכברג' (463) היה/הייתה מצוות/ת למארח/ת נעמה הכהן-מרגלית (8428). בצד של המארחים הוא/היא 19332.")
    w = Witness.find(463)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(425).comments.create!(user_id: 415, content: "בשנה שעברה, 'טנה שטרן' (425) היה/הייתה מצוות/ת למארח/ת שושי ריפשטיין (339). בצד של המארחים הוא/היא 369.")
    w = Witness.find(425)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(397).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרים הראל' (397) היה/הייתה מצוות/ת למארח/ת טלי סוקניק (815). בצד של המארחים הוא/היא 870.")
    w = Witness.find(397)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(700).comments.create!(user_id: 415, content: "בשנה שעברה, 'שלומית שולץ' (700) היה/הייתה מצוות/ת למארח/ת בית לוי אשכול (7380). בצד של המארחים הוא/היא 18007.")
    w = Witness.find(700)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(573).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודה אבן חיים' (573) היה/הייתה מצוות/ת למארח/ת פז חדד (6841). בצד של המארחים הוא/היא 17396.")
    w = Witness.find(573)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(765).comments.create!(user_id: 415, content: "בשנה שעברה, 'אדוארד גורז'לצן' (765) היה/הייתה מצוות/ת למארח/ת עופרי אור (8168). בצד של המארחים הוא/היא 18940.")
    w = Witness.find(765)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1397).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמוליק לוי' (1397) היה/הייתה מצוות/ת למארח/ת לירון ארבל (5029). בצד של המארחים הוא/היא 11585.")
    w = Witness.find(1397)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(559).comments.create!(user_id: 415, content: "בשנה שעברה, 'מקס מרדכי ליבני' (559) היה/הייתה מצוות/ת למארח/ת לירן קשטרי (3614). בצד של המארחים הוא/היא 9631.")
    w = Witness.find(559)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(664).comments.create!(user_id: 415, content: "בשנה שעברה, 'דוד (דוגו) לייטנר' (664) היה/הייתה מצוות/ת למארח/ת פאב שלומפר (8985). בצד של המארחים הוא/היא 20397.")
    w = Witness.find(664)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(794).comments.create!(user_id: 415, content: "בשנה שעברה, 'פנינה חכמו' (794) היה/הייתה מצוות/ת למארח/ת גתית סרי (7638). בצד של המארחים הוא/היא 18316.")
    w = Witness.find(794)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1518).comments.create!(user_id: 415, content: "בשנה שעברה, 'שמחה רובינזון' (1518) היה/הייתה מצוות/ת למארח/ת זוהר וייסמן (9358). בצד של המארחים הוא/היא 21657.")
    w = Witness.find(1518)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(849).comments.create!(user_id: 415, content: "בשנה שעברה, 'רבקה קונדור' (849) היה/הייתה מצוות/ת למארח/ת תומר (8303). בצד של המארחים הוא/היא 19117.")
    w = Witness.find(849)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1414).comments.create!(user_id: 415, content: "בשנה שעברה, 'זליג אונפסונג' (1414) היה/הייתה מצוות/ת למארח/ת לילי כנפי (8198). בצד של המארחים הוא/היא 18977.")
    w = Witness.find(1414)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1548).comments.create!(user_id: 415, content: "בשנה שעברה, 'מנחם בנדל' (1548) היה/הייתה מצוות/ת למארח/ת נעמה ווזנר (5677). בצד של המארחים הוא/היא 5070.")
    w = Witness.find(1548)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1686).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל ופנחס כפיר' (1686) היה/הייתה מצוות/ת למארח/ת דוד עזורי (7987). בצד של המארחים הוא/היא 18720.")
    w = Witness.find(1686)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1585).comments.create!(user_id: 415, content: "בשנה שעברה, 'צילה הרטמן' (1585) היה/הייתה מצוות/ת למארח/ת ואד פרן (9074). בצד של המארחים הוא/היא 20714.")
    w = Witness.find(1585)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1673).comments.create!(user_id: 415, content: "בשנה שעברה, 'רותי דרורי' (1673) היה/הייתה מצוות/ת למארח/ת זיוה שנבל (7089). בצד של המארחים הוא/היא 17671.")
    w = Witness.find(1673)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1639).comments.create!(user_id: 415, content: "בשנה שעברה, 'טלי רהב' (1639) היה/הייתה מצוות/ת למארח/ת רחלי גרונשטיין (9576). בצד של המארחים הוא/היא 22740.")
    w = Witness.find(1639)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1716).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל שטיינר' (1716) היה/הייתה מצוות/ת למארח/ת בתאל ויונתן אמסטר (1527). בצד של המארחים הוא/היא 2201.")
    w = Witness.find(1716)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1665).comments.create!(user_id: 415, content: "בשנה שעברה, 'שיראל הורוביץ' (1665) היה/הייתה מצוות/ת למארח/ת ביכורי העתים (7780). בצד של המארחים הוא/היא 18478.")
    w = Witness.find(1665)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1755).comments.create!(user_id: 415, content: "בשנה שעברה, 'אהרון נחושתן' (1755) היה/הייתה מצוות/ת למארח/ת עדי רשף (7176). בצד של המארחים הוא/היא 17765.")
    w = Witness.find(1755)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1726).comments.create!(user_id: 415, content: "בשנה שעברה, 'גרשון קסטל' (1726) היה/הייתה מצוות/ת למארח/ת אורנה ריין וחיים בלוצר (3452). בצד של המארחים הוא/היא 9355.")
    w = Witness.find(1726)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1704).comments.create!(user_id: 415, content: "בשנה שעברה, 'ציון כחלון' (1704) היה/הייתה מצוות/ת למארח/ת קורל וקסלר (8085). בצד של המארחים הוא/היא 18829.")
    w = Witness.find(1704)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1720).comments.create!(user_id: 415, content: "בשנה שעברה, 'קלרה פיטר' (1720) היה/הייתה מצוות/ת למארח/ת ניצן שחם (9302). בצד של המארחים הוא/היא 21448.")
    w = Witness.find(1720)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1751).comments.create!(user_id: 415, content: "בשנה שעברה, 'ג'ולייט סממה' (1751) היה/הייתה מצוות/ת למארח/ת שרון גודש (4927). בצד של המארחים הוא/היא 11418.")
    w = Witness.find(1751)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1647).comments.create!(user_id: 415, content: "בשנה שעברה, 'גילה רז' (1647) היה/הייתה מצוות/ת למארח/ת חן רחמוט (7803). בצד של המארחים הוא/היא 18502.")
    w = Witness.find(1647)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(198).comments.create!(user_id: 415, content: "בשנה שעברה, 'יחיאל נרקיס' (198) היה/הייתה מצוות/ת למארח/ת נופר חצבני (9419). בצד של המארחים הוא/היא 21968.")
    w = Witness.find(198)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1300).comments.create!(user_id: 415, content: "בשנה שעברה, 'אבינועם רוזנק' (1300) היה/הייתה מצוות/ת למארח/ת אלישבע בן-טל (7714). בצד של המארחים הוא/היא 18404.")
    w = Witness.find(1300)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1612).comments.create!(user_id: 415, content: "בשנה שעברה, 'טובה שפיצר' (1612) היה/הייתה מצוות/ת למארח/ת יותם דגני (8016). בצד של המארחים הוא/היא 18750.")
    w = Witness.find(1612)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(895).comments.create!(user_id: 415, content: "בשנה שעברה, 'אורית מוסל' (895) היה/הייתה מצוות/ת למארח/ת ירדן מורדוב (4111). בצד של המארחים הוא/היא 10273.")
    w = Witness.find(895)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(844).comments.create!(user_id: 415, content: "בשנה שעברה, 'קטה וולף' (844) היה/הייתה מצוות/ת למארח/ת רויטל מטר (8590). בצד של המארחים הוא/היא 19570.")
    w = Witness.find(844)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(861).comments.create!(user_id: 415, content: "בשנה שעברה, 'מיכאל בן דרור' (861) היה/הייתה מצוות/ת למארח/ת תמר אנגל טיאר (5400). בצד של המארחים הוא/היא 12329.")
    w = Witness.find(861)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(792).comments.create!(user_id: 415, content: "בשנה שעברה, 'חיים ויטל' (792) היה/הייתה מצוות/ת למארח/ת גילה יעקבי (1127). בצד של המארחים הוא/היא 1377.")
    w = Witness.find(792)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(843).comments.create!(user_id: 415, content: "בשנה שעברה, 'אבלין מוהבן' (843) היה/הייתה מצוות/ת למארח/ת נועה יוסף (7499). בצד של המארחים הוא/היא 18148.")
    w = Witness.find(843)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(870).comments.create!(user_id: 415, content: "בשנה שעברה, 'פנינה מילר' (870) היה/הייתה מצוות/ת למארח/ת אפרת נתניאל (8737). בצד של המארחים הוא/היא 19837.")
    w = Witness.find(870)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(476).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרדכי וחנה הראלי' (476) היה/הייתה מצוות/ת למארח/ת שירי עיזר (9328). בצד של המארחים הוא/היא 21558.")
    w = Witness.find(476)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1181).comments.create!(user_id: 415, content: "בשנה שעברה, 'יהודה טל' (1181) היה/הייתה מצוות/ת למארח/ת ענבל דביר (7774). בצד של המארחים הוא/היא 18471.")
    w = Witness.find(1181)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(186).comments.create!(user_id: 415, content: "בשנה שעברה, 'פנינה קורן' (186) היה/הייתה מצוות/ת למארח/ת מיקי רון (253). בצד של המארחים הוא/היא 271.")
    w = Witness.find(186)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(859).comments.create!(user_id: 415, content: "בשנה שעברה, 'סטיב דן קלע' (859) היה/הייתה מצוות/ת למארח/ת ים אביב (7385). בצד של המארחים הוא/היא 18014.")
    w = Witness.find(859)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(860).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוסף גרינוולד' (860) היה/הייתה מצוות/ת למארח/ת ניצן צברי (8860). בצד של המארחים הוא/היא 20119.")
    w = Witness.find(860)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(989).comments.create!(user_id: 415, content: "בשנה שעברה, 'יוסי קליין' (989) היה/הייתה מצוות/ת למארח/ת גיא שטרית (9817). בצד של המארחים הוא/היא 24456.")
    w = Witness.find(989)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(933).comments.create!(user_id: 415, content: "בשנה שעברה, 'מוטי שלם' (933) היה/הייתה מצוות/ת למארח/ת סיון גלעד (8487). בצד של המארחים הוא/היא 19415.")
    w = Witness.find(933)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(527).comments.create!(user_id: 415, content: "בשנה שעברה, 'אפרים ברקן(פרדי)' (527) היה/הייתה מצוות/ת למארח/ת טליה ברד (8910). בצד של המארחים הוא/היא 20212.")
    w = Witness.find(527)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(623).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל הרטום' (623) היה/הייתה מצוות/ת למארח/ת מאירם פישר (8128). בצד של המארחים הוא/היא 18874.")
    w = Witness.find(623)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(216).comments.create!(user_id: 415, content: "בשנה שעברה, 'עליזה סעדון' (216) היה/הייתה מצוות/ת למארח/ת שחף בהם (702). בצד של המארחים הוא/היא 754.")
    w = Witness.find(216)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1746).comments.create!(user_id: 415, content: "בשנה שעברה, 'נתי בן זאב' (1746) היה/הייתה מצוות/ת למארח/ת יעל כצנלסון (2181). בצד של המארחים הוא/היא 3973.")
    w = Witness.find(1746)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1441).comments.create!(user_id: 415, content: "בשנה שעברה, 'שלום ספיבק ואסתר בר נוי' (1441) היה/הייתה מצוות/ת למארח/ת עמית אבירם (5610). בצד של המארחים הוא/היא 12770.")
    w = Witness.find(1441)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1563).comments.create!(user_id: 415, content: "בשנה שעברה, 'סוזי קסטנר' (1563) היה/הייתה מצוות/ת למארח/ת מאיה גרינר קרייזמן (7746). בצד של המארחים הוא/היא 18439.")
    w = Witness.find(1563)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1483).comments.create!(user_id: 415, content: "בשנה שעברה, 'רחל עזריה' (1483) היה/הייתה מצוות/ת למארח/ת אלון שטרנברג (6563). בצד של המארחים הוא/היא 17110.")
    w = Witness.find(1483)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1311).comments.create!(user_id: 415, content: "בשנה שעברה, 'סוניה סברדלוף' (1311) היה/הייתה מצוות/ת למארח/ת מוריה דפני (7111). בצד של המארחים הוא/היא 4408.")
    w = Witness.find(1311)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1735).comments.create!(user_id: 415, content: "בשנה שעברה, 'קלרקה גל' (1735) היה/הייתה מצוות/ת למארח/ת ירדן (7805). בצד של המארחים הוא/היא 18504.")
    w = Witness.find(1735)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(435).comments.create!(user_id: 415, content: "בשנה שעברה, 'עליזה אוברשטיין' (435) היה/הייתה מצוות/ת למארח/ת אלעד בוטבול (7802). בצד של המארחים הוא/היא 18501.")
    w = Witness.find(435)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1780).comments.create!(user_id: 415, content: "בשנה שעברה, 'צביקה פלצ'נסקי' (1780) היה/הייתה מצוות/ת למארח/ת עדן בוטבול (8652). בצד של המארחים הוא/היא 19681.")
    w = Witness.find(1780)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1031).comments.create!(user_id: 415, content: "בשנה שעברה, 'אנג'לו רפאל' (1031) היה/הייתה מצוות/ת למארח/ת טל שחר הלל (9046). בצד של המארחים הוא/היא 20599.")
    w = Witness.find(1031)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1303).comments.create!(user_id: 415, content: "בשנה שעברה, 'הרב דוד אדרעי' (1303) היה/הייתה מצוות/ת למארח/ת נטע בן שלום (7386). בצד של המארחים הוא/היא 18015.")
    w = Witness.find(1303)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(621).comments.create!(user_id: 415, content: "בשנה שעברה, 'מרים טסלר' (621) היה/הייתה מצוות/ת למארח/ת רבקה שמש (7371). בצד של המארחים הוא/היא 17996.")
    w = Witness.find(621)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1783).comments.create!(user_id: 415, content: "בשנה שעברה, 'משה נורדהיים' (1783) היה/הייתה מצוות/ת למארח/ת תיכון דרור (6873). בצד של המארחים הוא/היא 17429.")
    w = Witness.find(1783)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1787).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה אליאש' (1787) היה/הייתה מצוות/ת למארח/ת אבי אדלמן (8268). בצד של המארחים הוא/היא 19059.")
    w = Witness.find(1787)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(862).comments.create!(user_id: 415, content: "בשנה שעברה, 'שרה שמיר' (862) היה/הייתה מצוות/ת למארח/ת שני שופט (3666). בצד של המארחים הוא/היא 9701.")
    w = Witness.find(862)
    w.active_last_year = true
    w.save
    ...
    h.active_last_year = true
    h.save
    Witness.find(1443).comments.create!(user_id: 415, content: "בשנה שעברה, 'מלכה ינאי' (1443) היה/הייתה מצוות/ת למארח/ת אדוה עמיאל (6871). בצד של המארחים הוא/היא 17427.")
    w = Witness.find(1443)
    w.active_last_year = true
    w.save
